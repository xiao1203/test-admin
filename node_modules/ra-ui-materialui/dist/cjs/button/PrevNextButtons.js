...
var PrevNextButtons = function (props) {
    var sx = props.sx;
    var _a = (0, ra_core_1.usePrevNextController)(props), hasPrev = _a.hasPrev, hasNext = _a.hasNext, prevPath = _a.prevPath, nextPath = _a.nextPath, index = _a.index, total = _a.total, error = _a.error, isLoading = _a.isLoading;
    var translate = (0, ra_core_1.useTranslate)();
    if (isLoading) {
        return (React.createElement(material_1.Box, { minHeight: function (theme) { return theme.spacing(4); } },
    ...
    if (!hasPrev && !hasNext) {
        return React.createElement(material_1.Box, { minHeight: function (theme) { return theme.spacing(5); } });
    }
    return (React.createElement(Root, { sx: sx },
        React.createElement("ul", { className: (0, clsx_1.default)(exports.PrevNextButtonClasses.list) },
            React.createElement("li", null,
                React.createElement(material_1.IconButton, { component: hasPrev ? react_router_dom_1.Link : undefined, to: prevPath, "aria-label": translate('ra.navigation.previous'), disabled: !hasPrev },
                    React.createElement(icons_material_1.NavigateBefore, null))),
            typeof index === 'number' && (React.createElement("li", null,
                index + 1,
                " / ",
                total)),
            React.createElement("li", null,
                React.createElement(material_1.IconButton, { component: hasNext ? react_router_dom_1.Link : undefined, to: nextPath, "aria-label": translate('ra.navigation.next'), disabled: !hasNext },
                    React.createElement(icons_material_1.NavigateNext, null))))));
};
...
var Root = (0, material_1.styled)('nav', {
    name: PREFIX,
    overridesResolver: function (_props, styles) { return styles.root; },
})((_a = {},
    _a["& .".concat(exports.PrevNextButtonClasses.list)] = {
        display: 'flex',
        flexWrap: 'wrap',
        alignItems: 'center',
        padding: 0,
