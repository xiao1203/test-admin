...
var Menu = function (props) {
    ...
    var hasDashboard = props.hasDashboard, _b = props.children, children = _b === void 0 ? hasDashboard ? ([
        React.createElement(DashboardMenuItem_1.DashboardMenuItem, { key: "default-dashboard-menu-item" }),
        React.createElement(ResourceMenuItems_1.ResourceMenuItems, { key: "default-resource-menu-items" }),
    ]) : (React.createElement(ResourceMenuItems_1.ResourceMenuItems, null)) : _b, className = props.className, rest = __rest(props, ["hasDashboard", "children", "className"]);
