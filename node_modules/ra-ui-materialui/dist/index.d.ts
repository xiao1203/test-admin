...
import { RedirectionSideEffect, RaRecord, MutationMode, Identifier, UseUpdateMutateParams, TransformData, UseCreateMutateParams, Exporter, SaveContextValue, DeleteParams, FilterPayload, SortPayload, CreateParams, UpdateParams, CreateControllerProps, InferredTypeMap, EditControllerProps, FormProps, ListControllerProps, LinkToType, UseReferenceResult, ListControllerResult, ChoicesProps, UseTranslatableOptions, InputProps, OptionText, UseSuggestionsOptions, ValidationErrorMessage, TitleComponent, CoreLayoutProps, ListFilterContextValue, CoreAdminUIProps, CoreAdminContextProps } from 'ra-core';
 ...
 *     );
 */
declare const LocalesMenuButton: ({ languages }: LocalesMenuButtonProps) => JSX.Element;
...
declare const ReferenceManyFieldView: FC<ReferenceManyFieldViewProps>;
interface ReferenceManyFieldViewProps extends Omit<ReferenceManyFieldProps, 'resource' | 'page' | 'perPage' | 'sort'>, ListControllerResult {
    children: ReactElement;
}
