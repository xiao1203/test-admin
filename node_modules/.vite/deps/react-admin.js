...
var Button = function(props) {
  var _a15 = props.alignIcon, alignIcon = _a15 === void 0 ? "left" : _a15, children = props.children, className = props.className, disabled = props.disabled, label = props.label, _b = props.color, color = _b === void 0 ? "primary" : _b, _c = props.size, size = _c === void 0 ? "small" : _c, locationDescriptor = props.to, rest = __rest(props, ["alignIcon", "children", "className", "disabled", "label", "color", "size", "to"]);
...
var CloneButton = function(props) {
  var _a15 = props.label, label = _a15 === void 0 ? "ra.action.clone" : _a15, _b = props.scrollToTop, scrollToTop = _b === void 0 ? true : _b, _c = props.icon, icon = _c === void 0 ? defaultIcon : _c, rest = __rest2(props, ["label", "scrollToTop", "icon"]);
...
var omitId = function(_a15) {
  var id = _a15.id, rest = __rest2(_a15, ["id"]);
  return rest;
};
var sanitizeRestProps = function(_a15) {
  var resource = _a15.resource, record = _a15.record, rest = __rest2(_a15, ["resource", "record"]);
  return rest;
};
...
var CreateButton = function(props) {
  var className = props.className, _a15 = props.icon, icon = _a15 === void 0 ? defaultIcon2 : _a15, _b = props.label, label = _b === void 0 ? "ra.action.create" : _b, resourceProp = props.resource, _c = props.scrollToTop, scrollToTop = _c === void 0 ? true : _c, variant = props.variant, rest = __rest3(props, ["className", "icon", "label", "resource", "scrollToTop", "variant"]);
  var resource = useResourceContext(props);
  var createPath = useCreatePath();
  var translate = useTranslate();
...
var ShowButton = function(props) {
  var _a15 = props.icon, icon = _a15 === void 0 ? defaultIcon3 : _a15, _b = props.label, label = _b === void 0 ? "ra.action.show" : _b, recordProp = props.record, resourceProp = props.resource, _c = props.scrollToTop, scrollToTop = _c === void 0 ? true : _c, rest = __rest4(props, ["icon", "label", "record", "resource", "scrollToTop"]);
  var resource = useResourceContext(props);
  var record = useRecordContext(props);
  var createPath = useCreatePath();
  if (!record)
...
var SortButton = function(props) {
  var fields = props.fields, _a15 = props.label, label = _a15 === void 0 ? "ra.sort.sort_by" : _a15, _b = props.icon, icon = _b === void 0 ? defaultIcon4 : _b, sx = props.sx, className = props.className;
  ...
  return React5.createElement(
    Root,
    { sx, className: clsx_m_default(className, classNames.root) },
    ...
    ) : React5.createElement(Button_default, { "aria-controls": "simple-menu", "aria-haspopup": "true", color: "primary", onClick: handleClick2, startIcon: icon, endIcon: React5.createElement(import_ArrowDropDown.default, null), size: "small" }, buttonLabel),
...
var SidebarToggleButton = function(props) {
  ...
  var _a15 = useSidebarState(), open = _a15[0], setOpen = _a15[1];
...
var PREFIX4 = "RaSidebarToggleButton";
var SidebarToggleButtonClasses = {
  menuButtonIconClosed: "".concat(PREFIX4, "-menuButtonIconClosed"),
  menuButtonIconOpen: "".concat(PREFIX4, "-menuButtonIconOpen")
};
...
var PREFIX5 = "RaLoadingIndicator";
var LoadingIndicatorClasses = {
  loader: "".concat(PREFIX5, "-loader"),
  loadedIcon: "".concat(PREFIX5, "-loadedIcon")
};
...
// node_modules/ra-ui-materialui/dist/esm/layout/UserMenuContextProvider.js
var UserMenuContextProvider = function(_a15) {
  var children = _a15.children, value = _a15.value;
...
var PREFIX6 = "RaLogout";
var LogoutClasses = {
  icon: "".concat(PREFIX6, "-icon")
};
...
})((_a2 = {}, _a2["& .".concat(LogoutClasses.icon)] = {}, _a2));

// node_modules/ra-ui-materialui/dist/esm/layout/UserMenu.js
var UserMenu = function(props) {
  var _a15 = (0, import_react7.useState)(null), anchorEl = _a15[0], setAnchorEl = _a15[1];
  var translate = useTranslate();
...
var PREFIX7 = "RaUserMenu";
var UserMenuClasses = {
  userButton: "".concat(PREFIX7, "-userButton"),
  avatar: "".concat(PREFIX7, "-avatar")
};
...
var TitlePortal = function(props) {
  return React12.createElement(Typography_default, __assign7({ flex: "1", textOverflow: "ellipsis", whiteSpace: "nowrap", overflow: "hidden", variant: "h6", color: "inherit", id: "react-admin-title" }, props));
};
...
var useThemesContext = function(params) {
  var _a15 = params || {}, lightTheme = _a15.lightTheme, darkTheme = _a15.darkTheme, defaultTheme2 = _a15.defaultTheme;
...
var ToggleThemeLegacyButton = function(props) {
  ...
  var _a15 = useTheme2(), theme = _a15[0], setTheme = _a15[1];
...
var ToggleThemeButton = function(props) {
  var translate = useTranslate();
  var _a15 = useThemesContext(props), darkTheme = _a15.darkTheme, defaultTheme2 = _a15.defaultTheme;
...
var AppBar = (0, import_react12.memo)(function(props) {
  ...
  return React15.createElement(
    ...
    React15.createElement(
      StyledAppBar,
      __assign8({ className: AppBarClasses.appBar, color }, rest),
      React15.createElement(
        Toolbar_default,
...
var PREFIX8 = "RaAppBar";
var AppBarClasses = {
  appBar: "".concat(PREFIX8, "-appBar"),
  toolbar: "".concat(PREFIX8, "-toolbar"),
  menuButton: "".concat(PREFIX8, "-menuButton"),
  menuButtonIconClosed: "".concat(PREFIX8, "-menuButtonIconClosed"),
  menuButtonIconOpen: "".concat(PREFIX8, "-menuButtonIconOpen"),
  title: "".concat(PREFIX8, "-title")
};
...
var ApplicationUpdatedNotification = React16.forwardRef(function(props, ref) {
  var ButtonProps = props.ButtonProps, _a15 = props.updateText, updateText = _a15 === void 0 ? "ra.action.update_application" : _a15, _b = props.notificationText, notificationText = _b === void 0 ? "ra.notification.application_update_available" : _b, alertProps = __rest8(props, ["ButtonProps", "updateText", "notificationText"]);
  var translate = useTranslate();
  var handleButtonClick = function() {
    window.location.reload();
  };
  return React16.createElement(Alert_default, __assign9({ ref, severity: "info", action: React16.createElement(Button_default, __assign9({ color: "inherit", size: "small", onClick: handleButtonClick }, ButtonProps), translate(updateText, { _: updateText })) }, alertProps), translate(notificationText, { _: notificationText }));
});
...
var CardContentInner = function(props) {
  ...
  return React17.createElement(Root4, { className }, children);
};
...
var PREFIX9 = "RaCardContentInner";
var CardContentInnerClasses = {
  root: "".concat(PREFIX9, "-root")
};
var Root4 = styled_default(CardContent_default, {
  name: PREFIX9,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var CheckForApplicationUpdate = function(props) {
  var _a15 = props.notification, notification = _a15 === void 0 ? DEFAULT_NOTIFICATION : _a15, rest = __rest9(props, ["notification"]);
...
var DEFAULT_NOTIFICATION = React18.createElement(ApplicationUpdatedNotification, null);
...
var Confirm = function(props) {
  ...
  return React19.createElement(
    ...
    React19.createElement(DialogTitle_default, { id: "alert-dialog-title" }, typeof title === "string" ? translate(title, __assign11({ _: title }, translateOptions)) : title),
    React19.createElement(DialogContent_default, null, typeof content === "string" ? React19.createElement(DialogContentText_default, null, translate(content, __assign11({ _: content }, translateOptions))) : content),
    React19.createElement(
      DialogActions_default,
      null,
      React19.createElement(Button_default, { disabled: loading, onClick: onClose, startIcon: React19.createElement(CancelIcon3, null) }, translate(cancel, { _: cancel })),
      React19.createElement(Button_default, { disabled: loading, onClick: handleConfirm, className: clsx_m_default("ra-confirm", (_a15 = {}, _a15[ConfirmClasses.confirmWarning] = confirmColor === "warning", _a15[ConfirmClasses.confirmPrimary] = confirmColor === "primary", _a15)), autoFocus: true, startIcon: React19.createElement(ConfirmIcon, null) }, translate(confirm, { _: confirm }))
    )
  );
};
Confirm.propTypes = {
...
var PREFIX10 = "RaConfirm";
var ConfirmClasses = {
  confirmPrimary: "".concat(PREFIX10, "-confirmPrimary"),
  confirmWarning: "".concat(PREFIX10, "-confirmWarning")
};
...
var MenuItemLink = (0, import_react14.forwardRef)(function(props, ref) {
  ...
  var renderMenuItem = function() {
    ...
    return import_react14.default.createElement(
      StyledMenuItem2,
      __assign12({
        className: clsx_m_default(className, (_a16 = {}, _a16[MenuItemLinkClasses.active] = !!match, _a16)),
        // @ts-ignore
        component: LinkRef,
        ref,
        tabIndex: 0
  ...
  return open ? renderMenuItem() : import_react14.default.createElement(Tooltip_default, __assign12({ title: typeof primaryText === "string" ? translate(primaryText, { _: primaryText }) : primaryText, placement: "right" }, tooltipProps), renderMenuItem());
});
...
var PREFIX11 = "RaMenuItemLink";
var MenuItemLinkClasses = {
  active: "".concat(PREFIX11, "-active"),
  icon: "".concat(PREFIX11, "-icon")
};
...
var LinkRef = (0, import_react14.forwardRef)(function(props, ref) {
  return import_react14.default.createElement(Link, __assign12({ ref }, props));
});
...
var DashboardMenuItem = function(props) {
  var basename = useBasename();
  var _a15 = props.leftIcon, leftIcon = _a15 === void 0 ? import_react15.default.createElement(import_Dashboard.default, null) : _a15, _b = props.to, to = _b === void 0 ? "".concat(basename, "/") : _b, _c = props.primaryText, primaryText = _c === void 0 ? "ra.page.dashboard" : _c, rest = __rest12(props, ["leftIcon", "to", "primaryText"]);
  return import_react15.default.createElement(MenuItemLink, __assign13({ leftIcon, to, primaryText }, rest));
};
...
var DeviceTestWrapper = function(_a15) {
  var _b = _a15.width, width = _b === void 0 ? "md" : _b, children = _a15.children;
  ...
  return React22.createElement(ThemeProvider, { theme: __assign14(__assign14({}, theme), { components: {
    MuiUseMediaQuery: {
      defaultProps: {
        ssrMatchMedia,
...
var Configurable = function(props) {
  var children = props.children, editor = props.editor, preferenceKey = props.preferenceKey, _a15 = props.openButtonLabel, openButtonLabel = _a15 === void 0 ? "ra.configurable.customize" : _a15, sx = props.sx;
  ...
  return React23.createElement(
    ...
    React23.createElement(Root5, { className: clsx_m_default(ConfigurableClasses.root, isEnabled && ConfigurableClasses.editMode, isEditorOpen && ConfigurableClasses.editorActive), sx, ref: wrapperRef, onMouseEnter: isEnabled ? handleShowButton : void 0, onMouseLeave: isEnabled ? handleHideButton : void 0 }, children),
...
var PREFIX12 = "RaConfigurable";
var ConfigurableClasses = {
  root: "".concat(PREFIX12, "-root"),
  editMode: "".concat(PREFIX12, "-editMode"),
  editorActive: "".concat(PREFIX12, "-editorActive")
};
...
var FieldToggle = function(props) {
  ...
  var dropIndex = React24.useRef(null);
  var x = React24.useRef(null);
  var y = React24.useRef(null);
  var handleDocumentDragOver = React24.useCallback(function(event) {
  ...
  return React24.createElement(
    ...
    React24.createElement(
      ...
      React24.createElement(Switch_default, { checked: selected, onChange: onToggle, name: index, id: "switch_".concat(index), size: "small", sx: { mr: 0.5, ml: -0.5 } }),
      React24.createElement(
        Typography_default,
        { variant: "body2", component: "span" },
        React24.createElement(FieldTitle_default, { label, source, resource })
      )
    ),
    onMove && React24.createElement(import_DragIndicator.default, { className: "dragIcon", color: "disabled", fontSize: "small" })
  );
};
var Root6 = styled_default("div")(function(_a15) {
  var theme = _a15.theme;
  return {
    display: "flex",
...
var FieldsSelector = function(_a15) {
  var _b = _a15.name, name = _b === void 0 ? "columns" : _b, _c = _a15.availableName, availableName = _c === void 0 ? "availableColumns" : _c;
  var translate = useTranslate();
  ...
  return React25.createElement(
    ...
    availableFields.map(function(field) {
      return React25.createElement(FieldToggle, { key: field.index, source: field.source, label: field.label, index: field.index, selected: fields.includes(field.index), onToggle: handleToggle, onMove: handleMove });
    }),
    React25.createElement(
      Box_default,
      { display: "flex", justifyContent: "space-between", mx: -0.5, mt: 1 },
      React25.createElement(Button_default, { size: "small", onClick: handleHideAll }, translate("ra.inspector.hideAll", {
        _: "Hide All"
      })),
      React25.createElement(Button_default, { size: "small", onClick: handleShowAll }, translate("ra.inspector.showAll", {
        _: "Show All"
      }))
    )
  );
...
var InspectorRoot = function() {
  ...
  return React26.createElement(Typography_default, null, translate("ra.configurable.inspector.content", {
...
var Inspector = function() {
  var _a15 = usePreferencesEditor(), isEnabled = _a15.isEnabled, disable = _a15.disable, title = _a15.title, titleOptions = _a15.titleOptions, editor = _a15.editor, preferenceKey = _a15.preferenceKey;
  ...
  return React27.createElement(
    ...
    React27.createElement(
      ...
      React27.createElement(Typography_default, { id: "inspector-dialog-title", variant: "overline", component: "div", py: 1, px: 2, flex: "1" }, title && translate(title, titleOptions)),
      React27.createElement("span", { id: "inspector-toolbar" }),
      preferenceKey && React27.createElement(
        IconButton_default,
        { "aria-label": translate("ra.action.remove"), onClick: handleReset, size: "small" },
        React27.createElement(import_DeleteOutline.default, { fontSize: "inherit" })
      ),
      React27.createElement(
        IconButton_default,
        { "aria-label": translate("ra.action.close"), onClick: disable, size: "small", sx: { mr: 1 } },
        React27.createElement(import_CancelOutlined.default, { fontSize: "inherit" })
      )
    ),
    React27.createElement(
      "div",
      { className: InspectorClasses.content, key: version },
      React27.createElement(PreferenceKeyContextProvider, { value: preferenceKey }, editor || React27.createElement(InspectorRoot, null))
    )
  );
};
var PREFIX13 = "RaInspector";
var InspectorClasses = {
  modal: "".concat(PREFIX13, "-modal"),
  title: "".concat(PREFIX13, "-title"),
  content: "".concat(PREFIX13, "-content")
};
...
var InspectorButton = React28.forwardRef(function(_a15, ref) {
  var _b = _a15.label, label = _b === void 0 ? "ra.configurable.configureMode" : _b, _c = _a15.SvgIconProps, SvgIconProps = _c === void 0 ? {} : _c, props = __rest13(_a15, ["label", "SvgIconProps"]);
  ...
  return React28.createElement(
    ...
    React28.createElement(
      ...
      React28.createElement(import_Settings2.default, __assign15({ fontSize: "inherit" }, SvgIconProps))
    )
  );
});
...
var PageTitle = function(_a15) {
  var title = _a15.title, defaultTitle = _a15.defaultTitle, className = _a15.className, rest = __rest14(_a15, ["title", "defaultTitle", "className"]);
  var titleFromPreferences = usePreference()[0];
  var translate = useTranslate();
  var record = useRecordContext();
  return titleFromPreferences ? React29.createElement("span", __assign16({ className }, rest), translate(titleFromPreferences, __assign16(__assign16({}, record), { _: titleFromPreferences }))) : React29.createElement("span", { className }, !title ? React29.createElement("span", __assign16({}, rest), defaultTitle) : typeof title === "string" ? React29.createElement("span", __assign16({}, rest), translate(title, { _: title })) : title);
};
...
var PageTitleEditor = function() {
  ...
  return React30.createElement(
    "form",
    null,
    React30.createElement(TextField_default, __assign17({ label: "title", variant: "filled", size: "small", fullWidth: true, sx: { mb: 1 } }, field))
  );
};
var PageTitleConfigurable = function(_a15) {
  var preferenceKey = _a15.preferenceKey, props = __rest15(_a15, ["preferenceKey"]);
  var pathname = useLocation().pathname;
  return React30.createElement(
    Configurable,
    { editor: React30.createElement(PageTitleEditor, null), preferenceKey: preferenceKey || "".concat(pathname, ".title"), sx: {
      "&.RaConfigurable-editMode": {
        margin: "2px"
      }
    } },
    React30.createElement(PageTitle, __assign17({}, props))
  );
};
...
var Title = function(props) {
  ...
  var _a15 = (0, import_react18.useState)(function() {
    return typeof document !== "undefined" ? document.getElementById("react-admin-title") : null;
  }), container = _a15[0], setContainer = _a15[1];
  ...
  return (0, import_react_dom.createPortal)(React31.createElement(PageTitleConfigurable, __assign18({ title, defaultTitle, preferenceKey }, rest)), container);
};
...
var Error2 = function(props) {
  ...
  if (ErrorComponent) {
    return React32.createElement(ErrorComponent, { error, errorInfo, title });
  }
  return React32.createElement(
    import_react20.Fragment,
    null,
    title && React32.createElement(Title, { title }),
    React32.createElement(
      ...
      React32.createElement(
        ...
        React32.createElement(import_Report.default, { className: ErrorClasses.icon }),
        translate("ra.page.error")
      ),
      React32.createElement("div", null, translate("ra.message.error")),
      React32.createElement(
        React32.Fragment,
        null,
        React32.createElement(
          ...
          React32.createElement(AccordionSummary_default, { expandIcon: React32.createElement(import_ExpandMore.default, null), className: ErrorClasses.panelSumary }, translate(error.message, {
            _: error.message
          })),
          React32.createElement(
            AccordionDetails_default,
            { className: ErrorClasses.panelDetails },
            React32.createElement("p", null, translate(error.message, {
              _: error.message
            })),
            React32.createElement("p", null, errorInfo === null || errorInfo === void 0 ? void 0 : errorInfo.componentStack)
          )
        ),
        React32.createElement(
          "div",
          { className: ErrorClasses.advice },
          React32.createElement(Typography_default, { align: "center" }, "Need help with this error? Try the following:"),
          React32.createElement(
            Typography_default,
            { component: "div" },
            React32.createElement(
              ...
              React32.createElement(
                ...
                "Check the",
                " ",
                React32.createElement("a", { href: "https://marmelab.com/react-admin/Readme.html" }, "react-admin documentation")
              ),
              React32.createElement(
                "li",
                null,
                "Search on",
                " ",
                React32.createElement("a", { href: "https://stackoverflow.com/questions/tagged/react-admin" }, "StackOverflow"),
                " ",
              ...
              React32.createElement(
                ...
                " ",
                React32.createElement("a", { href: "https://marmelab.com/ra-enterprise/#fromsww" }, "react-admin Enterprise Edition")
              )
            )
          )
        )
      ...
      React32.createElement(
        ...
        React32.createElement(Button_default, { variant: "contained", startIcon: React32.createElement(import_History.default, null), onClick: goBack }, translate("ra.action.back"))
      )
    )
  );
};
...
var PREFIX14 = "RaError";
var ErrorClasses = {
  container: "".concat(PREFIX14, "-container"),
  title: "".concat(PREFIX14, "-title"),
  icon: "".concat(PREFIX14, "-icon"),
  panel: "".concat(PREFIX14, "-panel"),
  panelSumary: "".concat(PREFIX14, "-panelSumary"),
  panelDetails: "".concat(PREFIX14, "-panelDetails"),
  toolbar: "".concat(PREFIX14, "-toolbar"),
  advice: "".concat(PREFIX14, "-advice")
};
...
var ErrorBoundary = function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    if (error !== null) {
      ...
      if (React33.isValidElement(fallback)) {
        return fallback;
      } else if (typeof fallbackRender === "function") {
        return fallbackRender(_props);
      } else if (FallbackComponent) {
        return React33.createElement(FallbackComponent, _props);
      } else {
...
var Sidebar = function(props) {
  var appBarAlwaysOn = props.appBarAlwaysOn, children = props.children, closedSize = props.closedSize, size = props.size, rest = __rest18(props, ["appBarAlwaysOn", "children", "closedSize", "size"]);
  var isXSmall = useMediaQuery(function(theme) {
    return theme.breakpoints.down("sm");
  });
  var _a15 = useSidebarState(), open = _a15[0], setOpen = _a15[1];
  ...
  return isXSmall ? React34.createElement(StyledDrawer, __assign20({ variant: "temporary", open, onClose: toggleSidebar, classes: SidebarClasses }, rest), children) : React34.createElement(
    StyledDrawer,
    ...
    React34.createElement("div", { className: SidebarClasses.fixed }, children)
  );
};
Sidebar.propTypes = {
  children: import_prop_types16.default.node.isRequired
};
var PREFIX15 = "RaSidebar";
var SidebarClasses = {
  docked: "".concat(PREFIX15, "-docked"),
  paper: "".concat(PREFIX15, "-paper"),
  paperAnchorLeft: "".concat(PREFIX15, "-paperAnchorLeft"),
  paperAnchorRight: "".concat(PREFIX15, "-paperAnchorRight"),
  paperAnchorTop: "".concat(PREFIX15, "-paperAnchorTop"),
  paperAnchorBottom: "".concat(PREFIX15, "-paperAnchorBottom"),
  paperAnchorDockedLeft: "".concat(PREFIX15, "-paperAnchorDockedLeft"),
  paperAnchorDockedTop: "".concat(PREFIX15, "-paperAnchorDockedTop"),
  paperAnchorDockedRight: "".concat(PREFIX15, "-paperAnchorDockedRight"),
  paperAnchorDockedBottom: "".concat(PREFIX15, "-paperAnchorDockedBottom"),
  modal: "".concat(PREFIX15, "-modal"),
  fixed: "".concat(PREFIX15, "-fixed"),
  appBarCollapsed: "".concat(PREFIX15, "-appBarCollapsed")
};
var StyledDrawer = styled_default(Drawer_default, {
  ...
  var _b, _c, _d;
  var open = _a15.open, theme = _a15.theme;
  return _b = {
...
var ResourceMenuItem = function(_a15) {
  var name = _a15.name;
  ...
  if (!resources || !resources[name])
    return null;
  return React35.createElement(MenuItemLink, { to: createPath({
    resource: name,
    type: "list"
  }), state: { _scrollToTop: true }, primaryText: React35.createElement(React35.Fragment, null, getResourceLabel(name, 2)), leftIcon: resources[name].icon ? (0, import_react21.createElement)(resources[name].icon) : React35.createElement(import_ViewList.default, null) });
};

// node_modules/ra-ui-materialui/dist/esm/layout/ResourceMenuItems.js
var React36 = __toESM(require_react());
var ResourceMenuItems = function() {
  var resources = useResourceDefinitions();
  return React36.createElement(React36.Fragment, null, Object.keys(resources).filter(function(name) {
    return resources[name].hasList;
  }).map(function(name) {
    return React36.createElement(ResourceMenuItem, { key: name, name });
  }));
};
...
var Menu = function(props) {
  var _a15;
  var hasDashboard = props.hasDashboard, _b = props.children, children = _b === void 0 ? hasDashboard ? [
    React37.createElement(DashboardMenuItem, { key: "default-dashboard-menu-item" }),
    React37.createElement(ResourceMenuItems, { key: "default-resource-menu-items" })
  ] : React37.createElement(ResourceMenuItems, null) : _b, className = props.className, rest = __rest19(props, ["hasDashboard", "children", "className"]);
  var open = useSidebarState()[0];
  return React37.createElement(Root8, __assign21({ className: clsx_m_default((_a15 = {}, _a15[MenuClasses.open] = open, _a15[MenuClasses.closed] = !open, _a15), className) }, rest), children);
};
Menu.propTypes = {
...
var PREFIX16 = "RaMenu";
var MenuClasses = {
  open: "".concat(PREFIX16, "-open"),
  closed: "".concat(PREFIX16, "-closed")
};
var Root8 = styled_default(MenuList_default, {
  name: PREFIX16,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var Loading = function(props) {
  var className = props.className, _a15 = props.loadingPrimary, loadingPrimary = _a15 === void 0 ? "ra.page.loading" : _a15, _b = props.loadingSecondary, loadingSecondary = _b === void 0 ? "ra.message.loading" : _b, rest = __rest20(props, ["className", "loadingPrimary", "loadingSecondary"]);
  var oneSecondHasPassed = useTimeout(1e3);
  var translate = useTranslate();
  return oneSecondHasPassed ? React38.createElement(
    Root9,
    __assign22({ className }, rest),
    React38.createElement(
      "div",
      { className: LoadingClasses.message },
      React38.createElement(CircularProgress_default, { className: LoadingClasses.icon }),
      React38.createElement(Typography_default, { variant: "h5", mt: 3, color: "text.secondary" }, translate(loadingPrimary, { _: loadingPrimary })),
      React38.createElement(Typography_default, { variant: "body2" }, translate(loadingSecondary, { _: loadingSecondary }))
    )
  ) : null;
};
Loading.propTypes = {
  className: import_prop_types18.default.string,
  loadingPrimary: import_prop_types18.default.string,
  loadingSecondary: import_prop_types18.default.string
};
var PREFIX17 = "RaLoading";
var LoadingClasses = {
  root: "".concat(PREFIX17, "-root"),
  icon: "".concat(PREFIX17, "-icon"),
  message: "".concat(PREFIX17, "-message")
};
...
var Layout = function(props) {
  var _a15 = props.appBar, AppBar2 = _a15 === void 0 ? AppBar : _a15, appBarAlwaysOn = props.appBarAlwaysOn, children = props.children, className = props.className, dashboard = props.dashboard, errorComponent = props.error, _b = props.menu, Menu2 = _b === void 0 ? Menu : _b, _c = props.sidebar, Sidebar2 = _c === void 0 ? Sidebar : _c, title = props.title, rest = __rest21(props, ["appBar", "appBarAlwaysOn", "children", "className", "dashboard", "error", "menu", "sidebar", "title"]);
  var open = useSidebarState()[0];
  ...
  return import_react22.default.createElement(
    Core,
    __assign23({ className: clsx_m_default("layout", className) }, rest),
    ...
    import_react22.default.createElement(
      ...
      import_react22.default.createElement(
        ...
        import_react22.default.createElement(
          ...
          import_react22.default.createElement(
            ErrorBoundary,
            { onError: handleError, fallbackRender: function(_a16) {
              var error = _a16.error, resetErrorBoundary = _a16.resetErrorBoundary;
              return import_react22.default.createElement(Error2, { error, errorComponent, errorInfo, resetErrorBoundary, title });
            } },
            import_react22.default.createElement(import_react22.Suspense, { fallback: import_react22.default.createElement(Loading, null) }, children)
          )
        )
      ),
...
var PREFIX18 = "RaLayout";
var LayoutClasses = {
  appFrame: "".concat(PREFIX18, "-appFrame"),
  contentWithSidebar: "".concat(PREFIX18, "-contentWithSidebar"),
  content: "".concat(PREFIX18, "-content")
};
...
var LinearProgress = function(_a15) {
  var _b = _a15.timeout, timeout = _b === void 0 ? 1e3 : _b, props = __rest22(_a15, ["timeout"]);
  var className = props.className, rest = __rest22(props, ["className"]);
  var oneSecondHasPassed = useTimeout(timeout);
  return oneSecondHasPassed ? React40.createElement(StyledProgress, __assign24({ className }, rest)) : React40.createElement(Box_default, { my: 1, height: 4 });
};
LinearProgress.propTypes = {
  className: import_prop_types19.default.string,
  timeout: import_prop_types19.default.number
};
LinearProgress.displayName = "LinearProgress";
var PREFIX19 = "RaLinearProgress";
...
var LoadingPage = function(_a15) {
  var _b = _a15.loadingPrimary, loadingPrimary = _b === void 0 ? "ra.page.loading" : _b, _c = _a15.loadingSecondary, loadingSecondary = _c === void 0 ? "ra.message.loading" : _c, props = __rest23(_a15, ["loadingPrimary", "loadingSecondary"]);
  return React41.createElement(Loading, __assign25({ loadingPrimary, loadingSecondary }, props));
};
...
var NotFound = function(props) {
  ...
  return React42.createElement(
    ...
    React42.createElement(Title, { defaultTitle: title }),
    React42.createElement(
      "div",
      { className: NotFoundClasses.message },
      React42.createElement(import_HotTub.default, { className: NotFoundClasses.icon }),
      React42.createElement("h1", null, translate("ra.page.not_found")),
      React42.createElement(
        "div",
        null,
    ...
    React42.createElement(
      ...
      React42.createElement(Button_default, { variant: "contained", startIcon: React42.createElement(import_History2.default, null), onClick: goBack2 }, translate("ra.action.back"))
    )
  );
};
var sanitizeRestProps2 = function(_a15) {
  var staticContext = _a15.staticContext, history = _a15.history, location = _a15.location, match = _a15.match, rest = __rest24(_a15, ["staticContext", "history", "location", "match"]);
  return rest;
};
NotFound.propTypes = {
...
var PREFIX20 = "RaNotFound";
var NotFoundClasses = {
  icon: "".concat(PREFIX20, "-icon"),
  message: "".concat(PREFIX20, "-message"),
  toolbar: "".concat(PREFIX20, "-toolbar")
};
var Root10 = styled_default("div", {
  name: PREFIX20,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var Notification = function(props) {
  ...
  var _h = React43.useState(void 0), messageInfo = _h[0], setMessageInfo = _h[1];
  var translate = useTranslate();
  (0, import_react23.useEffect)(function() {
    ...
    if ((_a16 = messageInfo === null || messageInfo === void 0 ? void 0 : messageInfo.notificationOptions) === null || _a16 === void 0 ? void 0 : _a16.undoable) {
    ...
    return function() {
      var _a17;
      if ((_a17 = messageInfo === null || messageInfo === void 0 ? void 0 : messageInfo.notificationOptions) === null || _a17 === void 0 ? void 0 : _a17.undoable) {
  ...
  return React43.createElement(StyledSnackbar, __assign27({ className, open, message: message && typeof message === "string" && translate(message, messageArgs), autoHideDuration: (
    ...
    className: clsx_m_default(NotificationClasses[typeFromMessage || type], (_a15 = {}, _a15[NotificationClasses.multiLine] = multilineFromMessage || multiLine, _a15))
  }, action: undoable ? React43.createElement(
    Button_default,
    { color: "primary", className: NotificationClasses.undo, size: "small", onClick: handleUndo },
    React43.createElement(React43.Fragment, null, translate("ra.action.undo"))
...
var PREFIX21 = "RaNotification";
var NotificationClasses = {
  success: "".concat(PREFIX21, "-success"),
  error: "".concat(PREFIX21, "-error"),
  warning: "".concat(PREFIX21, "-warning"),
  undo: "".concat(PREFIX21, "-undo"),
  multiLine: "".concat(PREFIX21, "-multiLine")
};
var StyledSnackbar = styled_default(Snackbar_default, {
  ...
  var _b;
  var theme = _a15.theme, type = _a15.type;
...
var useTheme2 = function(type) {
  var _a15 = useStore("theme", type), theme = _a15[0], setter = _a15[1];
  return [theme, setter];
};
...
var ThemeProvider2 = function(_a15) {
  var children = _a15.children, themeOverride = _a15.theme;
  ...
  return React44.createElement(ThemeProvider, { theme: themeValue }, children);
};
...
var TopToolbar = function(props) {
  ...
  return React45.createElement(StyledToolbar, __assign28({ disableGutters: true, variant: isXSmall ? "regular" : "dense" }, props));
};
...
var BulkDeleteWithConfirmButton = function(props) {
  var _a15 = props.confirmTitle, confirmTitle = _a15 === void 0 ? "ra.message.bulk_delete_title" : _a15, _b = props.confirmContent, confirmContent = _b === void 0 ? "ra.message.bulk_delete_content" : _b, _c = props.icon, icon = _c === void 0 ? defaultIcon6 : _c, _d = props.label, label = _d === void 0 ? "ra.action.delete" : _d, _e = props.mutationMode, mutationMode = _e === void 0 ? "pessimistic" : _e, _f = props.mutationOptions, mutationOptions = _f === void 0 ? {} : _f, onClick = props.onClick, rest = __rest26(props, ["confirmTitle", "confirmContent", "icon", "label", "mutationMode", "mutationOptions", "onClick"]);
  ...
  return React46.createElement(
    ...
    null,
    React46.createElement(StyledButton3, __assign29({ onClick: handleClick2, label }, sanitizeRestProps3(rest)), icon),
    React46.createElement(Confirm, { isOpen, loading: isLoading, title: confirmTitle, content: confirmContent, translateOptions: {
...
var sanitizeRestProps3 = function(_a15) {
  var classes2 = _a15.classes, filterValues = _a15.filterValues, label = _a15.label, selectedIds = _a15.selectedIds, rest = __rest26(_a15, ["classes", "filterValues", "label", "selectedIds"]);
  return rest;
};
var PREFIX23 = "RaBulkDeleteWithConfirmButton";
...
var defaultIcon6 = React46.createElement(import_Delete.default, null);
BulkDeleteWithConfirmButton.propTypes = {
  confirmTitle: import_prop_types24.default.node,
  confirmContent: import_prop_types24.default.node,
...
var BulkDeleteWithUndoButton = function(props) {
  var _a15 = props.label, label = _a15 === void 0 ? "ra.action.delete" : _a15, _b = props.icon, icon = _b === void 0 ? defaultIcon7 : _b, onClick = props.onClick, _c = props.mutationOptions, mutationOptions = _c === void 0 ? {} : _c, rest = __rest27(props, ["label", "icon", "onClick", "mutationOptions"]);
  ...
  return React47.createElement(StyledButton4, __assign30({ onClick: handleClick2, label, disabled: isLoading }, sanitizeRestProps4(rest)), icon);
};
var defaultIcon7 = React47.createElement(import_Delete2.default, null);
var sanitizeRestProps4 = function(_a15) {
  var classes2 = _a15.classes, filterValues = _a15.filterValues, label = _a15.label, selectedIds = _a15.selectedIds, rest = __rest27(_a15, ["classes", "filterValues", "label", "selectedIds"]);
  return rest;
};
var PREFIX24 = "RaBulkDeleteWithUndoButton";
...
var BulkDeleteButton = function(_a15) {
  var _b = _a15.mutationMode, mutationMode = _b === void 0 ? "undoable" : _b, props = __rest28(_a15, ["mutationMode"]);
  return mutationMode === "undoable" ? React48.createElement(BulkDeleteWithUndoButton, __assign31({}, props)) : React48.createElement(BulkDeleteWithConfirmButton, __assign31({ mutationMode }, props));
};
...
var BulkExportButton = function(props) {
  var onClick = props.onClick, _a15 = props.label, label = _a15 === void 0 ? "ra.action.export" : _a15, _b = props.icon, icon = _b === void 0 ? defaultIcon8 : _b, customExporter = props.exporter, meta = props.meta, rest = __rest29(props, ["onClick", "label", "icon", "exporter", "meta"]);
  ...
  var handleClick2 = (0, import_react27.useCallback)(function(event) {
    exporter && dataProvider.getMany(resource, { ids: selectedIds, meta }).then(function(_a16) {
      var data = _a16.data;
  ...
  return React49.createElement(Button, __assign32({ onClick: handleClick2, label }, sanitizeRestProps5(rest)), icon);
};
var defaultIcon8 = React49.createElement(import_GetApp.default, null);
var sanitizeRestProps5 = function(_a15) {
  var filterValues = _a15.filterValues, selectedIds = _a15.selectedIds, resource = _a15.resource, rest = __rest29(_a15, ["filterValues", "selectedIds", "resource"]);
  return rest;
};
...
var BulkUpdateWithConfirmButton = function(props) {
  ...
  var _a15 = (0, import_react28.useState)(false), isOpen = _a15[0], setOpen = _a15[1];
  ...
  return React50.createElement(
    ...
    null,
    React50.createElement(StyledButton5, __assign33({ onClick: handleClick2, label }, sanitizeRestProps6(rest)), icon),
    React50.createElement(Confirm, { isOpen, loading: isLoading, title: confirmTitle, content: confirmContent, translateOptions: {
      smart_count: selectedIds.length,
      name: translate("resources.".concat(resource, ".forcedCaseName"), {
        smart_count: selectedIds.length,
...
var sanitizeRestProps6 = function(_a15) {
  var filterValues = _a15.filterValues, label = _a15.label, onSuccess = _a15.onSuccess, onError = _a15.onError, rest = __rest30(_a15, ["filterValues", "label", "onSuccess", "onError"]);
  return rest;
};
BulkUpdateWithConfirmButton.propTypes = {
  confirmTitle: import_prop_types28.default.node,
  confirmContent: import_prop_types28.default.node,
...
var PREFIX25 = "RaBulkUpdateWithConfirmButton";
...
var defaultIcon9 = React50.createElement(import_Update.default, null);
...
var BulkUpdateWithUndoButton = function(props) {
  ...
  var unselectAll = useUnselectAll(resource);
  var refresh = useRefresh();
  var data = props.data, _a15 = props.label, label = _a15 === void 0 ? "ra.action.update" : _a15, _b = props.icon, icon = _b === void 0 ? defaultIcon10 : _b, onClick = props.onClick, _c = props.onSuccess, onSuccess = _c === void 0 ? function() {
    notify("ra.notification.updated", {
      type: "info",
      messageArgs: { smart_count: selectedIds.length },
      undoable: true
  ...
  return React51.createElement(StyledButton6, __assign34({ onClick: handleClick2, label, disabled: isLoading }, sanitizeRestProps7(rest)), icon);
};
var defaultIcon10 = React51.createElement(import_Update2.default, null);
var sanitizeRestProps7 = function(_a15) {
  var filterValues = _a15.filterValues, label = _a15.label, selectedIds = _a15.selectedIds, onSuccess = _a15.onSuccess, onError = _a15.onError, rest = __rest31(_a15, ["filterValues", "label", "selectedIds", "onSuccess", "onError"]);
  return rest;
};
...
var PREFIX26 = "RaBulkUpdateWithUndoButton";
...
var BulkUpdateButton = function(props) {
  var _a15 = props.mutationMode, mutationMode = _a15 === void 0 ? "undoable" : _a15, _b = props.data, data = _b === void 0 ? defaultData : _b, rest = __rest32(props, ["mutationMode", "data"]);
  return mutationMode === "undoable" ? React52.createElement(BulkUpdateWithUndoButton, __assign35({ data }, rest)) : React52.createElement(BulkUpdateWithConfirmButton, __assign35({ mutationMode, data }, rest));
};
...
var DeleteWithUndoButton = function(props) {
  var _a15 = props.label, label = _a15 === void 0 ? "ra.action.delete" : _a15, className = props.className, _b = props.icon, icon = _b === void 0 ? defaultIcon11 : _b, onClick = props.onClick, _c = props.redirect, redirect = _c === void 0 ? "list" : _c, mutationOptions = props.mutationOptions, _d = props.color, color = _d === void 0 ? "error" : _d, rest = __rest33(props, ["label", "className", "icon", "onClick", "redirect", "mutationOptions", "color"]);
  var record = useRecordContext(props);
  var resource = useResourceContext(props);
  ...
  return React53.createElement(Button, __assign36({ onClick: handleDelete, disabled: isLoading, label, className: clsx_m_default("ra-delete-button", className), key: "button", color }, rest), icon);
};
var defaultIcon11 = React53.createElement(import_Delete3.default, null);
...
var DeleteWithConfirmButton = function(props) {
  var className = props.className, _a15 = props.confirmTitle, confirmTitle = _a15 === void 0 ? "ra.message.delete_title" : _a15, _b = props.confirmContent, confirmContent = _b === void 0 ? "ra.message.delete_content" : _b, _c = props.icon, icon = _c === void 0 ? defaultIcon12 : _c, _d = props.label, label = _d === void 0 ? "ra.action.delete" : _d, _e = props.mutationMode, mutationMode = _e === void 0 ? "pessimistic" : _e, onClick = props.onClick, _f = props.redirect, redirect = _f === void 0 ? "list" : _f, _g = props.translateOptions, translateOptions = _g === void 0 ? {} : _g, mutationOptions = props.mutationOptions, _h = props.color, color = _h === void 0 ? "error" : _h, rest = __rest34(props, ["className", "confirmTitle", "confirmContent", "icon", "label", "mutationMode", "onClick", "redirect", "translateOptions", "mutationOptions", "color"]);
  var translate = useTranslate();
  var record = useRecordContext(props);
  var resource = useResourceContext(props);
  ...
  return import_react29.default.createElement(
    ...
    null,
    import_react29.default.createElement(Button, __assign37({ onClick: handleDialogOpen, label, className: clsx_m_default("ra-delete-button", className), key: "button", color }, rest), icon),
    import_react29.default.createElement(Confirm, { isOpen: open, loading: isLoading, title: confirmTitle, content: confirmContent, translateOptions: __assign37({ name: translate("resources.".concat(resource, ".forcedCaseName"), {
      smart_count: 1,
...
DeleteWithConfirmButton.propTypes = {
  ...
  confirmTitle: import_prop_types32.default.node,
  confirmContent: import_prop_types32.default.node,
...
var DeleteButton = function(props) {
  ...
  return finalMutationMode === "undoable" ? (
    ...
    React55.createElement(DeleteWithUndoButton, __assign38({ record }, rest))
  ) : React55.createElement(DeleteWithConfirmButton, __assign38({
    // @ts-ignore I looked for the error for one hour without finding it
...
var EditButton = function(props) {
  var _a15 = props.icon, icon = _a15 === void 0 ? defaultIcon13 : _a15, _b = props.label, label = _b === void 0 ? "ra.action.edit" : _b, _c = props.scrollToTop, scrollToTop = _c === void 0 ? true : _c, className = props.className, rest = __rest36(props, ["icon", "label", "scrollToTop", "className"]);
  var resource = useResourceContext(props);
  var record = useRecordContext(props);
  var createPath = useCreatePath();
  if (!record)
    return null;
  return React56.createElement(StyledButton7, __assign39({ component: Link, to: createPath({ type: "edit", resource, id: record.id }), state: scrollStates3[String(scrollToTop)], label, onClick: stopPropagation3, className: clsx_m_default(EditButtonClasses.root, className) }, rest), icon);
};
var scrollStates3 = {
  true: { _scrollToTop: true },
  false: {}
};
var defaultIcon13 = React56.createElement(import_Create.default, null);
...
var PREFIX27 = "RaEditButton";
var EditButtonClasses = {
  root: "".concat(PREFIX27, "-root")
};
...
var ExportButton = function(props) {
  var _a15 = props.maxResults, maxResults = _a15 === void 0 ? 1e3 : _a15, onClick = props.onClick, _b = props.label, label = _b === void 0 ? "ra.action.export" : _b, _c = props.icon, icon = _c === void 0 ? defaultIcon14 : _c, customExporter = props.exporter, meta = props.meta, rest = __rest37(props, ["maxResults", "onClick", "label", "icon", "exporter", "meta"]);
  ...
  return React57.createElement(Button, __assign40({ onClick: handleClick2, label, disabled: total === 0 }, sanitizeRestProps8(rest)), icon);
};
var defaultIcon14 = React57.createElement(import_GetApp2.default, null);
var sanitizeRestProps8 = function(_a15) {
  var filterValues = _a15.filterValues, resource = _a15.resource, rest = __rest37(_a15, ["filterValues", "resource"]);
  return rest;
};
ExportButton.propTypes = {
  ...
  sort: import_prop_types35.default.exact({
    ...
    order: import_prop_types35.default.oneOf(["ASC", "DESC"])
  }),
...
var IconButtonWithTooltip = function(_a15) {
  var label = _a15.label, onClick = _a15.onClick, props = __rest38(_a15, ["label", "onClick"]);
  var translate = useTranslate();
  var _b = React58.useState(false), open = _b[0], setOpen = _b[1];
  var handleClose = function() {
    setOpen(false);
  };
  ...
  return React58.createElement(
    ...
    React58.createElement(IconButton_default, __assign41({ "aria-label": translatedLabel, onClick: handleClick2 }, props))
  );
};
...
var LocalesMenuButton = function(props) {
  var _a15 = (0, import_react31.useState)(null), anchorEl = _a15[0], setAnchorEl = _a15[1];
  ...
  return React59.createElement(
    Root11,
    { component: "span" },
    React59.createElement(Button_default, { color: "inherit", "aria-controls": "simple-menu", "aria-label": "", "aria-haspopup": "true", onClick: handleLanguageClick, startIcon: React59.createElement(import_Translate.default, null), endIcon: React59.createElement(import_ExpandMore2.default, { fontSize: "small" }) }, getNameForLocale(locale)),
    React59.createElement(Menu_default, { id: "simple-menu", anchorEl, keepMounted: true, open: Boolean(anchorEl), onClose: handleClose }, languages.map(function(language) {
      return React59.createElement(MenuItem_default, { key: language.locale, onClick: changeLocale(language.locale), selected: language.locale === locale }, language.name);
    }))
  );
};
var PREFIX28 = "RaLocalesMenuButton";
var LocalesMenuButtonClasses = {};
var Root11 = styled_default(Box_default, {
  name: PREFIX28,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var ListButton = function(props) {
  var _a15 = props.icon, icon = _a15 === void 0 ? defaultIcon15 : _a15, _b = props.label, label = _b === void 0 ? "ra.action.list" : _b, resourceProp = props.resource, _c = props.scrollToTop, scrollToTop = _c === void 0 ? true : _c, rest = __rest39(props, ["icon", "label", "resource", "scrollToTop"]);
  var resource = useResourceContext(props);
  var createPath = useCreatePath();
  return React60.createElement(Button, __assign42({ component: Link, to: createPath({ type: "list", resource }), state: scrollStates4[String(scrollToTop)], label }, rest), icon);
};
var scrollStates4 = {
  true: { _scrollToTop: true },
  false: {}
};
var defaultIcon15 = React60.createElement(import_List.default, null);
ListButton.propTypes = {
  icon: import_prop_types36.default.element,
  label: import_prop_types36.default.string
};

// node_modules/ra-ui-materialui/dist/esm/button/PrevNextButtons.js
var React61 = __toESM(require_react());
var import_Error2 = __toESM(require_Error());
var _a3;
var PrevNextButtons = function(props) {
  var sx = props.sx;
  var _a15 = usePrevNextController(props), hasPrev = _a15.hasPrev, hasNext = _a15.hasNext, prevPath = _a15.prevPath, nextPath = _a15.nextPath, index = _a15.index, total = _a15.total, error = _a15.error, isLoading = _a15.isLoading;
  var translate = useTranslate();
  if (isLoading) {
    return React61.createElement(
      ...
      React61.createElement(LinearProgress, null)
    );
  }
  if (error) {
    return React61.createElement(import_Error2.default, { color: "error", fontSize: "small", titleAccess: "error", "aria-errormessage": error.message });
  }
  if (!hasPrev && !hasNext) {
    return React61.createElement(Box_default, { minHeight: function(theme) {
  ...
  return React61.createElement(
    ...
    React61.createElement(
      "ul",
      { className: clsx_m_default(PrevNextButtonClasses.list) },
      React61.createElement(
        "li",
        null,
        React61.createElement(
          IconButton_default,
          { component: hasPrev ? Link : void 0, to: prevPath, "aria-label": translate("ra.navigation.previous"), disabled: !hasPrev },
          React61.createElement(NavigateBefore_default, null)
        )
      ),
      typeof index === "number" && React61.createElement(
        "li",
        null,
        index + 1,
        " / ",
      ...
      React61.createElement(
        ...
        React61.createElement(
          IconButton_default,
          { component: hasNext ? Link : void 0, to: nextPath, "aria-label": translate("ra.navigation.next"), disabled: !hasNext },
          React61.createElement(NavigateNext_default, null)
        )
      )
    )
  );
};
var PREFIX29 = "RaPrevNextButton";
var PrevNextButtonClasses = {
  list: "".concat(PREFIX29, "-list")
};
var Root12 = styled_default("nav", {
  name: PREFIX29,
  overridesResolver: function(_props, styles) {
    return styles.root;
  }
})((_a3 = {}, _a3["& .".concat(PrevNextButtonClasses.list)] = {
  display: "flex",
  flexWrap: "wrap",
  alignItems: "center",
  padding: 0,
...
var RefreshButton = function(props) {
  var _a15 = props.label, label = _a15 === void 0 ? "ra.action.refresh" : _a15, _b = props.icon, icon = _b === void 0 ? defaultIcon16 : _b, onClick = props.onClick, rest = __rest40(props, ["label", "icon", "onClick"]);
  var refresh = useRefresh();
  ...
  return React62.createElement(Button, __assign43({ label, onClick: handleClick2 }, rest), icon);
};
var defaultIcon16 = React62.createElement(import_Refresh.default, null);
...
var RefreshIconButton = function(props) {
  var _a15 = props.label, label = _a15 === void 0 ? "ra.action.refresh" : _a15, _b = props.icon, icon = _b === void 0 ? defaultIcon17 : _b, onClick = props.onClick, className = props.className, rest = __rest41(props, ["label", "icon", "onClick", "className"]);
  var refresh = useRefresh();
  var translate = useTranslate();
  ...
  return React63.createElement(
    ...
    React63.createElement(IconButton_default, __assign44({ "aria-label": label && translate(label, { _: "Refresh" }), className, color: "inherit", onClick: handleClick2 }, rest), icon)
  );
};
var defaultIcon17 = React63.createElement(import_Refresh2.default, null);
...
var SaveButton = function(props) {
  ...
  var handleSubmit2 = (0, import_react34.useCallback)(function(values) {
    return __awaiter(void 0, void 0, void 0, function() {
      var errors;
      return __generator(this, function(_a16) {
        switch (_a16.label) {
          case 0:
            if (!(saveContext === null || saveContext === void 0 ? void 0 : saveContext.save))
              return [3, 2];
            return [4, saveContext.save(values, __assign45(__assign45({}, mutationOptions), { transform }))];
          case 1:
            errors = _a16.sent();
            _a16.label = 2;
          case 2:
  ...
  return React64.createElement(
    StyledButton8,
    __assign45({ variant, type, color, "aria-label": displayedLabel, disabled, onClick: handleClick2 }, rest),
    isSubmitting ? React64.createElement(CircularProgress_default, { sx: circularProgressStyle, size: 14, thickness: 3, color: "inherit" }) : icon,
    displayedLabel
  );
};
...
var defaultIcon18 = React64.createElement(import_Save.default, null);
...
var SkipNavigationButton = function() {
  return import_react35.default.createElement(StyledButton9, { onClick: skipToContent, className: "skip-nav-button", label: "ra.navigation.skip_nav", variant: "contained" });
};
var PREFIX31 = "RaSkipNavigationButton";
...
var UpdateWithConfirmButton = function(props) {
  ...
  var translate = useTranslate();
  var resource = useResourceContext(props);
  var _a15 = (0, import_react36.useState)(false), isOpen = _a15[0], setOpen = _a15[1];
  var record = useRecordContext(props);
  var _b = props.confirmTitle, confirmTitle = _b === void 0 ? "ra.message.bulk_update_title" : _b, _c = props.confirmContent, confirmContent = _c === void 0 ? "ra.message.bulk_update_content" : _c, data = props.data, _d = props.icon, icon = _d === void 0 ? defaultIcon19 : _d, _e = props.label, label = _e === void 0 ? "ra.action.update" : _e, _f = props.mutationMode, mutationMode = _f === void 0 ? "pessimistic" : _f, onClick = props.onClick, _g = props.mutationOptions, mutationOptions = _g === void 0 ? {} : _g, rest = __rest43(props, ["confirmTitle", "confirmContent", "data", "icon", "label", "mutationMode", "onClick", "mutationOptions"]);
  ...
  return React66.createElement(
    ...
    null,
    React66.createElement(StyledButton10, __assign46({ onClick: handleClick2, label }, sanitizeRestProps9(rest)), icon),
    React66.createElement(Confirm, { isOpen, loading: isLoading, title: confirmTitle, content: confirmContent, translateOptions: {
      smart_count: 1,
      name: translate("resources.".concat(resource, ".forcedCaseName"), {
        smart_count: 1,
...
var sanitizeRestProps9 = function(_a15) {
  var filterValues = _a15.filterValues, label = _a15.label, rest = __rest43(_a15, ["filterValues", "label"]);
  return rest;
};
UpdateWithConfirmButton.propTypes = {
  confirmTitle: import_prop_types40.default.node,
  confirmContent: import_prop_types40.default.node,
  label: import_prop_types40.default.string,
  resource: import_prop_types40.default.string,
  selectedIds: import_prop_types40.default.arrayOf(import_prop_types40.default.any),
  icon: import_prop_types40.default.element,
  data: import_prop_types40.default.any.isRequired,
  mutationMode: import_prop_types40.default.oneOf(["pessimistic", "optimistic", "undoable"])
};
var PREFIX32 = "RaUpdateWithConfirmButton";
...
var defaultIcon19 = React66.createElement(import_Update3.default, null);
...
var UpdateWithUndoButton = function(props) {
  ...
  var resource = useResourceContext(props);
  var refresh = useRefresh();
  var data = props.data, _a15 = props.label, label = _a15 === void 0 ? "ra.action.update" : _a15, _b = props.icon, icon = _b === void 0 ? defaultIcon20 : _b, onClick = props.onClick, _c = props.mutationOptions, mutationOptions = _c === void 0 ? {} : _c, rest = __rest44(props, ["data", "label", "icon", "onClick", "mutationOptions"]);
  ...
  return React67.createElement(StyledButton11, __assign47({ onClick: handleClick2, label, disabled: isLoading }, sanitizeRestProps10(rest)), icon);
};
var defaultIcon20 = React67.createElement(import_Update4.default, null);
var sanitizeRestProps10 = function(_a15) {
  var filterValues = _a15.filterValues, label = _a15.label, selectedIds = _a15.selectedIds, rest = __rest44(_a15, ["filterValues", "label", "selectedIds"]);
  return rest;
};
UpdateWithUndoButton.propTypes = {
  ...
  data: import_prop_types41.default.any.isRequired
};
var PREFIX33 = "RaUpdateWithUndoButton";
...
var UpdateButton = function(props) {
  var _a15 = props.mutationMode, mutationMode = _a15 === void 0 ? "undoable" : _a15, rest = __rest45(props, ["mutationMode"]);
  return mutationMode === "undoable" ? React68.createElement(UpdateWithUndoButton, __assign48({}, rest)) : React68.createElement(UpdateWithConfirmButton, __assign48({ mutationMode }, rest));
};
UpdateButton.propTypes = {
  label: import_prop_types42.default.string,
  resource: import_prop_types42.default.string,
  selectedIds: import_prop_types42.default.arrayOf(import_prop_types42.default.any),
  mutationMode: import_prop_types42.default.oneOf(["pessimistic", "optimistic", "undoable"]),
...
var AuthError = function(props) {
  var className = props.className, _a15 = props.title, title = _a15 === void 0 ? "ra.page.error" : _a15, _b = props.message, message = _b === void 0 ? "ra.message.auth_error" : _b, rest = __rest46(props, ["className", "title", "message"]);
  var translate = useTranslate();
  return React69.createElement(
    ...
    React69.createElement(
      ...
      React69.createElement("h1", null, translate(title, { _: title })),
      React69.createElement("div", null, translate(message, { _: message })),
      React69.createElement(
        Button,
        { to: "/login", label: "ra.auth.sign_in" },
        React69.createElement(import_Lock.default, null)
      )
    )
  );
};
AuthError.propTypes = {
  ...
  message: import_prop_types43.default.string
};
var PREFIX34 = "RaAuthError";
var AuthErrorClasses = {
  root: "".concat(PREFIX34, "-root"),
  message: "".concat(PREFIX34, "-message")
};
var Root13 = styled_default("div", {
  name: PREFIX34,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var AuthCallback = function() {
  ...
  if (error) {
    return React70.createElement(AuthError, { message: error ? error.message : void 0 });
  }
  return React70.createElement(Loading, null);
};
...
var InputHelperText = function(props) {
  ...
  var translate = useTranslate();
  if (touched && error) {
    return React71.createElement(ValidationError_default, { error });
  }
  if (helperText === false) {
    return null;
  }
  if ((0, import_react37.isValidElement)(helperText)) {
    return helperText;
  }
  if (typeof helperText === "string") {
    return React71.createElement(React71.Fragment, null, translate(helperText, { _: helperText }));
  }
  return React71.createElement("span", { dangerouslySetInnerHTML: defaultInnerHTML });
};
...
var sanitizeInputRestProps = function(_a15) {
  var afterSubmit = _a15.afterSubmit, allowNull = _a15.allowNull, alwaysOn = _a15.alwaysOn, beforeSubmit = _a15.beforeSubmit, component = _a15.component, data = _a15.data, defaultValue = _a15.defaultValue, error = _a15.error, format = _a15.format, formatOnBlur = _a15.formatOnBlur, formClassName = _a15.formClassName, initialValue = _a15.initialValue, initializeForm = _a15.initializeForm, input = _a15.input, isEqual9 = _a15.isEqual, isRequired2 = _a15.isRequired, label = _a15.label, limitChoicesToValue = _a15.limitChoicesToValue, locale = _a15.locale, meta = _a15.meta, multiple = _a15.multiple, name = _a15.name, options = _a15.options, optionText = _a15.optionText, optionValue = _a15.optionValue, parse = _a15.parse, record = _a15.record, ref = _a15.ref, refetch = _a15.refetch, render = _a15.render, resource = _a15.resource, setFilter = _a15.setFilter, setPagination = _a15.setPagination, setSort = _a15.setSort, shouldUnregister = _a15.shouldUnregister, source = _a15.source, submitError = _a15.submitError, subscription = _a15.subscription, textAlign = _a15.textAlign, translate = _a15.translate, translateChoice = _a15.translateChoice, validate = _a15.validate, validateFields = _a15.validateFields, value = _a15.value, rest = __rest47(_a15, ["afterSubmit", "allowNull", "alwaysOn", "beforeSubmit", "component", "data", "defaultValue", "error", "format", "formatOnBlur", "formClassName", "initialValue", "initializeForm", "input", "isEqual", "isRequired", "label", "limitChoicesToValue", "locale", "meta", "multiple", "name", "options", "optionText", "optionValue", "parse", "record", "ref", "refetch", "render", "resource", "setFilter", "setPagination", "setSort", "shouldUnregister", "source", "submitError", "subscription", "textAlign", "translate", "translateChoice", "validate", "validateFields", "value"]);
  return rest;
};
...
var _a4;
var Labeled = function(_a15) {
  var _b;
  var _c, _d;
  var children = _a15.children, _e = _a15.className, className = _e === void 0 ? "" : _e, _f = _a15.color, color = _f === void 0 ? "textSecondary" : _f, _g = _a15.component, component = _g === void 0 ? "span" : _g, fullWidth = _a15.fullWidth, isRequired2 = _a15.isRequired, label = _a15.label, resource = _a15.resource, source = _a15.source, rest = __rest48(_a15, ["children", "className", "color", "component", "fullWidth", "isRequired", "label", "resource", "source"]);
  return React72.createElement(
    ...
    ((_d = children.type) === null || _d === void 0 ? void 0 : _d.displayName) !== "Labeled" ? React72.createElement(
      Typography_default,
      { color, className: LabeledClasses.label },
      React72.createElement(FieldTitle_default, { label: label || children.props.label, source: source || children.props.source, resource, isRequired: isRequired2 })
    ) : null,
    children
  );
};
Labeled.displayName = "Labeled";
var PREFIX35 = "RaLabeled";
var LabeledClasses = {
  label: "".concat(PREFIX35, "-label"),
  fullWidth: "".concat(PREFIX35, "-fullWidth")
};
var Root14 = styled_default(Stack_default, {
  ...
  display: "inline-flex",
  marginBottom: "0.2em"
}, _a4["&.".concat(LabeledClasses.fullWidth)] = {
  width: "100%"
}, _a4["& .".concat(LabeledClasses.label)] = {
  fontSize: "0.75em",
  marginBottom: "0.2em"
}, _a4));
...
var ArrayInputContext = (0, import_react38.createContext)(void 0);
...
var ArrayInput = function(props) {
    ...
    rules: {
      validate: function(value) {
        return __awaiter2(void 0, void 0, void 0, function() {
          var error2;
          return __generator2(this, function(_a16) {
            switch (_a16.label) {
              case 0:
  ...
  if (isLoading) {
    return React73.createElement(
      Labeled,
      { label, className },
      React73.createElement(LinearProgress, null)
    );
  }
  var renderHelperText = helperText !== false || (isDirty || isSubmitted) && !!error;
  return React73.createElement(
    Root15,
    __assign51({ fullWidth: true, margin, className: clsx_m_default("ra-input", "ra-input-".concat(source), ArrayInputClasses.root, className), error: (isDirty || isSubmitted) && !!error }, sanitizeInputRestProps(rest)),
    React73.createElement(
      InputLabel_default,
      { htmlFor: source, className: ArrayInputClasses.label, shrink: true, error: (isDirty || isSubmitted) && !!error },
      React73.createElement(FieldTitle_default, { label, source, resource: resourceFromProps, isRequired: isRequired(validate) })
    ),
    React73.createElement(ArrayInputContext.Provider, { value: fieldProps }, (0, import_react39.cloneElement)(import_react39.Children.only(children), __assign51(__assign51({}, fieldProps), { record, resource: resourceFromProps, source, variant, margin, disabled }))),
    renderHelperText ? React73.createElement(
      FormHelperText_default,
      { error: (isDirty || isSubmitted) && !!error },
      React73.createElement(InputHelperText, {
        ...
        error: (_b = (_a15 = error === null || error === void 0 ? void 0 : error.root) === null || _a15 === void 0 ? void 0 : _a15.message) !== null && _b !== void 0 ? _b : error === null || error === void 0 ? void 0 : error.message,
        helperText
      })
    ) : null
  );
...
var PREFIX36 = "RaArrayInput";
var ArrayInputClasses = {
  root: "".concat(PREFIX36, "-root"),
  label: "".concat(PREFIX36, "-label")
};
var Root15 = styled_default(FormControl_default, {
  name: PREFIX36,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var useArrayInput = function(props) {
  var context = (0, import_react40.useContext)(ArrayInputContext);
  var memo22 = (0, import_react40.useMemo)(function() {
    return {
...
var SimpleFormIteratorContext = (0, import_react41.createContext)(void 0);
...
var useSimpleFormIterator = function() {
  return (0, import_react42.useContext)(SimpleFormIteratorContext);
};

// node_modules/ra-ui-materialui/dist/esm/input/ArrayInput/SimpleFormIteratorItemContext.js
var import_react43 = __toESM(require_react());
var SimpleFormIteratorItemContext = (0, import_react43.createContext)(void 0);
...
var SimpleFormIteratorItem = React74.forwardRef(function(props, ref) {
  var children = props.children, disabled = props.disabled, disableReordering = props.disableReordering, disableRemove = props.disableRemove, getItemLabel = props.getItemLabel, index = props.index, _a15 = props.inline, inline = _a15 === void 0 ? false : _a15, member = props.member, record = props.record, removeButton = props.removeButton, reOrderButtons = props.reOrderButtons, resource = props.resource, source = props.source;
  ...
  return React74.createElement(
    ...
    React74.createElement(
      ...
      label && React74.createElement(Typography_default, { variant: "body2", className: SimpleFormIteratorClasses.index }, label),
      React74.createElement("section", { className: clsx_m_default(SimpleFormIteratorClasses.form, inline && SimpleFormIteratorClasses.inline) }, import_react44.Children.map(children, function(input, index2) {
        if (!(0, import_react44.isValidElement)(input)) {
          return null;
        }
        var _a16 = input.props, source2 = _a16.source, inputProps = __rest50(_a16, ["source"]);
        return (0, import_react44.cloneElement)(input, __assign52({ source: source2 ? "".concat(member, ".").concat(source2) : member, index: source2 ? void 0 : index2, resource, disabled }, inputProps));
      })),
      !disabled && React74.createElement(
        "span",
        { className: SimpleFormIteratorClasses.action },
        !disableReordering && (0, import_react44.cloneElement)(reOrderButtons, {
          index,
          max: total,
          reOrder,
          className: clsx_m_default("button-reorder", "button-reorder-".concat(source, "-").concat(index))
        }),
        !disableRemoveField(record) && (0, import_react44.cloneElement)(removeButton, {
...
var AddItemButton = function(props) {
  ...
  return React75.createElement(
    ...
    React75.createElement(import_AddCircleOutline.default, { fontSize: "small" })
  );
};
...
var useSimpleFormIteratorItem = function() {
  return (0, import_react45.useContext)(SimpleFormIteratorItemContext);
};
...
var RemoveItemButton = function(props) {
  ...
  return React76.createElement(
    ...
    React76.createElement(import_RemoveCircleOutline.default, { fontSize: "small" })
  );
};
...
var ReOrderButtons = function(_a15) {
  var className = _a15.className;
  ...
  return React77.createElement(
    ...
    React77.createElement(
      ...
      React77.createElement(import_ArrowCircleUp.default, { fontSize: "small" })
    ),
    React77.createElement(
      IconButtonWithTooltip,
      ...
      React77.createElement(import_ArrowCircleDown.default, { fontSize: "small" })
    )
  );
};
...
var ClearArrayButton = function(props) {
  return React78.createElement(
    ...
    React78.createElement(import_HighlightOff.default, { fontSize: "small" })
  );
};
...
var SimpleFormIterator = function(props) {
  var _a15 = props.addButton, addButton = _a15 === void 0 ? React79.createElement(AddItemButton, null) : _a15, _b = props.removeButton, removeButton = _b === void 0 ? React79.createElement(RemoveItemButton, null) : _b, _c = props.reOrderButtons, reOrderButtons = _c === void 0 ? React79.createElement(ReOrderButtons, null) : _c, children = props.children, className = props.className, resource = props.resource, source = props.source, disabled = props.disabled, _d = props.disableAdd, disableAdd = _d === void 0 ? false : _d, disableClear = props.disableClear, _e = props.disableRemove, disableRemove = _e === void 0 ? false : _e, disableReordering = props.disableReordering, inline = props.inline, _f = props.getItemLabel, getItemLabel = _f === void 0 ? false : _f, fullWidth = props.fullWidth, sx = props.sx;
  var _g = (0, import_react46.useState)(false), confirmIsOpen = _g[0], setConfirmIsOpen = _g[1];
  var _h = useArrayInput(props), append = _h.append, fields = _h.fields, move = _h.move, remove = _h.remove, replace = _h.replace;
  var resetField = useFormContext().resetField;
  var translate = useTranslate();
  var record = useRecordContext(props);
  var initialDefaultValue = (0, import_react46.useRef)({});
  var removeField = (0, import_react46.useCallback)(function(index) {
    remove(index);
  }, [remove]);
  if (fields.length > 0) {
  ...
  var addField = (0, import_react46.useCallback)(function(item) {
    if (item === void 0) {
      item = void 0;
    }
    ...
    if (item == null) {
      ...
      if (import_react46.Children.count(children) === 1 && React79.isValidElement(import_react46.Children.only(children)) && // @ts-ignore
      !import_react46.Children.only(children).props.source && // Make sure it's not a FormDataConsumer
      import_react46.Children.map(children, function(input) {
        return React79.isValidElement(input) && input.type !== FormDataConsumer_default;
      }).some(Boolean)) {
        defaultValue = "";
      } else {
        defaultValue = defaultValue || {};
        import_react46.Children.forEach(children, function(input) {
          var _a16;
          if (React79.isValidElement(input) && input.type !== FormDataConsumer_default && input.props.source) {
            defaultValue[input.props.source] = (_a16 = input.props.defaultValue) !== null && _a16 !== void 0 ? _a16 : null;
          }
        });
      }
    }
  ...
  var handleReorder = (0, import_react46.useCallback)(function(origin, destination) {
    move(origin, destination);
  }, [move]);
  var handleArrayClear = (0, import_react46.useCallback)(function() {
    replace([]);
  ...
  return fields ? React79.createElement(
    SimpleFormIteratorContext.Provider,
    { value: context },
    React79.createElement(
      Root16,
      { className: clsx_m_default(className, fullWidth && "fullwidth", disabled && "disabled"), sx },
      React79.createElement("ul", { className: SimpleFormIteratorClasses.list }, fields.map(function(member, index) {
        return React79.createElement(SimpleFormIteratorItem, { key: member.id, disabled, disableRemove, disableReordering, fields, getItemLabel, index, member: "".concat(source, ".").concat(index), onRemoveField: removeField, onReorder: handleReorder, record: records && records[index] || {}, removeButton, reOrderButtons, resource, source, inline }, children);
      })),
      !disabled && !(disableAdd && (disableClear || disableRemove)) && React79.createElement(
        "div",
        { className: SimpleFormIteratorClasses.buttons },
        !disableAdd && React79.createElement("div", { className: SimpleFormIteratorClasses.add }, (0, import_react46.cloneElement)(addButton, {
          className: clsx_m_default("button-add", "button-add-".concat(source)),
          onClick: handleAddButtonClick(addButton.props.onClick)
        })),
        fields.length > 0 && !disableClear && !disableRemove && React79.createElement(
          "div",
          { className: SimpleFormIteratorClasses.clear },
          React79.createElement(Confirm, { isOpen: confirmIsOpen, title: translate("ra.action.clear_array_input"), content: translate("ra.message.clear_array_input"), onConfirm: handleArrayClear, onClose: function() {
            return setConfirmIsOpen(false);
          } }),
          React79.createElement(ClearArrayButton, { onClick: function() {
...
SimpleFormIterator.propTypes = {
  addButton: import_prop_types44.default.element,
  removeButton: import_prop_types44.default.element,
  children: import_prop_types44.default.node,
  className: import_prop_types44.default.string,
  field: import_prop_types44.default.object,
  fields: import_prop_types44.default.array,
  fieldState: import_prop_types44.default.object,
  formState: import_prop_types44.default.object,
  fullWidth: import_prop_types44.default.bool,
  inline: import_prop_types44.default.bool,
  record: import_prop_types44.default.object,
  source: import_prop_types44.default.string,
  resource: import_prop_types44.default.string,
  translate: import_prop_types44.default.func,
  disableAdd: import_prop_types44.default.bool,
  disableRemove: import_prop_types44.default.oneOfType([import_prop_types44.default.func, import_prop_types44.default.bool]),
  TransitionProps: import_prop_types44.default.shape({})
};
...
var useSupportCreateSuggestion = function(options) {
  var create2 = options.create, _a15 = options.createLabel, createLabel = _a15 === void 0 ? "ra.action.create" : _a15, _b = options.createItemLabel, createItemLabel = _b === void 0 ? "ra.action.create_item" : _b, _c = options.createValue, createValue = _c === void 0 ? "@@ra-create" : _c, _d = options.optionText, optionText = _d === void 0 ? "name" : _d, filter = options.filter, handleChange = options.handleChange, onCreate = options.onCreate;
  var translate = useTranslate();
  var _e = (0, import_react47.useState)(false), renderOnCreate = _e[0], setRenderOnCreate = _e[1];
  var filterRef = (0, import_react47.useRef)(filter);
  (0, import_react47.useEffect)(function() {
    if (filterRef.current !== filter && filter !== "") {
      filterRef.current = filter;
    }
  }, [filter]);
  var context = (0, import_react47.useMemo)(function() {
    return {
  ...
  return {
    ...
    handleChange: function(eventOrValue) {
      return __awaiter3(void 0, void 0, void 0, function() {
        ...
        return __generator3(this, function(_b2) {
          switch (_b2.label) {
            case 0:
              value = ((_a16 = eventOrValue === null || eventOrValue === void 0 ? void 0 : eventOrValue.target) === null || _a16 === void 0 ? void 0 : _a16.value) || eventOrValue;
              finalValue = Array.isArray(value) ? __spreadArray2([], value, true).pop() : value;
              if (!((finalValue === null || finalValue === void 0 ? void 0 : finalValue.id) === createValue || finalValue === createValue))
                return [3, 3];
              if (!!(0, import_react47.isValidElement)(create2))
                return [3, 2];
    ...
    createElement: renderOnCreate && (0, import_react47.isValidElement)(create2) ? React80.createElement(CreateSuggestionContext.Provider, { value: context }, create2) : null
  };
};
var CreateSuggestionContext = (0, import_react47.createContext)(void 0);
var useCreateSuggestionContext = function() {
  return (0, import_react47.useContext)(CreateSuggestionContext);
};
...
var AutocompleteInput = function(props) {
  ...
  var finalChoices = (0, import_react48.useMemo)(function() {
    var _a16;
    return emptyText == void 0 || isRequired2 || multiple ? allChoices : [
      (_a16 = {}, _a16[optionValue || "id"] = emptyValue, _a16[typeof optionText === "string" ? optionText : "name"] = translate(emptyText, {
        _: emptyText
      }), _a16)
    ].concat(allChoices);
  }, [
  ...
  (0, import_react48.useEffect)(function() {
    if ((0, import_react48.isValidElement)(optionText) && emptyText != void 0) {
      throw new Error("optionText of type React element is not supported when setting emptyText");
    }
    if ((0, import_react48.isValidElement)(optionText) && inputText == void 0) {
      throw new Error("\nIf you provided a React element for the optionText prop, you must also provide the inputText prop (used for the text input)");
    }
    if ((0, import_react48.isValidElement)(optionText) && !isFromReference && // eslint-disable-next-line eqeqeq
  ...
  var _p = (0, import_react48.useState)(""), filterValue = _p[0], setFilterValue = _p[1];
  var handleChange = function(newValue) {
    ...
    if (multiple) {
      if (Array.isArray(newValue)) {
        ...
        field.onChange(__spreadArray3(__spreadArray3([], (_a16 = field.value) !== null && _a16 !== void 0 ? _a16 : [], true), [getChoiceValue(newValue)], false), newValue);
      }
    } else {
      field.onChange((_b2 = getChoiceValue(newValue)) !== null && _b2 !== void 0 ? _b2 : emptyValue, newValue);
    }
  };
  var debouncedSetFilter = (0, import_react48.useCallback)((0, import_debounce.default)(function(filter) {
    if (setFilter) {
  ...
  var currentValue = (0, import_react48.useRef)(field.value);
  (0, import_react48.useEffect)(function() {
  ...
  var _q = useSupportCreateSuggestion({
    ...
    onCreate,
    optionText
  }), getCreateItem = _q.getCreateItem, handleChangeWithCreateSupport = _q.handleChange, createElement202 = _q.createElement, createId = _q.createId;
  var getOptionLabel = (0, import_react48.useCallback)(function(option, isListItem) {
  ...
  var finalOnBlur = (0, import_react48.useCallback)(function() {
  ...
  var doesQueryMatchSelection = (0, import_react48.useCallback)(function(filter) {
  ...
  var doesQueryMatchSuggestion = (0, import_react48.useCallback)(function(filter) {
  ...
  var suggestions = (0, import_react48.useMemo)(function() {
  ...
  return React81.createElement(
    React81.Fragment,
    null,
    React81.createElement(StyledAutocomplete, __assign56({ blurOnSelect: true, className: clsx_m_default("ra-input", "ra-input-".concat(source), className), clearText: translate(clearText, { _: clearText }), closeText: translate(closeText, { _: closeText }), openOnFocus: true, openText: translate(openText, { _: openText }), id, isOptionEqualToValue, filterSelectedOptions: true, renderInput: function(params) {
      return React81.createElement(TextField_default, __assign56({ name: field.name, label: React81.createElement(FieldTitle_default, { label, source, resource: resourceProp, isRequired: isRequired2 }), error: !!fetchError || (isTouched || isSubmitted) && invalid, helperText: renderHelperText ? React81.createElement(InputHelperText, { touched: isTouched || isSubmitted || fetchError, error: (error === null || error === void 0 ? void 0 : error.message) || (fetchError === null || fetchError === void 0 ? void 0 : fetchError.message), helperText }) : null, margin, variant, className: AutocompleteInputClasses.textField }, TextFieldProps, params, { size }));
    }, multiple, renderTags: function(value, getTagProps) {
      return value.map(function(option, index) {
        return React81.createElement(Chip_default, __assign56({ label: (0, import_react48.isValidElement)(optionText) ? inputText(option) : getChoiceText(option), sx: {
          ".MuiSvgIcon-root": {
    ...
    shouldRenderSuggestions(filterValue) ? suggestions : [], getOptionLabel, inputValue: filterValue, loading: isLoading && (!finalChoices || finalChoices.length === 0) && oneSecondHasPassed, value: selectedChoice, onChange: handleAutocompleteChange, onBlur: finalOnBlur, onInputChange: handleInputChange, renderOption: function(props2, record) {
      ...
      return React81.createElement("li", __assign56({}, props2), optionLabel === "" ? " " : optionLabel);
    } })),
    createElement202
  );
};
var PREFIX37 = "RaAutocompleteInput";
var AutocompleteInputClasses = {
  textField: "".concat(PREFIX37, "-textField")
};
...
var useSelectedChoice = function(value, _a15) {
  var choices2 = _a15.choices, multiple = _a15.multiple, optionValue = _a15.optionValue;
  var selectedChoiceRef = (0, import_react48.useRef)(getSelectedItems(choices2, value, optionValue, multiple));
  var _b = (0, import_react48.useState)(function() {
...
var areSelectedItemsEqual = function(selectedChoice, newSelectedChoice, optionValue, multiple) {
  ...
  if (multiple) {
    var selectedChoiceArray = (_a15 = selectedChoice) !== null && _a15 !== void 0 ? _a15 : [];
...
var AutocompleteArrayInput = function(_a15) {
  var defaultValue = _a15.defaultValue, props = __rest53(_a15, ["defaultValue"]);
  return React82.createElement(AutocompleteInput, __assign57({}, props, { multiple: true, defaultValue: defaultValue !== null && defaultValue !== void 0 ? defaultValue : [] }));
};
...
var InputPropTypes = {
  label: import_prop_types45.default.oneOfType([
    import_prop_types45.default.string,
    import_prop_types45.default.bool,
    import_prop_types45.default.element
  ]),
  resource: import_prop_types45.default.string,
  source: import_prop_types45.default.string
};
...
var BooleanInput = function(props) {
  var className = props.className, _a15 = props.row, row = _a15 === void 0 ? false : _a15, _b = props.defaultValue, defaultValue = _b === void 0 ? false : _b, format = props.format, label = props.label, fullWidth = props.fullWidth, helperText = props.helperText, onBlur = props.onBlur, onChange = props.onChange, onFocus = props.onFocus, disabled = props.disabled, parse = props.parse, resource = props.resource, source = props.source, validate = props.validate, _c = props.options, options = _c === void 0 ? defaultOptions : _c, sx = props.sx, rest = __rest54(props, ["className", "row", "defaultValue", "format", "label", "fullWidth", "helperText", "onBlur", "onChange", "onFocus", "disabled", "parse", "resource", "source", "validate", "options", "sx"]);
  var _d = useInput(__assign58({ defaultValue, format, parse, resource, source, onBlur, onChange, type: "checkbox", validate }, rest)), id = _d.id, field = _d.field, isRequired2 = _d.isRequired, _e = _d.fieldState, error = _e.error, invalid = _e.invalid, isTouched = _e.isTouched, isSubmitted = _d.formState.isSubmitted;
  var handleChange = (0, import_react49.useCallback)(function(event) {
  ...
  return React83.createElement(
    ...
    React83.createElement(FormControlLabel_default, { inputRef: field.ref, control: React83.createElement(Switch_default, __assign58({ id, name: field.name, color: "primary", onChange: handleChange, onFocus, checked: Boolean(field.value) }, sanitizeInputRestProps(rest), options, { disabled })), label: React83.createElement(FieldTitle_default, { label, source, resource, isRequired: isRequired2 }) }),
    renderHelperText ? React83.createElement(
      FormHelperText_default,
      { error: (isTouched || isSubmitted) && invalid },
      React83.createElement(InputHelperText, { touched: isTouched || isSubmitted, error: error === null || error === void 0 ? void 0 : error.message, helperText })
    ) : null
  );
};
BooleanInput.propTypes = __assign58(__assign58({}, InputPropTypes), {
  // @ts-ignore
  options: import_prop_types46.default.shape(Switch_default.propTypes),
...
var CheckboxGroupInputItem = function(props) {
  ...
  var _a15 = useChoices({
    ...
    optionValue,
    translateChoice
  }), getChoiceText = _a15.getChoiceText, getChoiceValue = _a15.getChoiceValue;
  var choiceName = getChoiceText(choice);
  return React84.createElement(StyledFormControlLabel, { htmlFor: "".concat(id, "_").concat(getChoiceValue(choice)), key: getChoiceValue(choice), onChange, className, inputRef, control: React84.createElement(Checkbox_default, __assign59({ id: "".concat(id, "_").concat(getChoiceValue(choice)), color: "primary", className: CheckboxGroupInputItemClasses.checkbox, checked: value ? value.find(function(v) {
...
var PREFIX38 = "RaCheckboxGroupInputItem";
...
})((_a5 = {}, _a5["& .".concat(CheckboxGroupInputItemClasses.checkbox)] = {
  height: 32
}, _a5));
...
var CheckboxGroupInput = function(props) {
  var choicesProp = props.choices, className = props.className, classesOverride = props.classes, format = props.format, helperText = props.helperText, label = props.label, labelPlacement = props.labelPlacement, isLoadingProp = props.isLoading, isFetchingProp = props.isFetching, _a15 = props.margin, margin = _a15 === void 0 ? "dense" : _a15, onBlur = props.onBlur, onChange = props.onChange, options = props.options, _b = props.optionText, optionText = _b === void 0 ? "name" : _b, _c = props.optionValue, optionValue = _c === void 0 ? "id" : _c, parse = props.parse, resourceProp = props.resource, _d = props.row, row = _d === void 0 ? true : _d, sourceProp = props.source, translateChoice = props.translateChoice, validate = props.validate, rest = __rest56(props, ["choices", "className", "classes", "format", "helperText", "label", "labelPlacement", "isLoading", "isFetching", "margin", "onBlur", "onChange", "options", "optionText", "optionValue", "parse", "resource", "row", "source", "translateChoice", "validate"]);
  ...
  var handleCheck = (0, import_react50.useCallback)(function(event, isChecked) {
    ...
    if (isChecked) {
      formOnChange(__spreadArray4(__spreadArray4([], value || [], true), [newValue], false));
    } else {
  ...
  if (isLoading && (!allChoices || allChoices.length === 0)) {
    return React85.createElement(
      ...
      React85.createElement(LinearProgress, null)
    );
  }
  var renderHelperText = !!fetchError || helperText !== false || (isTouched || isSubmitted) && invalid;
  return React85.createElement(
    StyledFormControl,
    __assign60({ component: "fieldset", margin, error: fetchError || (isTouched || isSubmitted) && invalid, className: clsx_m_default("ra-input", "ra-input-".concat(source), className) }, sanitizeRestProps11(rest)),
    React85.createElement(
      FormLabel_default,
      { component: "legend", className: CheckboxGroupInputClasses.label },
      React85.createElement(FieldTitle_default, { label, source, resource, isRequired: isRequired2 })
    ),
    React85.createElement(FormGroup_default, { row }, allChoices === null || allChoices === void 0 ? void 0 : allChoices.map(function(choice, index) {
      return React85.createElement(CheckboxGroupInputItem, __assign60({ key: (0, import_get5.default)(choice, optionValue), choice, id, onChange: handleCheck, options, optionText, optionValue, translateChoice: translateChoice !== null && translateChoice !== void 0 ? translateChoice : !isFromReference, value, labelPlacement, inputRef: index === 0 ? ref : void 0 }, sanitizeRestProps11(rest)));
    })),
    renderHelperText ? React85.createElement(
      FormHelperText_default,
      { error: fetchError || (isTouched || isSubmitted) && !!error, className: CheckboxGroupInputClasses.helperText },
      React85.createElement(InputHelperText, { touched: isTouched || isSubmitted || fetchError, error: (error === null || error === void 0 ? void 0 : error.message) || (fetchError === null || fetchError === void 0 ? void 0 : fetchError.message), helperText })
    ) : null
  );
};
var sanitizeRestProps11 = function(_a15) {
  var refetch = _a15.refetch, setFilter = _a15.setFilter, setPagination = _a15.setPagination, setSort = _a15.setSort, loaded = _a15.loaded, touched = _a15.touched, rest = __rest56(_a15, ["refetch", "setFilter", "setPagination", "setSort", "loaded", "touched"]);
  return sanitizeInputRestProps(rest);
};
CheckboxGroupInput.propTypes = {
  choices: import_prop_types47.default.arrayOf(import_prop_types47.default.any),
  className: import_prop_types47.default.string,
  source: import_prop_types47.default.string,
  optionText: import_prop_types47.default.oneOfType([
    import_prop_types47.default.string,
    import_prop_types47.default.func,
    import_prop_types47.default.element
  ]),
  optionValue: import_prop_types47.default.string,
  row: import_prop_types47.default.bool,
  resource: import_prop_types47.default.string,
  translateChoice: import_prop_types47.default.bool
};
var PREFIX39 = "RaCheckboxGroupInput";
var CheckboxGroupInputClasses = {
  label: "".concat(PREFIX39, "-label"),
  helperText: "".concat(PREFIX39, "-helperText")
};
...
var PREFIX40 = "RaDatagrid";
var DatagridClasses = {
  root: "".concat(PREFIX40, "-root"),
  table: "".concat(PREFIX40, "-table"),
  tableWrapper: "".concat(PREFIX40, "-tableWrapper"),
  thead: "".concat(PREFIX40, "-thead"),
  tbody: "".concat(PREFIX40, "-tbody"),
  headerRow: "".concat(PREFIX40, "-headerRow"),
  headerCell: "".concat(PREFIX40, "-headerCell"),
  checkbox: "".concat(PREFIX40, "-checkbox"),
  row: "".concat(PREFIX40, "-row"),
  clickableRow: "".concat(PREFIX40, "-clickableRow"),
  rowEven: "".concat(PREFIX40, "-rowEven"),
  rowOdd: "".concat(PREFIX40, "-rowOdd"),
  rowCell: "".concat(PREFIX40, "-rowCell"),
  selectable: "".concat(PREFIX40, "-selectable"),
  expandHeader: "".concat(PREFIX40, "-expandHeader"),
  expandIconCell: "".concat(PREFIX40, "-expandIconCell"),
  expandIcon: "".concat(PREFIX40, "-expandIcon"),
  expandable: "".concat(PREFIX40, "-expandable"),
  expanded: "".concat(PREFIX40, "-expanded"),
  expandedPanel: "".concat(PREFIX40, "-expandedPanel")
};
...
var DatagridCell = React86.forwardRef(function(_a15, ref) {
  var className = _a15.className, field = _a15.field, record = _a15.record, resource = _a15.resource, rest = __rest57(_a15, ["className", "field", "record", "resource"]);
  return React86.createElement(TableCell_default, __assign61({ className: clsx_m_default(className, field.props.cellClassName), align: field.props.textAlign, ref }, rest), field);
});
DatagridCell.propTypes = {
  className: import_prop_types48.default.string,
  field: import_prop_types48.default.element,
  // @ts-ignore
  record: import_prop_types48.default.object,
...
var ExpandRowButton = function(_a15) {
  var expanded = _a15.expanded, expandContentId = _a15.expandContentId, props = __rest58(_a15, ["expanded", "expandContentId"]);
  var translate = useTranslate();
  return React87.createElement(
    ...
    React87.createElement(import_ExpandMore3.default, { fontSize: "inherit" })
  );
};
var ExpandRowButton_default = (0, import_react51.memo)(ExpandRowButton);
...
var DatagridContext = (0, import_react52.createContext)({});
...
var useDatagridContext = function(props) {
  var context = (0, import_react53.useContext)(DatagridContext_default);
...
var DatagridRow = import_react54.default.forwardRef(function(props, ref) {
  ...
  var _h = (0, import_react54.useState)(function() {
  ...
  var handleToggleExpand = (0, import_react54.useCallback)(function(event) {
    toggleExpanded();
    event.stopPropagation();
  }, [toggleExpanded]);
  var handleToggleSelection = (0, import_react54.useCallback)(function(event) {
    if (!selectable)
      return;
    onToggleItem(id, event);
    event.stopPropagation();
  }, [id, onToggleItem, selectable]);
  var handleClick2 = (0, import_react54.useCallback)(function(event) {
  ...
  return import_react54.default.createElement(
    ...
    import_react54.default.createElement(
      TableRow_default,
      __assign63({ ref, className: clsx_m_default(className, (_a15 = {}, _a15[DatagridClasses.expandable] = expandable, _a15[DatagridClasses.selectable] = selectable, _a15[DatagridClasses.clickableRow] = typeof rowClick === "function" ? true : rowClick, _a15)), key: id, style, hover, onClick: handleClick2 }, rest),
      expand && import_react54.default.createElement(TableCell_default, { padding: "none", className: DatagridClasses.expandIconCell }, expandable && import_react54.default.createElement(ExpandRowButton_default, { className: clsx_m_default(DatagridClasses.expandIcon, (_b = {}, _b[DatagridClasses.expanded] = expanded, _b)), expanded, onClick: handleToggleExpand, expandContentId: "".concat(id, "-expand") })),
      hasBulkActions && import_react54.default.createElement(
        TableCell_default,
        { padding: "checkbox" },
        import_react54.default.createElement(Checkbox_default, { "aria-label": translate("ra.action.select_row", {
          _: "Select this row"
      ...
      import_react54.default.Children.map(children, function(field, index) {
        return (0, import_react54.isValidElement)(field) ? import_react54.default.createElement(DatagridCell_default, { key: "".concat(id, "-").concat(field.props.source || index), className: clsx_m_default("column-".concat(field.props.source), DatagridClasses.rowCell), record, field, resource }) : null;
      })
    ),
    expandable && expanded && import_react54.default.createElement(
      TableRow_default,
      { key: "".concat(id, "-expand"), id: "".concat(id, "-expand"), className: DatagridClasses.expandedPanel },
      import_react54.default.createElement(TableCell_default, { colSpan: nbColumns }, (0, import_react_is.isElement)(expand) ? (0, import_react54.cloneElement)(expand, {
        // @ts-ignore
        record,
        resource,
        id: String(id)
      }) : (0, import_react54.createElement)(expand, {
        record,
        resource,
        id: String(id)
      }))
...
DatagridRow.propTypes = {
  ...
  hover: import_prop_types49.default.bool,
  id: import_prop_types49.default.any,
  onToggleItem: import_prop_types49.default.func,
  // @ts-ignore
  record: import_prop_types49.default.object,
  resource: import_prop_types49.default.string,
  // @ts-ignore
  rowClick: import_prop_types49.default.oneOfType([
  ...
  selectable: import_prop_types49.default.bool
};
var areEqual = function(prevProps, nextProps) {
  var _1 = prevProps.children, _2 = prevProps.expand, prevPropsWithoutChildren = __rest59(prevProps, ["children", "expand"]);
  var _3 = nextProps.children, _4 = nextProps.expand, nextPropsWithoutChildren = __rest59(nextProps, ["children", "expand"]);
  return shallowEqual(prevPropsWithoutChildren, nextPropsWithoutChildren);
};
var PureDatagridRow = (0, import_react54.memo)(DatagridRow, areEqual);
...
var DatagridBody = React89.forwardRef(function(_a15, ref) {
  var children = _a15.children, className = _a15.className, _b = _a15.data, data = _b === void 0 ? defaultData2 : _b, expand = _a15.expand, _c = _a15.hasBulkActions, hasBulkActions = _c === void 0 ? false : _c, hover = _a15.hover, onToggleItem = _a15.onToggleItem, resource = _a15.resource, _d = _a15.row, row = _d === void 0 ? defaultChildren : _d, rowClick = _a15.rowClick, rowSx = _a15.rowSx, rowStyle = _a15.rowStyle, selectedIds = _a15.selectedIds, isRowSelectable = _a15.isRowSelectable, rest = __rest60(_a15, ["children", "className", "data", "expand", "hasBulkActions", "hover", "onToggleItem", "resource", "row", "rowClick", "rowSx", "rowStyle", "selectedIds", "isRowSelectable"]);
  return React89.createElement(TableBody_default, __assign64({ ref, className: clsx_m_default("datagrid-body", className, DatagridClasses.tbody) }, rest), data.map(function(record, rowIndex) {
    var _a16;
    var _b2, _c2;
    return (0, import_react55.cloneElement)(row, {
      className: clsx_m_default(DatagridClasses.row, (_a16 = {}, _a16[DatagridClasses.rowEven] = rowIndex % 2 === 0, _a16[DatagridClasses.rowOdd] = rowIndex % 2 !== 0, _a16)),
      expand,
...
var defaultChildren = React89.createElement(DatagridRow_default, null);
DatagridBody.propTypes = {
  className: import_prop_types50.default.string,
  children: import_prop_types50.default.node,
  // @ts-ignore
  data: import_prop_types50.default.arrayOf(import_prop_types50.default.object),
  // @ts-ignore
  expand: import_prop_types50.default.oneOfType([import_prop_types50.default.element, import_prop_types50.default.elementType]),
  hasBulkActions: import_prop_types50.default.bool,
  hover: import_prop_types50.default.bool,
  onToggleItem: import_prop_types50.default.func,
  resource: import_prop_types50.default.string,
  row: import_prop_types50.default.element,
  // @ts-ignore
  rowClick: import_prop_types50.default.oneOfType([
    import_prop_types50.default.string,
    import_prop_types50.default.func,
    import_prop_types50.default.bool
  ]),
  rowSx: import_prop_types50.default.func,
  rowStyle: import_prop_types50.default.func,
...
var PureDatagridBody = (0, import_react55.memo)(function(props) {
  return React89.createElement(DatagridBody, __assign64({ row: React89.createElement(PureDatagridRow, null) }, props));
});
...
var DatagridHeaderCell = function(props) {
  ...
  var resource = useResourceContext(props);
  var translate = useTranslate();
  return React90.createElement(StyledTableCell, __assign65({ className: clsx_m_default(className, field.props.headerClassName), align: field.props.textAlign, variant: "head" }, rest), updateSort && field.props.sortable !== false && (field.props.sortBy || field.props.source) ? React90.createElement(
    Tooltip_default,
    ...
    React90.createElement(
      ...
      React90.createElement(FieldTitle_default, { label: field.props.label, source: field.props.source, resource })
    )
  ) : React90.createElement(FieldTitle_default, { label: field.props.label, source: field.props.source, resource }));
};
DatagridHeaderCell.propTypes = {
  className: import_prop_types51.default.string,
  field: import_prop_types51.default.element,
  sort: import_prop_types51.default.shape({
    field: import_prop_types51.default.string,
    order: import_prop_types51.default.oneOf(["ASC", "DESC"])
  }).isRequired,
  isSorting: import_prop_types51.default.bool,
  resource: import_prop_types51.default.string,
  updateSort: import_prop_types51.default.func
};
var DatagridHeaderCell_default = (0, import_react56.memo)(DatagridHeaderCell, function(props, nextProps) {
...
var PREFIX41 = "RaDatagridHeaderCell";
...
})((_a6 = {}, _a6["& .MuiTableSortLabel-icon"] = {
  display: "none"
}, _a6["& .Mui-active .MuiTableSortLabel-icon"] = {
  display: "inline"
}, _a6));
...
var Placeholder = function(props) {
  return React91.createElement(Root17, { className: props.className }, " ");
};
var PREFIX42 = "RaPlaceholder";
var Root17 = styled_default("span", {
  name: PREFIX42,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var DatagridLoading = function(_a15) {
  var className = _a15.className, expand = _a15.expand, hasBulkActions = _a15.hasBulkActions, nbChildren = _a15.nbChildren, _b = _a15.nbFakeLines, nbFakeLines = _b === void 0 ? 5 : _b, size = _a15.size;
  var oneSecondHasPassed = useTimeout(1e3);
  return oneSecondHasPassed ? React92.createElement(
    "div",
    ...
    React92.createElement(
      ...
      React92.createElement(
        ...
        React92.createElement(
          ...
          expand && React92.createElement(TableCell_default, { padding: "none", className: DatagridClasses.expandHeader }),
          hasBulkActions && React92.createElement(
            TableCell_default,
            { padding: "checkbox", className: DatagridClasses.expandIconCell },
            React92.createElement(Checkbox_default, { className: "select-all", color: "primary", checked: false })
          ),
          times(nbChildren, function(key) {
            return React92.createElement(
              TableCell_default,
              { variant: "head", className: DatagridClasses.headerCell, key },
              React92.createElement(Placeholder, null)
            );
          })
        )
      ),
      React92.createElement(TableBody_default, null, times(nbFakeLines, function(key1) {
        return React92.createElement(
          TableRow_default,
          { key: key1, style: { opacity: 1 / (key1 + 1) } },
          expand && React92.createElement(
            TableCell_default,
            ...
            React92.createElement(
              ...
              React92.createElement(import_ExpandMore4.default, null)
            )
          ),
          hasBulkActions && React92.createElement(
            TableCell_default,
...
DatagridLoading.propTypes = {
  ...
  hasBulkActions: import_prop_types52.default.bool,
  nbChildren: import_prop_types52.default.number,
  nbFakeLines: import_prop_types52.default.number,
  size: import_prop_types52.default.oneOf(["small", "medium"])
};
var DatagridLoading_default = (0, import_react57.memo)(DatagridLoading);
...
var ExpandAllButton = function(_a15) {
  var _b;
  var resource = _a15.resource, ids = _a15.ids;
  var translate = useTranslate();
  ...
  return React93.createElement(
    ...
    React93.createElement(import_ExpandMore5.default, { fontSize: "inherit" })
  );
};
var ExpandAllButton_default = (0, import_react58.memo)(ExpandAllButton);

// node_modules/ra-ui-materialui/dist/esm/list/datagrid/DatagridHeader.js
var DatagridHeader = function(props) {
  var children = props.children, className = props.className, _a15 = props.hasExpand, hasExpand = _a15 === void 0 ? false : _a15, _b = props.hasBulkActions, hasBulkActions = _b === void 0 ? false : _b, isRowSelectable = props.isRowSelectable;
  var resource = useResourceContext(props);
  var translate = useTranslate();
  ...
  var updateSortCallback = (0, import_react59.useCallback)(function(event) {
    event.stopPropagation();
  ...
  var handleSelectAll = (0, import_react59.useCallback)(function(event) {
  ...
  return React94.createElement(
    ...
    React94.createElement(
      ...
      hasExpand && React94.createElement(TableCell_default, { padding: "none", className: clsx_m_default(DatagridClasses.headerCell, DatagridClasses.expandHeader) }, !expandSingle ? React94.createElement(ExpandAllButton_default, { resource, ids: data.map(function(record) {
        return record.id;
      }) }) : null),
      hasBulkActions && selectedIds && React94.createElement(
        TableCell_default,
        { padding: "checkbox", className: DatagridClasses.headerCell },
        React94.createElement(Checkbox_default, { "aria-label": translate("ra.action.select_all", {
          _: "Select all"
      ...
      import_react59.Children.map(children, function(field, index) {
        return (0, import_react59.isValidElement)(field) ? React94.createElement(DatagridHeaderCell_default, { className: clsx_m_default(DatagridClasses.headerCell, "column-".concat(field.props.source)), sort, field, isSorting: sort.field === (field.props.sortBy || field.props.source), key: field.props.source || index, resource, updateSort }) : null;
      })
    )
  );
};
DatagridHeader.propTypes = {
  ...
  sort: import_prop_types53.default.exact({
    field: import_prop_types53.default.string,
    order: import_prop_types53.default.oneOf(["ASC", "DESC"])
  }),
  data: import_prop_types53.default.arrayOf(import_prop_types53.default.any),
  hasExpand: import_prop_types53.default.bool,
  hasBulkActions: import_prop_types53.default.bool,
  isRowSelectable: import_prop_types53.default.func,
  isRowExpandable: import_prop_types53.default.func,
  onSelect: import_prop_types53.default.func,
  onToggleItem: import_prop_types53.default.func,
  resource: import_prop_types53.default.string,
  selectedIds: import_prop_types53.default.arrayOf(import_prop_types53.default.any),
  setSort: import_prop_types53.default.func
};
DatagridHeader.displayName = "DatagridHeader";

// node_modules/ra-ui-materialui/dist/esm/list/datagrid/DatagridContextProvider.js
var import_react60 = __toESM(require_react());
var DatagridContextProvider = function(_a15) {
  var children = _a15.children, value = _a15.value;
  return import_react60.default.createElement(DatagridContext_default.Provider, { value }, children);
};
...
var BulkActionsToolbar = function(props) {
  var _a15;
  var _b = props.label, label = _b === void 0 ? "ra.action.bulk_actions" : _b, children = props.children, className = props.className, rest = __rest62(props, ["label", "children", "className"]);
  ...
  var translate = useTranslate();
  var handleUnselectAllClick = (0, import_react61.useCallback)(function() {
    onUnselectItems();
  }, [onUnselectItems]);
  return React96.createElement(
    ...
    React96.createElement(
      Toolbar_default,
      __assign66({ "data-test": "bulk-actions-toolbar", className: clsx_m_default(BulkActionsToolbarClasses.toolbar, (_a15 = {}, _a15[BulkActionsToolbarClasses.collapsed] = selectedIds.length === 0, _a15)) }, sanitizeListRestProps(rest)),
      React96.createElement(
        "div",
        ...
        React96.createElement(
          ...
          React96.createElement(import_Close.default, { fontSize: "small" })
        ),
        React96.createElement(Typography_default, { color: "inherit", variant: "subtitle1" }, translate(label, {
          _: label,
          smart_count: selectedIds.length
        }))
      ),
      React96.createElement(TopToolbar_default, { className: BulkActionsToolbarClasses.topToolbar }, import_react61.Children.map(children, function(child) {
        return (0, import_react61.isValidElement)(child) ? (0, import_react61.cloneElement)(child, {
          filterValues,
          resource,
          selectedIds
        }) : null;
...
var PREFIX43 = "RaBulkActionsToolbar";
var BulkActionsToolbarClasses = {
  toolbar: "".concat(PREFIX43, "-toolbar"),
  topToolbar: "".concat(PREFIX43, "-topToolbar"),
  buttons: "".concat(PREFIX43, "-buttons"),
  collapsed: "".concat(PREFIX43, "-collapsed"),
  title: "".concat(PREFIX43, "-title"),
  icon: "".concat(PREFIX43, "-icon")
};
...
var ListNoResults = (0, import_react62.memo)(function() {
  var translate = useTranslate();
  var resource = useResourceContext();
  return React97.createElement(
    CardContent_default,
    null,
    React97.createElement(Typography_default, { variant: "body2" }, translate("ra.navigation.no_results", { resource }))
  );
});
...
var Datagrid = React98.forwardRef(function(props, ref) {
  ...
  var contextValue = (0, import_react63.useMemo)(function() {
    return { isRowExpandable, expandSingle };
  }, [
    isRowExpandable,
    expandSingle
  ]);
  var lastSelected = (0, import_react63.useRef)(null);
  (0, import_react63.useEffect)(function() {
    if (!selectedIds || selectedIds.length === 0) {
      lastSelected.current = null;
    }
  }, [JSON.stringify(selectedIds)]);
  var handleToggleItem = (0, import_react63.useCallback)(function(id, event) {
  ...
  if (isLoading === true) {
    return React98.createElement(DatagridLoading_default, { className, expand, hasBulkActions, nbChildren: React98.Children.count(children), size });
  }
  ...
  return React98.createElement(
    ...
    React98.createElement(
      ...
      bulkActionButtons !== false ? React98.createElement(BulkActionsToolbar, { selectedIds }, (0, import_react63.isValidElement)(bulkActionButtons) ? bulkActionButtons : defaultBulkActionButtons) : null,
      React98.createElement(
        "div",
        { className: DatagridClasses.tableWrapper },
        React98.createElement(
          Table_default,
          __assign67({ ref, className: DatagridClasses.table, size }, sanitizeRestProps12(rest)),
...
var createOrCloneElement = function(element, props, children) {
  return (0, import_react63.isValidElement)(element) ? (0, import_react63.cloneElement)(element, props, children) : (0, import_react63.createElement)(element, props, children);
};
Datagrid.propTypes = {
  // @ts-ignore
  body: import_prop_types55.default.oneOfType([import_prop_types55.default.element, import_prop_types55.default.elementType]),
  // @ts-ignore-line
  bulkActionButtons: import_prop_types55.default.oneOfType([import_prop_types55.default.bool, import_prop_types55.default.element]),
  children: import_prop_types55.default.node.isRequired,
  className: import_prop_types55.default.string,
  sort: import_prop_types55.default.exact({
    field: import_prop_types55.default.string,
    order: import_prop_types55.default.oneOf(["ASC", "DESC"])
  }),
  data: import_prop_types55.default.arrayOf(import_prop_types55.default.any),
  empty: import_prop_types55.default.element,
  // @ts-ignore
  expand: import_prop_types55.default.oneOfType([import_prop_types55.default.element, import_prop_types55.default.elementType]),
  // @ts-ignore
  header: import_prop_types55.default.oneOfType([import_prop_types55.default.element, import_prop_types55.default.elementType]),
  hover: import_prop_types55.default.bool,
  isLoading: import_prop_types55.default.bool,
  onSelect: import_prop_types55.default.func,
  onToggleItem: import_prop_types55.default.func,
  resource: import_prop_types55.default.string,
  // @ts-ignore
  rowClick: import_prop_types55.default.oneOfType([
    import_prop_types55.default.string,
    import_prop_types55.default.func,
    import_prop_types55.default.bool
  ]),
  rowSx: import_prop_types55.default.func,
  rowStyle: import_prop_types55.default.func,
  selectedIds: import_prop_types55.default.arrayOf(import_prop_types55.default.any),
  setSort: import_prop_types55.default.func,
  total: import_prop_types55.default.number,
  isRowSelectable: import_prop_types55.default.func,
  isRowExpandable: import_prop_types55.default.func,
  expandSingle: import_prop_types55.default.bool
};
var injectedProps2 = [
  "isRequired",
  "setFilter",
...
var sanitizeRestProps12 = function(props) {
  return Object.keys(sanitizeListRestProps(props)).filter(function(propName) {
    ...
    var _a15;
    return __assign67(__assign67({}, acc), (_a15 = {}, _a15[key] = props[key], _a15));
  }, {});
};
Datagrid.displayName = "Datagrid";
var DefaultEmpty = React98.createElement(ListNoResults, null);
...
var DatagridEditor = function() {
  ...
  return React99.createElement(FieldsSelector, { name: "columns", availableName: "availableColumns" });
};
...
var DatagridConfigurable = function(_a15) {
  var preferenceKey = _a15.preferenceKey, omit = _a15.omit, props = __rest64(_a15, ["preferenceKey", "omit"]);
  if (props.optimized) {
  ...
  React100.useEffect(function() {
    var columns = React100.Children.toArray(props.children).filter(function(child) {
  ...
  return React100.createElement(
    Configurable,
    { editor: React100.createElement(DatagridEditor, null), preferenceKey: finalPreferenceKey, sx: { display: "block", minHeight: 2 } },
    React100.createElement(DatagridWithPreferences, __assign68({}, props))
  );
};
DatagridConfigurable.propTypes = Datagrid.propTypes;
var DatagridWithPreferences = function(_a15) {
  var children = _a15.children, props = __rest64(_a15, ["children"]);
  ...
  var childrenArray = React100.Children.toArray(children);
  return React100.createElement(Datagrid, __assign68({}, props), columns === void 0 ? children : columns.map(function(index) {
...
var SelectColumnsButton = function(props) {
  ...
  var resource = useResourceContext(props);
  var finalPreferenceKey = preferenceKey || "".concat(resource, ".datagrid");
  var _a15 = React101.useState(null), anchorEl = _a15[0], setAnchorEl = _a15[1];
  var _b = useStore("preferences.".concat(finalPreferenceKey, ".availableColumns"), []), availableColumns = _b[0], setAvailableColumns = _b[1];
  ...
  var handleMove = function(index1, index2) {
    ...
    if (index1Pos > index2Pos) {
      newAvailableColumns = __spreadArray5(__spreadArray5(__spreadArray5(__spreadArray5([], availableColumns.slice(0, index2Pos), true), [
        availableColumns[index1Pos]
      ], false), availableColumns.slice(index2Pos, index1Pos), true), availableColumns.slice(index1Pos + 1), true);
    } else {
      newAvailableColumns = __spreadArray5(__spreadArray5(__spreadArray5(__spreadArray5([], availableColumns.slice(0, index1Pos), true), availableColumns.slice(index1Pos + 1, index2Pos + 1), true), [
        availableColumns[index1Pos]
  ...
  return React101.createElement(
    React101.Fragment,
    null,
    isXSmall ? React101.createElement(
      Tooltip_default,
      { title },
      React101.createElement(
        ...
        React101.createElement(import_ViewWeek.default, null)
      )
    ) : React101.createElement(StyledButton12, __assign69({ size: "small", onClick: handleClick2, startIcon: React101.createElement(import_ViewWeek.default, null) }, sanitizeRestProps13(props)), title),
    React101.createElement(
      Popover_default,
      ...
      React101.createElement(Box_default, { p: 1 }, availableColumns.map(function(column) {
        return React101.createElement(FieldToggle, { key: column.index, source: column.source, label: column.label, index: column.index, selected: columns.includes(column.index), onToggle: handleToggle, onMove: handleMove });
      }))
    )
  );
};
var StyledButton12 = styled_default(Button_default, {
...
var sanitizeRestProps13 = function(_a15) {
  var _b = _a15.resource, resource = _b === void 0 ? null : _b, _c = _a15.preferenceKey, preferenceKey = _c === void 0 ? null : _c, rest = __rest65(_a15, ["resource", "preferenceKey"]);
  return rest;
};
...
var FilterFormInput = function(props) {
  ...
  return React102.createElement(
    ...
    React102.cloneElement(filterElement, {
      resource,
      record: emptyRecord,
      size: (_a15 = filterElement.props.size) !== null && _a15 !== void 0 ? _a15 : "small",
      helperText: false,
      // ignore defaultValue in Field because it was already set in Form (via mergedInitialValuesWithDefaultValues)
      defaultValue: void 0
    }),
    !filterElement.props.alwaysOn && React102.createElement(
      IconButton_default,
      ...
      React102.createElement(import_RemoveCircleOutline2.default, null)
    ),
    React102.createElement("div", { className: FilterFormInputClasses.spacer }, " ")
  );
};
FilterFormInput.propTypes = {
  filterElement: import_prop_types56.default.node,
  handleHide: import_prop_types56.default.func,
  resource: import_prop_types56.default.string,
  className: import_prop_types56.default.string
};
var PREFIX44 = "RaFilterFormInput";
var FilterFormInputClasses = {
  spacer: "".concat(PREFIX44, "-spacer"),
  hideButton: "".concat(PREFIX44, "-hideButton")
};
var Root19 = styled_default("div", {
  name: PREFIX44,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var FilterContext = React103.createContext(void 0);
...
var FilterForm = function(props) {
  ...
  var _a15 = useListContext(props), setFilters = _a15.setFilters, displayedFilters = _a15.displayedFilters, filterValues = _a15.filterValues;
  var filters = (0, import_react64.useContext)(FilterContext) || filtersProps;
  ...
  (0, import_react64.useEffect)(function() {
    var subscription = form.watch(function(values, _a16) {
      var name = _a16.name;
  ...
  return React104.createElement(
    FormProvider,
    __assign70({}, form),
    React104.createElement(FilterFormBase, __assign70({ onSubmit: handleFormSubmit, filters }, rest))
  );
};
var FilterFormBase = function(props) {
  ...
  var resource = useResourceContext(props);
  var form = useFormContext();
  var _a15 = useListContext(props), _b = _a15.displayedFilters, displayedFilters = _b === void 0 ? {} : _b, hideFilter = _a15.hideFilter;
  (0, import_react64.useEffect)(function() {
  ...
  var handleHide = (0, import_react64.useCallback)(function(event) {
  ...
  return React104.createElement(
    ...
    React104.createElement(
      ...
      getShownFilters().map(function(filterElement) {
        return React104.createElement(FilterFormInput, { key: filterElement.props.source, filterElement, handleHide, resource, className: FilterFormClasses.filterFormInput });
      }),
      React104.createElement("div", { className: FilterFormClasses.clearFix })
    )
  );
};
...
FilterFormBase.propTypes = {
  resource: import_prop_types57.default.string,
  filters: import_prop_types57.default.arrayOf(import_prop_types57.default.node).isRequired,
  displayedFilters: import_prop_types57.default.object,
  hideFilter: import_prop_types57.default.func,
  initialValues: import_prop_types57.default.object,
  className: import_prop_types57.default.string
};
var sanitizeRestProps14 = function(_a15) {
  var displayedFilters = _a15.displayedFilters, filterValues = _a15.filterValues, hasCreate = _a15.hasCreate, hideFilter = _a15.hideFilter, setFilters = _a15.setFilters, resource = _a15.resource, props = __rest66(_a15, ["displayedFilters", "filterValues", "hasCreate", "hideFilter", "setFilters", "resource"]);
  return props;
};
...
var PREFIX45 = "RaFilterForm";
var FilterFormClasses = {
  clearFix: "".concat(PREFIX45, "-clearFix"),
  filterFormInput: "".concat(PREFIX45, "-filterFormInput")
};
...
var getFilterFormValues = function(formValues, filterValues) {
  ...
  return Object.keys(formValues).reduce(function(acc, key) {
    ...
    return acc;
  }, (_a15 = (0, import_cloneDeep.default)(filterValues)) !== null && _a15 !== void 0 ? _a15 : {});
};
var getInputValue = function(formValues, key, filterValues) {
  ...
  if (typeof formValues[key] === "object") {
    var inputValues = Object.keys(formValues[key]).reduce(function(acc, innerKey) {
      var _a15;
      var nestedInputValue = getInputValue(formValues[key], innerKey, (_a15 = (filterValues || {})[key]) !== null && _a15 !== void 0 ? _a15 : {});
      if (nestedInputValue === "") {
        return acc;
      }
...
var FilterButtonMenuItem = (0, import_react65.forwardRef)(function(props, ref) {
  var filter = props.filter, onShow = props.onShow, autoFocus = props.autoFocus;
  var resource = useResourceContext(props);
  var handleShow = (0, import_react65.useCallback)(function() {
    onShow({
  ...
  return React105.createElement(
    ...
    React105.createElement(FieldTitle_default, { label: filter.props.label, source: filter.props.source, resource })
  );
});
FilterButtonMenuItem.propTypes = {
  filter: import_prop_types58.default.element.isRequired,
  onShow: import_prop_types58.default.func.isRequired,
  resource: import_prop_types58.default.string,
...
var isValidSavedQuery = function(savedQuery) {
  var _a15, _b;
  if (savedQuery.label && typeof savedQuery.label === "string" && savedQuery.value && typeof Array.isArray(savedQuery.value.displayedFilters) && typeof savedQuery.value.perPage === "number" && typeof ((_a15 = savedQuery.value.sort) === null || _a15 === void 0 ? void 0 : _a15.field) === "string" && typeof ((_b = savedQuery.value.sort) === null || _b === void 0 ? void 0 : _b.order) === "string" && typeof savedQuery.value.filter === "object") {
    return true;
  }
  return false;
};
...
var AddSavedQueryDialog = function(_a15) {
  var open = _a15.open, onClose = _a15.onClose;
  var translate = useTranslate();
  ...
  var _d = (0, import_react66.useState)(""), queryName = _d[0], setQueryName = _d[1];
  ...
  return React106.createElement(
    ...
    React106.createElement(DialogTitle_default, { id: "form-dialog-title" }, translate("ra.saved_queries.new_dialog_title", {
    ...
    React106.createElement(
      DialogActions_default,
      null,
      React106.createElement(Button_default, { onClick: onClose }, translate("ra.action.cancel")),
      React106.createElement(Button_default, { onClick: addQuery, color: "primary" }, translate("ra.action.save"))
    )
  );
};
...
var RemoveSavedQueryDialog = function(_a15) {
  var open = _a15.open, onClose = _a15.onClose;
  var translate = useTranslate();
  ...
  var removeQuery = function() {
    ...
    setSavedQueries(__spreadArray6(__spreadArray6([], newSavedQueries.slice(0, index), true), newSavedQueries.slice(index + 1), true));
    onClose();
  };
  return React107.createElement(
    Dialog_default,
    { open, onClose, "aria-labelledby": "alert-dialog-title", "aria-describedby": "alert-dialog-description" },
    React107.createElement(DialogTitle_default, { id: "alert-dialog-title" }, translate("ra.saved_queries.remove_dialog_title", {
      _: "Remove saved query?"
    })),
    React107.createElement(
      DialogContent_default,
      null,
      React107.createElement(DialogContentText_default, null, translate("ra.saved_queries.remove_message", {
    ...
    React107.createElement(
      DialogActions_default,
      null,
      React107.createElement(Button_default, { onClick: onClose }, translate("ra.action.cancel")),
      React107.createElement(Button_default, {
        onClick: removeQuery,
        color: "primary",
        // eslint-disable-next-line jsx-a11y/no-autofocus
        autoFocus: true
...
var FilterButton = function(props) {
  ...
  var filters = (0, import_react67.useContext)(FilterContext) || filtersProp;
  var resource = useResourceContext(props);
  var translate = useTranslate();
  var savedQueries = useSavedQueries(resource)[0];
  var navigate = useNavigate();
  var _a15 = useListContext(props), _b = _a15.displayedFilters, displayedFilters = _b === void 0 ? {} : _b, filterValues = _a15.filterValues, perPage = _a15.perPage, setFilters = _a15.setFilters, showFilter = _a15.showFilter, sort = _a15.sort;
  ...
  var _c = (0, import_react67.useState)(false), open = _c[0], setOpen = _c[1];
  var anchorEl = (0, import_react67.useRef)();
  if (filters === void 0) {
  ...
  var handleClickButton = (0, import_react67.useCallback)(function(event) {
    event.preventDefault();
    setOpen(true);
    anchorEl.current = event.currentTarget;
  }, [anchorEl, setOpen]);
  var handleRequestClose = (0, import_react67.useCallback)(function() {
    setOpen(false);
  }, [setOpen]);
  var handleShow = (0, import_react67.useCallback)(function(_a16) {
    var source = _a16.source, defaultValue = _a16.defaultValue;
  ...
  var _d = (0, import_react67.useState)(false), addSavedQueryDialogOpen = _d[0], setAddSavedQueryDialogOpen = _d[1];
  ...
  var _e = (0, import_react67.useState)(false), removeSavedQueryDialogOpen = _e[0], setRemoveSavedQueryDialogOpen = _e[1];
  ...
  return React108.createElement(
    ...
    React108.createElement(
      ...
      React108.createElement(import_FilterList.default, null)
    ),
    React108.createElement(
      Menu_default,
      { open, anchorEl: anchorEl.current, onClose: handleRequestClose },
      hiddenFilters.map(function(filterElement, index) {
        return React108.createElement(FilterButtonMenuItem, { key: filterElement.props.source, filter: filterElement, resource, onShow: handleShow, autoFocus: index === 0 });
      }),
      validSavedQueries.map(function(savedQuery, index) {
        return (0, import_isEqual6.default)(savedQuery.value, {
          ...
          perPage,
          displayedFilters
        }) ? React108.createElement(MenuItem_default, { onClick: showRemoveSavedQueryDialog, key: index }, translate("ra.saved_queries.remove_label_with_name", {
          _: 'Remove query "%{name}"',
          name: savedQuery.label
        })) : React108.createElement(MenuItem_default, { onClick: function() {
          navigate({
      ...
      hasFilterValues && !hasSavedCurrentQuery && !disableSaveQuery && React108.createElement(MenuItem_default, { onClick: showAddSavedQueryDialog }, translate("ra.saved_queries.new_label", {
        _: "Save current query..."
      })),
      hasFilterValues && React108.createElement(MenuItem_default, { onClick: function() {
        return setFilters({}, {}, false);
      } }, translate("ra.action.remove_all_filters", {
        _: "Remove all filters"
      }))
    ),
    !disableSaveQuery && React108.createElement(
      React108.Fragment,
      null,
      React108.createElement(AddSavedQueryDialog, { open: addSavedQueryDialogOpen, onClose: hideAddSavedQueryDialog }),
      React108.createElement(RemoveSavedQueryDialog, { open: removeSavedQueryDialogOpen, onClose: hideRemoveSavedQueryDialog })
    )
  );
};
var sanitizeRestProps15 = function(_a15) {
  var _b = _a15.displayedFilters, displayedFilters = _b === void 0 ? null : _b, _c = _a15.filterValues, filterValues = _c === void 0 ? null : _c, _d = _a15.showFilter, showFilter = _d === void 0 ? null : _d, rest = __rest67(_a15, ["displayedFilters", "filterValues", "showFilter"]);
  return rest;
};
FilterButton.propTypes = {
  resource: import_prop_types59.default.string,
  filters: import_prop_types59.default.arrayOf(import_prop_types59.default.node),
  displayedFilters: import_prop_types59.default.object,
  filterValues: import_prop_types59.default.object,
  showFilter: import_prop_types59.default.func,
  className: import_prop_types59.default.string
};
var PREFIX46 = "RaFilterButton";
...
var Filter = function(props) {
  ...
  var renderButton = function() {
    return React109.createElement(FilterButton, { className: FilterClasses.button });
  };
  var renderForm = function() {
    return React109.createElement(FilterForm, { className: FilterClasses.form });
  };
  return React109.createElement(FilterContext.Provider, { value: import_react68.Children.toArray(children) }, props.context === "button" ? renderButton() : renderForm());
};
Filter.propTypes = {
  children: import_prop_types60.default.node,
  classes: import_prop_types60.default.object,
  context: import_prop_types60.default.oneOf(["form", "button"])
};
var PREFIX47 = "RaFilter";
var FilterClasses = {
  button: "".concat(PREFIX47, "-button"),
  form: "".concat(PREFIX47, "-form")
};
...
var FilterList = function(props) {
  var label = props.label, icon = props.icon, children = props.children, rest = __rest68(props, ["label", "icon", "children"]);
  var translate = useTranslate();
  return React110.createElement(
    ...
    React110.createElement(
      ...
      React110.createElement(Box_default, { mr: 1 }, icon),
      React110.createElement(Typography_default, { variant: "overline" }, translate(label, { _: label }))
    ),
    React110.createElement(List_default, { dense: true, disablePadding: true }, children)
  );
};
...
var FilterListItem = (0, import_react69.memo)(function(props) {
  var label = props.label, value = props.value, icon = props.icon, _a15 = props.isSelected, getIsSelected = _a15 === void 0 ? DefaultIsSelected : _a15, _b = props.toggleFilter, userToggleFilter = _b === void 0 ? DefaultToggleFilter : _b, rest = __rest69(props, ["label", "value", "icon", "isSelected", "toggleFilter"]);
  ...
  return React111.createElement(
    ...
    React111.createElement(
      ...
      icon && React111.createElement(ListItemIcon_default, { className: FilterListItemClasses.listItemIcon }, icon),
      React111.createElement(ListItemText_default, { primary: (0, import_react_is2.isElement)(label) ? label : translate(label, { _: label }), className: FilterListItemClasses.listItemText, "data-selected": isSelected ? "true" : "false" }),
      isSelected && React111.createElement(
        ListItemSecondaryAction_default,
        ...
        React111.createElement(
          IconButton_default,
          { size: "small" },
          React111.createElement(import_CancelOutlined2.default, null)
        )
      )
    )
  );
...
var DefaultToggleFilter = function(value, filters) {
  ...
  if (isSelected) {
    ...
    return Object.keys(filters).reduce(function(acc, key) {
      var _a15;
      return keysToRemove_1.includes(key) ? acc : __assign73(__assign73({}, acc), (_a15 = {}, _a15[key] = filters[key], _a15));
    }, {});
  }
  return __assign73(__assign73({}, filters), value);
};
var PREFIX48 = "RaFilterListItem";
var FilterListItemClasses = {
  listItemButton: "".concat(PREFIX48, "-listItemButton"),
  listItemText: "".concat(PREFIX48, "-listItemText"),
  listItemIcon: "".concat(PREFIX48, "-listItemIcon")
};
...
})((_a7 = {}, _a7["& .".concat(FilterListItemClasses.listItemButton)] = {
  paddingRight: "2em",
  paddingLeft: "2em"
}, _a7["& .".concat(FilterListItemClasses.listItemText)] = {
  margin: 0
}, _a7["& .".concat(FilterListItemClasses.listItemIcon)] = {
  minWidth: 0,
  marginRight: "0.5em"
}, _a7));
...
var FilterLiveSearch = (0, import_react70.memo)(function(props) {
  var _a15 = useListFilterContext(), filterValues = _a15.filterValues, setFilters = _a15.setFilters;
  var translate = useTranslate();
  ...
  var handleChange = function(event) {
    var _a16;
    if (event.target) {
      setFilters(__assign74(__assign74({}, filterValues), (_a16 = {}, _a16[source] = event.target.value, _a16)), null);
    } else {
      var _b2 = filterValues, _c2 = source, _1 = _b2[_c2], filters = __rest70(_b2, [typeof _c2 === "symbol" ? _c2 : _c2 + ""]);
      setFilters(filters, null, false);
    }
  };
  var initialValues = (0, import_react70.useMemo)(function() {
    var _a16;
    return _a16 = {}, _a16[source] = filterValues[source], _a16;
  }, [filterValues, source]);
  ...
  return React112.createElement(
    ...
    React112.createElement(
      "form",
      { onSubmit },
      React112.createElement(TextInput, __assign74({ resettable: true, helperText: false, source, InputProps: {
        endAdornment: React112.createElement(
          InputAdornment_default,
          { position: "end" },
          React112.createElement(import_Search.default, { color: "disabled" })
        )
...
var AddSavedQueryIconButton = function(props) {
  var _a15 = (0, import_react71.useState)(false), open = _a15[0], setOpen = _a15[1];
  var handleOpen = function() {
    setOpen(true);
  };
  var handleClose = function() {
  ...
  return React113.createElement(
    ...
    React113.createElement(
      ...
      React113.createElement(import_AddCircleOutline2.default, null)
    ),
    React113.createElement(AddSavedQueryDialog, { open, onClose: handleClose })
  );
};
...
var import_RemoveCircleOutline3 = __toESM(require_RemoveCircleOutline());
...
var RemoveSavedQueryIconButton = function(props) {
  var _a15 = (0, import_react72.useState)(false), confirmationOpen = _a15[0], setConfirmationOpen = _a15[1];
  ...
  return React114.createElement(
    ...
    React114.createElement(
      ...
      React114.createElement(import_RemoveCircleOutline3.default, null)
    ),
    React114.createElement(RemoveSavedQueryDialog, { open: confirmationOpen, onClose: handleConfirmationClose })
  );
};
...
var SavedQueryFilterListItem = (0, import_react73.memo)(function(props) {
  var className = props.className, label = props.label, sx = props.sx, value = props.value;
  var _a15 = useListContext(), filterValues = _a15.filterValues, sort = _a15.sort, perPage = _a15.perPage, displayedFilters = _a15.displayedFilters;
  var navigate = useNavigate();
  ...
  return (
    ...
    React115.createElement(
      ...
      React115.createElement(
        ...
        React115.createElement(ListItemText_default, { primary: label, className: SavedQueryFilterListItemClasses.listItemText }),
        isSelected && React115.createElement(
          ListItemSecondaryAction_default,
          null,
          React115.createElement(
            IconButton_default,
            { size: "small", onClick: toggleFilter },
            React115.createElement(import_CancelOutlined3.default, null)
          )
        )
      )
    )
...
var PREFIX49 = "RaSavedQueryFilterListItem";
var SavedQueryFilterListItemClasses = {
  listItemButton: "".concat(PREFIX49, "-listItemButton"),
  listItemText: "".concat(PREFIX49, "-listItemText")
};
var StyledListItem2 = styled_default(ListItem_default, {
  ...
  var _a15;
  return _a15 = {}, _a15["& .".concat(SavedQueryFilterListItemClasses.listItemButton)] = {
    paddingRight: "2em",
    paddingLeft: "2em"
  }, _a15["& .".concat(SavedQueryFilterListItemClasses.listItemText)] = {
    margin: 0
  }, _a15;
});

// node_modules/ra-ui-materialui/dist/esm/list/filter/SavedQueriesList.js
var SavedQueriesList = function(_a15) {
  var _b = _a15.icon, icon = _b === void 0 ? defaultIcon21 : _b;
  var translate = useTranslate();
  ...
  return React116.createElement(
    ...
    hasSavedCurrentFilterValue ? React116.createElement(RemoveSavedQueryIconButton, { className: SavedQueriesListClasses.floatingIcon }) : hasFilterValues ? React116.createElement(AddSavedQueryIconButton, { className: SavedQueriesListClasses.floatingIcon }) : React116.createElement(
      Tooltip_default,
      { title: translate("ra.saved_queries.help"), className: SavedQueriesListClasses.floatingTooltip },
      React116.createElement(import_HelpOutline.default, null)
    ),
    validSavedQueries.map(function(savedQuery, index) {
      return React116.createElement(SavedQueryFilterListItem, { label: savedQuery.label, value: savedQuery.value, key: index });
    })
  );
};
var PREFIX50 = "RaSavedQueriesList";
var SavedQueriesListClasses = {
  floatingIcon: "".concat(PREFIX50, "-floatingIcon"),
  floatingTooltip: "".concat(PREFIX50, "-floatingTooltip"),
  titleContainer: "".concat(PREFIX50, "-titleContainer"),
  titleIcon: "".concat(PREFIX50, "-titleIcon")
};
var Root21 = styled_default(FilterList, {
  name: PREFIX50,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var defaultIcon21 = React116.createElement(import_BookmarkBorder.default, null);

// node_modules/ra-ui-materialui/dist/esm/list/pagination/InfinitePagination.js
var React117 = __toESM(require_react());
var import_react74 = __toESM(require_react());
var InfinitePagination = function(_a15) {
  var _b = _a15.options, options = _b === void 0 ? defaultOptions2 : _b, sx = _a15.sx;
  ...
  var observerElem = (0, import_react74.useRef)(null);
  ...
  if (isLoading)
    return null;
  return React117.createElement(Box_default, { ref: observerElem, py: 2, textAlign: "center", sx }, isFetchingNextPage && hasNextPage && React117.createElement(CircularProgress_default, { size: "1.5em" }));
};
...
var PaginationActions = (0, import_react75.memo)(function(props) {
  var page = props.page, rowsPerPage = props.rowsPerPage, count = props.count, onPageChange = props.onPageChange, _a15 = props.size, size = _a15 === void 0 ? "small" : _a15, className = props.className, rest = __rest71(props, ["page", "rowsPerPage", "count", "onPageChange", "size", "className"]);
  var translate = useTranslate();
  var nbPages = Math.ceil(count / rowsPerPage) || 1;
  if (nbPages === 1) {
    return React118.createElement(Root22, { className });
  }
  ...
  return React118.createElement(
    Root22,
    { className },
    React118.createElement(Pagination_default, __assign77({
      size,
      count: nbPages,
...
PaginationActions.propTypes = {
  ...
  color: import_prop_types61.default.oneOf(["primary", "secondary", "standard"]),
  size: import_prop_types61.default.oneOf(["small", "medium", "large"])
};
var PREFIX51 = "RaPaginationActions";
var Root22 = styled_default("div", {
  name: PREFIX51,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var sanitizeRestProps16 = function(_a15) {
  var nextIconButtonProps = _a15.nextIconButtonProps, backIconButtonProps = _a15.backIconButtonProps, rest = __rest71(_a15, ["nextIconButtonProps", "backIconButtonProps"]);
  return rest;
};
...
var Pagination = (0, import_react76.memo)(function(props) {
  var _a15 = props.rowsPerPageOptions, rowsPerPageOptions = _a15 === void 0 ? DefaultRowsPerPageOptions : _a15, actions = props.actions, _b = props.limit, limit = _b === void 0 ? null : _b, rest = __rest72(props, ["rowsPerPageOptions", "actions", "limit"]);
  ...
  var totalPages = (0, import_react76.useMemo)(function() {
    return total != null ? Math.ceil(total / perPage) : void 0;
  }, [perPage, total]);
  var handlePageChange = (0, import_react76.useCallback)(function(event, page2) {
  ...
  var handlePerPageChange = (0, import_react76.useCallback)(function(event) {
    setPerPage(event.target.value);
  }, [setPerPage]);
  var labelDisplayedRows = (0, import_react76.useCallback)(function(_a16) {
    var from = _a16.from, to = _a16.to, count = _a16.count;
  ...
  var labelItem = (0, import_react76.useCallback)(function(type) {
    return translate("ra.navigation.".concat(type), { _: "Go to ".concat(type, " page") });
  }, [translate]);
  if (isLoading) {
    return React119.createElement(Toolbar_default, { variant: "dense" });
  }
  ...
  if (isSmall) {
    return React119.createElement(TablePagination_default, __assign78({ count: total == null ? -1 : total, rowsPerPage: perPage, page: page - 1, onPageChange: handlePageChange, rowsPerPageOptions: emptyArray, component: "span", labelDisplayedRows }, sanitizeListRestProps(rest)));
  }
  var ActionsComponent = actions ? actions : !isLoading && total != null ? PaginationActions : void 0;
  return React119.createElement(TablePagination_default, __assign78({
...
Pagination.propTypes = {
  ...
  limit: import_prop_types62.default.element,
  rowsPerPageOptions: import_prop_types62.default.arrayOf(import_prop_types62.default.number)
};
...
var PaginationLimit = (0, import_react77.memo)(function() {
  var translate = useTranslate();
  return React120.createElement(
    CardContent_default,
    null,
    React120.createElement(Typography_default, { variant: "body2" }, translate("ra.navigation.no_results"))
  );
});
...
var defaultPagination = React121.createElement(Pagination, null);
var DatagridInput = function(props) {
  ...
  var onSelect = (0, import_react78.useCallback)(function(idsToAdd) {
    field.onChange(idsToAdd);
  }, [field]);
  var onToggleItem = (0, import_react78.useCallback)(function(id) {
    if (field.value.includes(id)) {
      field.onChange(field.value.filter(function(item) {
        return item !== id;
      }));
    } else {
      field.onChange(__spreadArray7(__spreadArray7([], field.value, true), [id], false));
    }
  }, [field]);
  var onUnselectItems = (0, import_react78.useCallback)(function() {
    field.onChange([]);
  }, [field]);
  var listContext = React121.useMemo(function() {
  ...
  return React121.createElement(
    ...
    React121.createElement(
      ListContextProvider,
      { value: listContext },
      filters ? Array.isArray(filters) ? React121.createElement(
        FilterContext.Provider,
        { value: filters },
        React121.createElement(
          React121.Fragment,
          null,
          React121.createElement(FilterForm, null),
          React121.createElement(FilterButton, null)
        )
      ) : React121.createElement(
        React121.Fragment,
        null,
        (0, import_react78.cloneElement)(filters, {
          context: "form"
        }),
        (0, import_react78.cloneElement)(filters, {
          context: "button"
      ...
      !fieldState.error && !fetchError && React121.createElement(
        React121.Fragment,
        null,
        React121.createElement(Datagrid, __assign79({}, rest)),
        pagination !== false && pagination
      ),
      React121.createElement(InputHelperText, { touched: fieldState.isTouched || formState.isSubmitted || fetchError, error: ((_a15 = fieldState.error) === null || _a15 === void 0 ? void 0 : _a15.message) || (fetchError === null || fetchError === void 0 ? void 0 : fetchError.message) })
    )
  );
};
...
var DateInput = function(_a15) {
  var className = _a15.className, defaultValue = _a15.defaultValue, _b = _a15.format, format = _b === void 0 ? getStringFromDate : _b, label = _a15.label, name = _a15.name, source = _a15.source, resource = _a15.resource, helperText = _a15.helperText, margin = _a15.margin, onBlur = _a15.onBlur, onChange = _a15.onChange, parse = _a15.parse, validate = _a15.validate, variant = _a15.variant, rest = __rest74(_a15, ["className", "defaultValue", "format", "label", "name", "source", "resource", "helperText", "margin", "onBlur", "onChange", "parse", "validate", "variant"]);
  var _c = useInput(__assign80({ defaultValue, name, format, parse, onBlur, onChange, resource, source, validate }, rest)), field = _c.field, fieldState = _c.fieldState, formState = _c.formState, id = _c.id, isRequired2 = _c.isRequired;
  var error = fieldState.error, invalid = fieldState.invalid, isTouched = fieldState.isTouched;
  var isSubmitted = formState.isSubmitted;
  var renderHelperText = helperText !== false || (isTouched || isSubmitted) && invalid;
  return React122.createElement(TextField_default, __assign80({ id }, field, { className: clsx_m_default("ra-input", "ra-input-".concat(source), className), type: "date", size: "small", variant, margin, error: (isTouched || isSubmitted) && invalid, helperText: renderHelperText ? React122.createElement(InputHelperText, { touched: isTouched || isSubmitted, error: error === null || error === void 0 ? void 0 : error.message, helperText }) : null, label: React122.createElement(FieldTitle_default, { label, source, resource, isRequired: isRequired2 }), InputLabelProps: defaultInputLabelProps }, sanitizeInputRestProps(rest)));
};
DateInput.propTypes = {
  label: import_prop_types63.default.oneOfType([
    import_prop_types63.default.string,
    import_prop_types63.default.bool,
    import_prop_types63.default.element
  ]),
  resource: import_prop_types63.default.string,
  source: import_prop_types63.default.string
};
...
var DateTimeInput = function(_a15) {
  var className = _a15.className, defaultValue = _a15.defaultValue, _b = _a15.format, format = _b === void 0 ? formatDateTime : _b, label = _a15.label, helperText = _a15.helperText, margin = _a15.margin, onBlur = _a15.onBlur, onChange = _a15.onChange, source = _a15.source, resource = _a15.resource, _c = _a15.parse, parse = _c === void 0 ? parseDateTime : _c, validate = _a15.validate, variant = _a15.variant, rest = __rest75(_a15, ["className", "defaultValue", "format", "label", "helperText", "margin", "onBlur", "onChange", "source", "resource", "parse", "validate", "variant"]);
  var _d = useInput(__assign81({ defaultValue, format, parse, onBlur, onChange, resource, source, validate }, rest)), field = _d.field, fieldState = _d.fieldState, formState = _d.formState, id = _d.id, isRequired2 = _d.isRequired;
  var error = fieldState.error, invalid = fieldState.invalid, isTouched = fieldState.isTouched;
  var isSubmitted = formState.isSubmitted;
  var renderHelperText = helperText !== false || (isTouched || isSubmitted) && invalid;
  return React123.createElement(TextField_default, __assign81({ id }, field, { className: clsx_m_default("ra-input", "ra-input-".concat(source), className), type: "datetime-local", size: "small", variant, margin, error: (isTouched || isSubmitted) && invalid, helperText: renderHelperText ? React123.createElement(InputHelperText, { touched: isTouched || isSubmitted, error: error === null || error === void 0 ? void 0 : error.message, helperText }) : null, label: React123.createElement(FieldTitle_default, { label, source, resource, isRequired: isRequired2 }), InputLabelProps: defaultInputLabelProps2 }, sanitizeInputRestProps(rest)));
};
DateTimeInput.propTypes = {
  label: import_prop_types64.default.oneOfType([
    import_prop_types64.default.string,
    import_prop_types64.default.bool,
    import_prop_types64.default.element
  ]),
  resource: import_prop_types64.default.string,
  source: import_prop_types64.default.string
};
...
var parseTime = function(value) {
  ...
  today.setHours((_a15 = timeTokens[0]) !== null && _a15 !== void 0 ? _a15 : 0);
  today.setMinutes((_b = timeTokens[1]) !== null && _b !== void 0 ? _b : 0);
  return today;
};
var TimeInput = function(_a15) {
  var className = _a15.className, defaultValue = _a15.defaultValue, _b = _a15.format, format = _b === void 0 ? formatTime : _b, label = _a15.label, helperText = _a15.helperText, margin = _a15.margin, onBlur = _a15.onBlur, onChange = _a15.onChange, source = _a15.source, resource = _a15.resource, _c = _a15.parse, parse = _c === void 0 ? parseTime : _c, validate = _a15.validate, variant = _a15.variant, rest = __rest76(_a15, ["className", "defaultValue", "format", "label", "helperText", "margin", "onBlur", "onChange", "source", "resource", "parse", "validate", "variant"]);
  var _d = useInput(__assign82({ defaultValue, format, parse, onBlur, onChange, resource, source, validate }, rest)), field = _d.field, fieldState = _d.fieldState, formState = _d.formState, id = _d.id, isRequired2 = _d.isRequired;
  var error = fieldState.error, invalid = fieldState.invalid, isTouched = fieldState.isTouched;
  var isSubmitted = formState.isSubmitted;
  var renderHelperText = helperText !== false || (isTouched || isSubmitted) && invalid;
  return React124.createElement(TextField_default, __assign82({ id }, field, { className: clsx_m_default("ra-input", "ra-input-".concat(source), className), type: "time", size: "small", variant, margin, error: (isTouched || isSubmitted) && invalid, helperText: renderHelperText ? React124.createElement(InputHelperText, { touched: isTouched || isSubmitted, error: error === null || error === void 0 ? void 0 : error.message, helperText }) : null, label: React124.createElement(FieldTitle_default, { label, source, resource, isRequired: isRequired2 }), InputLabelProps: defaultInputLabelProps3 }, sanitizeInputRestProps(rest)));
};
TimeInput.propTypes = {
  label: import_prop_types65.default.oneOfType([import_prop_types65.default.string, import_prop_types65.default.bool]),
...
function fromEvent(evt) {
  return __awaiter6(this, void 0, void 0, function() {
    return __generator6(this, function(_a15) {
...
var Dropzone = (0, import_react79.forwardRef)(function(_ref2, ref) {
  ...
  return import_react79.default.createElement(import_react79.Fragment, null, children(_objectSpread2(_objectSpread2({}, props), {}, {
    open
  })));
});
...
Dropzone.propTypes = {
   ...
   */
  children: import_prop_types66.default.func,
  /**
   ...
   */
  accept: import_prop_types66.default.oneOfType([import_prop_types66.default.string, import_prop_types66.default.arrayOf(import_prop_types66.default.string)]),
  /**
   ...
   */
  preventDropOnDocument: import_prop_types66.default.bool,
  /**
   * If true, disables click to open the native file selection dialog
   */
  noClick: import_prop_types66.default.bool,
  /**
   * If true, disables SPACE/ENTER to open the native file selection dialog.
   * Note that it also stops tracking the focus state.
   */
  noKeyboard: import_prop_types66.default.bool,
  /**
   * If true, disables drag 'n' drop
   */
  noDrag: import_prop_types66.default.bool,
  /**
   * If true, stops drag event propagation to parents
   */
  noDragEventsBubbling: import_prop_types66.default.bool,
  /**
   * Minimum file size (in bytes)
   */
  minSize: import_prop_types66.default.number,
  /**
   * Maximum file size (in bytes)
   */
  maxSize: import_prop_types66.default.number,
  /**
   * Maximum accepted number of files
   * The default value is 0 which means there is no limitation to how many files are accepted.
   */
  maxFiles: import_prop_types66.default.number,
  /**
   ...
   */
  getFilesFromEvent: import_prop_types66.default.func,
  /**
   * Cb for when closing the file dialog with no selection
   */
  onFileDialogCancel: import_prop_types66.default.func,
  /**
   * Cb for when opening the file dialog
   */
  onFileDialogOpen: import_prop_types66.default.func,
  /**
   * Set to true to use the https://developer.mozilla.org/en-US/docs/Web/API/File_System_Access_API
   * to open the file picker instead of using an `<input type="file">` click event.
   */
  useFsAccessApi: import_prop_types66.default.bool,
  /**
   * Cb for when the `dragenter` event occurs.
   *
   * @param {DragEvent} event
   */
  onDragEnter: import_prop_types66.default.func,
  /**
   * Cb for when the `dragleave` event occurs
   *
   * @param {DragEvent} event
   */
  onDragLeave: import_prop_types66.default.func,
  /**
   * Cb for when the `dragover` event occurs
   *
   * @param {DragEvent} event
   */
  onDragOver: import_prop_types66.default.func,
  /**
   ...
   * @param {(DragEvent|Event)} event A drag event or input change event (if files were selected via the file dialog)
   */
  onDrop: import_prop_types66.default.func,
  /**
   * Cb for when the `drop` event occurs.
   ...
   */
  onDropAccepted: import_prop_types66.default.func,
  /**
   * Cb for when the `drop` event occurs.
   ...
   * @param {(DragEvent|Event)} event
   */
  onDropRejected: import_prop_types66.default.func,
  /**
   * Custom validation function
   * @param {File} file
   * @returns {FileError|FileError[]}
   */
  validator: import_prop_types66.default.func
};
var initialState2 = {
  isFocused: false,
...
function useDropzone() {
  ...
  var onFileDialogOpenCb = (0, import_react79.useMemo)(function() {
    return typeof onFileDialogOpen === "function" ? onFileDialogOpen : noop;
  }, [onFileDialogOpen]);
  var onFileDialogCancelCb = (0, import_react79.useMemo)(function() {
    return typeof onFileDialogCancel === "function" ? onFileDialogCancel : noop;
  }, [onFileDialogCancel]);
  var rootRef = (0, import_react79.useRef)(null);
  var inputRef = (0, import_react79.useRef)(null);
  var _useReducer = (0, import_react79.useReducer)(reducer, initialState2), _useReducer2 = _slicedToArray2(_useReducer, 2), state = _useReducer2[0], dispatch = _useReducer2[1];
  var isFocused = state.isFocused, isFileDialogActive = state.isFileDialogActive, draggedFiles = state.draggedFiles;
  var fsAccessApiWorksRef = (0, import_react79.useRef)(typeof window !== "undefined" && window.isSecureContext && useFsAccessApi && canUseFileSystemAccessAPI());
  ...
  var dragTargetsRef = (0, import_react79.useRef)([]);
  ...
  var onDragEnterCb = (0, import_react79.useCallback)(function(event) {
    event.preventDefault();
    event.persist();
  ...
  var onDragOverCb = (0, import_react79.useCallback)(function(event) {
    event.preventDefault();
    event.persist();
    stopPropagation8(event);
  ...
  var onDragLeaveCb = (0, import_react79.useCallback)(function(event) {
    event.preventDefault();
    event.persist();
    stopPropagation8(event);
  ...
  var setFiles = (0, import_react79.useCallback)(function(files, event) {
    var acceptedFiles = [];
    var fileRejections = [];
  ...
  var onDropCb = (0, import_react79.useCallback)(function(event) {
    event.preventDefault();
    event.persist();
    stopPropagation8(event);
    dragTargetsRef.current = [];
  ...
  var openFileDialog = (0, import_react79.useCallback)(function() {
  ...
  var onKeyDownCb = (0, import_react79.useCallback)(function(event) {
  ...
  var onFocusCb = (0, import_react79.useCallback)(function() {
    dispatch({
      type: "focus"
    });
  }, []);
  var onBlurCb = (0, import_react79.useCallback)(function() {
    dispatch({
      type: "blur"
    });
  }, []);
  var onClickCb = (0, import_react79.useCallback)(function() {
    if (noClick) {
      return;
    }
    if (isIeOrEdge()) {
  ...
  var getRootProps = (0, import_react79.useMemo)(function() {
    return function() {
  ...
  var onInputElementClick = (0, import_react79.useCallback)(function(event) {
    event.stopPropagation();
  }, []);
  var getInputProps = (0, import_react79.useMemo)(function() {
    return function() {
...
var FileInputPreview = function(props) {
  var children = props.children, className = props.className, onRemove = props.onRemove, file = props.file, _a15 = props.removeIcon, RemoveIcon2 = _a15 === void 0 ? import_RemoveCircle.default : _a15, rest = __rest77(props, ["children", "className", "onRemove", "file", "removeIcon"]);
  var translate = useTranslate();
  ...
  return React126.createElement(
    ...
    React126.createElement(
      ...
      React126.createElement(RemoveIcon2, { className: FileInputPreviewClasses.removeIcon })
    ),
    children
  );
};
FileInputPreview.propTypes = {
  ...
  file: import_prop_types67.default.object,
  onRemove: import_prop_types67.default.func.isRequired,
  removeIcon: import_prop_types67.default.element
};
var PREFIX52 = "RaFileInputPreview";
var FileInputPreviewClasses = {
  removeButton: "".concat(PREFIX52, "-removeButton"),
  removeIcon: "".concat(PREFIX52, "-removeIcon")
};
...
var FileInput = function(props) {
  var accept = props.accept, children = props.children, className = props.className, format = props.format, helperText = props.helperText, inputPropsOptions = props.inputProps, maxSize = props.maxSize, minSize = props.minSize, _a15 = props.multiple, multiple = _a15 === void 0 ? false : _a15, label = props.label, _b = props.labelMultiple, labelMultiple = _b === void 0 ? "ra.input.file.upload_several" : _b, _c = props.labelSingle, labelSingle = _c === void 0 ? "ra.input.file.upload_single" : _c, _d = props.options, options = _d === void 0 ? {} : _d, onRemoveProp = props.onRemove, parse = props.parse, placeholder = props.placeholder, removeIcon = props.removeIcon, resource = props.resource, source = props.source, validate = props.validate, validateFileRemoval = props.validateFileRemoval, rest = __rest78(props, ["accept", "children", "className", "format", "helperText", "inputProps", "maxSize", "minSize", "multiple", "label", "labelMultiple", "labelSingle", "options", "onRemove", "parse", "placeholder", "removeIcon", "resource", "source", "validate", "validateFileRemoval"]);
  ...
  var _e = useInput(__assign84({ format: format || transformFiles, parse: parse || transformFiles, source, validate }, rest)), id = _e.id, _f = _e.field, onChange = _f.onChange, value = _f.value, fieldState = _e.fieldState, isSubmitted = _e.formState.isSubmitted, isRequired2 = _e.isRequired;
  ...
  var onDrop = function(newFiles, rejectedFiles, event) {
    var updatedFiles = multiple ? __spreadArray8(__spreadArray8([], files, true), newFiles, true) : __spreadArray8([], newFiles, true);
    if (multiple) {
  ...
  var onRemove = function(file) {
    return function() {
      return __awaiter7(void 0, void 0, void 0, function() {
        ...
        return __generator7(this, function(_a16) {
          switch (_a16.label) {
            case 0:
  ...
  var childrenElement = children && (0, import_react81.isValidElement)(import_react81.Children.only(children)) ? import_react81.Children.only(children) : void 0;
  ...
  return import_react81.default.createElement(
    ...
    import_react81.default.createElement(
      ...
      import_react81.default.createElement(
        ...
        import_react81.default.createElement("input", __assign84({ id, name: id }, getInputProps(__assign84({}, inputPropsOptions)))),
        placeholder ? placeholder : multiple ? import_react81.default.createElement("p", null, translate(labelMultiple)) : import_react81.default.createElement("p", null, translate(labelSingle))
      ),
      renderHelperText ? import_react81.default.createElement(
        FormHelperText_default,
        { error: (isTouched || isSubmitted) && invalid },
        import_react81.default.createElement(InputHelperText, { touched: isTouched || isSubmitted, error: error === null || error === void 0 ? void 0 : error.message, helperText })
      ) : null,
      children && import_react81.default.createElement("div", { className: "previews" }, files.map(function(file, index) {
        return import_react81.default.createElement(
          FileInputPreview,
          { key: index, file, onRemove: onRemove(file), className: FileInputClasses.removeButton, removeIcon },
          import_react81.default.createElement(RecordContextProvider, { value: file }, childrenElement)
        );
      }))
    )
  );
...
FileInput.propTypes = {
  accept: import_prop_types68.default.string,
  ...
  isRequired: import_prop_types68.default.bool,
  ...
  labelMultiple: import_prop_types68.default.string,
  labelSingle: import_prop_types68.default.string,
  maxSize: import_prop_types68.default.number,
  minSize: import_prop_types68.default.number,
  multiple: import_prop_types68.default.bool,
  validateFileRemoval: import_prop_types68.default.func,
  options: import_prop_types68.default.object,
  removeIcon: import_prop_types68.default.elementType,
...
var PREFIX53 = "RaFileInput";
var FileInputClasses = {
  dropZone: "".concat(PREFIX53, "-dropZone"),
  removeButton: "".concat(PREFIX53, "-removeButton")
};
...
var ImageInput = function(props) {
  return React128.createElement(StyledFileInput, __assign85({ labelMultiple: "ra.input.image.upload_several", labelSingle: "ra.input.image.upload_single" }, props));
};
var PREFIX54 = "RaImageInput";
...
var _a8;
var ResettableTextField = (0, import_react82.forwardRef)(function(props, ref) {
  ...
  var handleClickClearButton = (0, import_react82.useCallback)(function(event) {
    event.preventDefault();
    onChange("");
  }, [onChange]);
  var handleFocus = (0, import_react82.useCallback)(function(event) {
    onFocus && onFocus(event);
  }, [onFocus]);
  var handleBlur = (0, import_react82.useCallback)(function(event) {
    onBlur && onBlur(event);
  }, [onBlur]);
  ...
  var _a15 = InputProps || {}, endAdornment = _a15.endAdornment, InputPropsWithoutEndAdornment = __rest79(_a15, ["endAdornment"]);
    ...
    if (!resettable) {
      ...
      if (clearAlwaysVisible) {
        return React129.createElement(
          ...
          React129.createElement(
            ...
            React129.createElement(import_Clear.default, { className: clsx_m_default(clearIcon, visibleClearIcon) })
          )
        );
      } else {
        if (endAdornment) {
          ...
          return React129.createElement(
            ...
            React129.createElement("span", { className: clearButton }, " ")
          );
        }
      }
    } else {
      return React129.createElement(
        ...
        React129.createElement(
          ...
          React129.createElement(import_Clear.default, { className: clsx_m_default(clearIcon, (_a16 = {}, _a16[visibleClearIcon] = clearAlwaysVisible || value, _a16)) })
        )
      );
    }
  };
  return React129.createElement(StyledTextField, __assign86({ value, InputProps: __assign86({ classes: props.select && variant === "filled" ? { adornedEnd: inputAdornedEnd } : {}, endAdornment: getEndAdornment() }, InputPropsWithoutEndAdornment), disabled, variant, margin, className, size: "small" }, rest, { onFocus: handleFocus, onBlur: handleBlur, inputRef: ref }));
});
...
ResettableTextField.propTypes = {
  clearAlwaysVisible: import_prop_types69.default.bool,
  ...
  resettable: import_prop_types69.default.bool,
  value: import_prop_types69.default.any
};
var PREFIX55 = "RaResettableTextField";
var ResettableTextFieldClasses = {
  clearIcon: "".concat(PREFIX55, "-clearIcon"),
  visibleClearIcon: "".concat(PREFIX55, "-visibleClearIcon"),
  clearButton: "".concat(PREFIX55, "-clearButton"),
  selectAdornment: "".concat(PREFIX55, "-selectAdornment"),
  inputAdornedEnd: "".concat(PREFIX55, "-inputAdornedEnd")
};
var ResettableTextFieldStyles = (_a8 = {}, _a8["& .".concat(ResettableTextFieldClasses.clearIcon)] = {
  height: 16,
  width: 0
}, _a8["& .".concat(ResettableTextFieldClasses.visibleClearIcon)] = {
  width: 16
}, _a8["& .".concat(ResettableTextFieldClasses.clearButton)] = {
  height: 24,
  width: 24,
  padding: 0
}, _a8["& .".concat(ResettableTextFieldClasses.selectAdornment)] = {
  position: "absolute",
  right: 24
}, _a8["& .".concat(ResettableTextFieldClasses.inputAdornedEnd)] = {
  paddingRight: 0
}, _a8);
...
// node_modules/ra-ui-materialui/dist/esm/input/LoadingInput.js
var LoadingInput = function(_a15) {
  var fullWidth = _a15.fullWidth, label = _a15.label, helperText = _a15.helperText, margin = _a15.margin, size = _a15.size, sx = _a15.sx, _b = _a15.timeout, timeout = _b === void 0 ? 1e3 : _b, variant = _a15.variant;
  var oneSecondHasPassed = useTimeout(timeout);
  return React130.createElement(StyledResettableTextField, { sx, label, helperText, fullWidth, variant, margin, size, disabled: true, onChange: function() {
  }, InputProps: {
    endAdornment: React130.createElement(InputAdornment_default, { position: "end" }, oneSecondHasPassed ? React130.createElement(CircularProgress_default, { color: "inherit", size: 20 }) : (
      // use an adornment of the same size to avoid visual jumps
      React130.createElement("span", { style: { width: 20 } }, " ")
    ))
  } });
};
var PREFIX56 = "RaLoadingInput";
...
var NullableBooleanInput = function(props) {
  var className = props.className, _a15 = props.format, format = _a15 === void 0 ? getStringFromBoolean : _a15, helperText = props.helperText, label = props.label, margin = props.margin, onBlur = props.onBlur, onChange = props.onChange, _b = props.parse, parse = _b === void 0 ? getBooleanFromString : _b, resource = props.resource, source = props.source, validate = props.validate, variant = props.variant, _c = props.nullLabel, nullLabel = _c === void 0 ? "ra.boolean.null" : _c, _d = props.falseLabel, falseLabel = _d === void 0 ? "ra.boolean.false" : _d, _e = props.trueLabel, trueLabel = _e === void 0 ? "ra.boolean.true" : _e, rest = __rest80(props, ["className", "format", "helperText", "label", "margin", "onBlur", "onChange", "parse", "resource", "source", "validate", "variant", "nullLabel", "falseLabel", "trueLabel"]);
  var translate = useTranslate();
  var _f = useInput(__assign87({ format, parse, onBlur, onChange, resource, source, validate }, rest)), field = _f.field, _g = _f.fieldState, error = _g.error, invalid = _g.invalid, isTouched = _g.isTouched, isSubmitted = _f.formState.isSubmitted, id = _f.id, isRequired2 = _f.isRequired;
  var renderHelperText = helperText !== false || (isTouched || isSubmitted) && invalid;
  return React131.createElement(
    StyledTextField2,
    __assign87({ id, size: "small" }, field, { className: clsx_m_default("ra-input", "ra-input-".concat(source), NullableBooleanInputClasses.input, className), select: true, margin, label: React131.createElement(FieldTitle_default, { label, source, resource, isRequired: isRequired2 }), error: (isTouched || isSubmitted) && invalid, helperText: renderHelperText ? React131.createElement(InputHelperText, { touched: isTouched || isSubmitted, error: error === null || error === void 0 ? void 0 : error.message, helperText }) : null, variant }, sanitizeInputRestProps(rest)),
    React131.createElement(MenuItem_default, { value: "" }, translate(nullLabel)),
    React131.createElement(MenuItem_default, { value: "false" }, translate(falseLabel)),
    React131.createElement(MenuItem_default, { value: "true" }, translate(trueLabel))
  );
};
NullableBooleanInput.propTypes = {
  ...
  nullLabel: import_prop_types70.default.string,
  falseLabel: import_prop_types70.default.string,
  trueLabel: import_prop_types70.default.string
};
var PREFIX57 = "RaNullableBooleanInput";
var NullableBooleanInputClasses = {
  input: "".concat(PREFIX57, "-input")
};
var StyledTextField2 = styled_default(TextField_default, {
  ...
  var _b, _c;
  var theme = _a15.theme, fullWidth = _a15.fullWidth;
...
var NumberInput = function(_a15) {
  var className = _a15.className, _b = _a15.defaultValue, defaultValue = _b === void 0 ? null : _b, _c = _a15.format, format = _c === void 0 ? convertNumberToString : _c, helperText = _a15.helperText, label = _a15.label, margin = _a15.margin, onChange = _a15.onChange, onBlur = _a15.onBlur, onFocus = _a15.onFocus, parse = _a15.parse, resource = _a15.resource, source = _a15.source, _d = _a15.step, step = _d === void 0 ? "any" : _d, min = _a15.min, max = _a15.max, validate = _a15.validate, variant = _a15.variant, overrideInputProps = _a15.inputProps, rest = __rest81(_a15, ["className", "defaultValue", "format", "helperText", "label", "margin", "onChange", "onBlur", "onFocus", "parse", "resource", "source", "step", "min", "max", "validate", "variant", "inputProps"]);
  ...
  var inputProps = __assign88(__assign88({}, overrideInputProps), { step, min, max });
  var _g = React132.useState(format(field.value)), value = _g[0], setValue = _g[1];
  var hasFocus = React132.useRef(false);
  ...
  return React132.createElement(TextField_default, __assign88({ id }, fieldWithoutRef, {
    inputRef: ref,
    ...
    variant,
    error: (isTouched || isSubmitted) && invalid,
    helperText: renderHelperText ? React132.createElement(InputHelperText, { touched: isTouched || isSubmitted, error: error === null || error === void 0 ? void 0 : error.message, helperText }) : null,
    label: React132.createElement(FieldTitle_default, { label, source, resource, isRequired: isRequired2 }),
    margin,
    inputProps
  }, sanitizeInputRestProps(rest)));
};
NumberInput.propTypes = {
  label: import_prop_types71.default.oneOfType([
    import_prop_types71.default.string,
    import_prop_types71.default.bool,
    import_prop_types71.default.element
  ]),
  resource: import_prop_types71.default.string,
  source: import_prop_types71.default.string,
  step: import_prop_types71.default.oneOfType([import_prop_types71.default.string, import_prop_types71.default.number])
};
...
var TextInput = function(props) {
  var className = props.className, defaultValue = props.defaultValue, label = props.label, format = props.format, helperText = props.helperText, onBlur = props.onBlur, onChange = props.onChange, parse = props.parse, resource = props.resource, source = props.source, validate = props.validate, rest = __rest82(props, ["className", "defaultValue", "label", "format", "helperText", "onBlur", "onChange", "parse", "resource", "source", "validate"]);
  var _a15 = useInput(__assign89({ defaultValue, format, parse, resource, source, type: "text", validate, onBlur, onChange }, rest)), field = _a15.field, _b = _a15.fieldState, error = _b.error, invalid = _b.invalid, isTouched = _b.isTouched, isSubmitted = _a15.formState.isSubmitted, id = _a15.id, isRequired2 = _a15.isRequired;
  var renderHelperText = helperText !== false || (isTouched || isSubmitted) && invalid;
  return React133.createElement(ResettableTextField, __assign89({ id }, field, { className: clsx_m_default("ra-input", "ra-input-".concat(source), className), label: label !== "" && label !== false ? React133.createElement(FieldTitle_default, { label, source, resource, isRequired: isRequired2 }) : null, error: (isTouched || isSubmitted) && invalid, helperText: renderHelperText ? React133.createElement(InputHelperText, { touched: isTouched || isSubmitted, error: error === null || error === void 0 ? void 0 : error.message, helperText }) : null }, sanitizeInputRestProps(rest)));
};
TextInput.propTypes = {
  ...
  resource: import_prop_types72.default.string,
  source: import_prop_types72.default.string
};
...
var PasswordInput = function(props) {
  var _a15 = props.initiallyVisible, initiallyVisible = _a15 === void 0 ? false : _a15, rest = __rest83(props, ["initiallyVisible"]);
  var _b = (0, import_react83.useState)(initiallyVisible), visible = _b[0], setVisible = _b[1];
  var translate = useTranslate();
  var handleClick2 = function() {
    setVisible(!visible);
  };
  return React134.createElement(TextInput, __assign90({ type: visible ? "text" : "password", size: "small", InputProps: {
    endAdornment: React134.createElement(
      InputAdornment_default,
      { position: "end" },
      React134.createElement(IconButton_default, { "aria-label": translate(visible ? "ra.input.password.toggle_visible" : "ra.input.password.toggle_hidden"), onClick: handleClick2, size: "large" }, visible ? React134.createElement(import_Visibility.default, null) : React134.createElement(import_VisibilityOff.default, null))
    )
  } }, rest));
};
...
var RadioButtonGroupInputItem = function(_a15) {
  var choice = _a15.choice, optionText = _a15.optionText, optionValue = _a15.optionValue, source = _a15.source, translateChoice = _a15.translateChoice;
  var _b = useChoices({
    optionText,
    optionValue,
    translateChoice
  ...
  return React135.createElement(FormControlLabel_default, { label, htmlFor: nodeId, value, control: React135.createElement(Radio_default, { id: nodeId, color: "primary" }) });
};
...
var RadioButtonGroupInput = function(props) {
  var choicesProp = props.choices, className = props.className, format = props.format, helperText = props.helperText, isFetchingProp = props.isFetching, isLoadingProp = props.isLoading, label = props.label, _a15 = props.margin, margin = _a15 === void 0 ? "dense" : _a15, onBlur = props.onBlur, onChange = props.onChange, _b = props.options, options = _b === void 0 ? defaultOptions3 : _b, _c = props.optionText, optionText = _c === void 0 ? "name" : _c, _d = props.optionValue, optionValue = _d === void 0 ? "id" : _d, parse = props.parse, resourceProp = props.resource, _e = props.row, row = _e === void 0 ? true : _e, sourceProp = props.source, translateChoice = props.translateChoice, validate = props.validate, rest = __rest84(props, ["choices", "className", "format", "helperText", "isFetching", "isLoading", "label", "margin", "onBlur", "onChange", "options", "optionText", "optionValue", "parse", "resource", "row", "source", "translateChoice", "validate"]);
  ...
  var _g = useInput(__assign91({ format, onBlur, onChange, parse, resource, source, validate }, rest)), id = _g.id, isRequired2 = _g.isRequired, fieldState = _g.fieldState, field = _g.field, formState = _g.formState;
  var error = fieldState.error, invalid = fieldState.invalid, isTouched = fieldState.isTouched;
  var isSubmitted = formState.isSubmitted;
  if (isLoading) {
    return React136.createElement(
      ...
      React136.createElement(LinearProgress, null)
    );
  }
  var renderHelperText = !!fetchError || helperText !== false || (isTouched || isSubmitted) && invalid;
  return React136.createElement(
    StyledFormControl2,
    __assign91({ component: "fieldset", className: clsx_m_default("ra-input", "ra-input-".concat(source), className), margin, error: fetchError || (isTouched || isSubmitted) && invalid }, sanitizeRestProps17(rest)),
    React136.createElement(
      FormLabel_default,
      { component: "legend", className: RadioButtonGroupInputClasses.label },
      React136.createElement(FieldTitle_default, { label, source, resource, isRequired: isRequired2 })
    ),
    React136.createElement(RadioGroup_default, __assign91({ id, row }, field, options, sanitizeRestProps17(rest)), allChoices === null || allChoices === void 0 ? void 0 : allChoices.map(function(choice) {
      return React136.createElement(RadioButtonGroupInputItem, { key: (0, import_get8.default)(choice, optionValue), choice, optionText, optionValue, source: id, translateChoice: translateChoice !== null && translateChoice !== void 0 ? translateChoice : !isFromReference });
    })),
    renderHelperText ? React136.createElement(
      FormHelperText_default,
      null,
      React136.createElement(InputHelperText, { touched: isTouched || isSubmitted || fetchError, error: (error === null || error === void 0 ? void 0 : error.message) || (fetchError === null || fetchError === void 0 ? void 0 : fetchError.message), helperText })
    ) : null
  );
};
RadioButtonGroupInput.propTypes = {
  choices: import_prop_types73.default.arrayOf(import_prop_types73.default.any),
  label: import_prop_types73.default.oneOfType([
    import_prop_types73.default.string,
    import_prop_types73.default.bool,
    import_prop_types73.default.element
  ]),
  options: import_prop_types73.default.object,
  optionText: import_prop_types73.default.oneOfType([
    import_prop_types73.default.string,
    import_prop_types73.default.func,
    import_prop_types73.default.element
  ]),
  optionValue: import_prop_types73.default.string,
  resource: import_prop_types73.default.string,
  source: import_prop_types73.default.string,
  translateChoice: import_prop_types73.default.bool
};
var sanitizeRestProps17 = function(_a15) {
  var afterSubmit = _a15.afterSubmit, allowNull = _a15.allowNull, beforeSubmit = _a15.beforeSubmit, choices2 = _a15.choices, className = _a15.className, crudGetMatching = _a15.crudGetMatching, crudGetOne = _a15.crudGetOne, data = _a15.data, filter = _a15.filter, filterToQuery = _a15.filterToQuery, formatOnBlur = _a15.formatOnBlur, isEqual9 = _a15.isEqual, limitChoicesToValue = _a15.limitChoicesToValue, multiple = _a15.multiple, name = _a15.name, pagination = _a15.pagination, perPage = _a15.perPage, ref = _a15.ref, reference = _a15.reference, refetch = _a15.refetch, render = _a15.render, setFilter = _a15.setFilter, setPagination = _a15.setPagination, setSort = _a15.setSort, sort = _a15.sort, subscription = _a15.subscription, type = _a15.type, validateFields = _a15.validateFields, validation = _a15.validation, value = _a15.value, rest = __rest84(_a15, ["afterSubmit", "allowNull", "beforeSubmit", "choices", "className", "crudGetMatching", "crudGetOne", "data", "filter", "filterToQuery", "formatOnBlur", "isEqual", "limitChoicesToValue", "multiple", "name", "pagination", "perPage", "ref", "reference", "refetch", "render", "setFilter", "setPagination", "setSort", "sort", "subscription", "type", "validateFields", "validation", "value"]);
  return sanitizeInputRestProps(rest);
};
var PREFIX58 = "RaRadioButtonGroupInput";
var RadioButtonGroupInputClasses = {
  label: "".concat(PREFIX58, "-label")
};
...
var ReferenceArrayInput = function(props) {
  var _a15 = props.children, children = _a15 === void 0 ? defaultChildren2 : _a15, reference = props.reference, sort = props.sort, _b = props.filter, filter = _b === void 0 ? defaultFilter : _b;
  ...
  return React137.createElement(
    ResourceContextProvider,
    { value: reference },
    React137.createElement(ChoicesContextProvider, { value: controllerProps }, children)
  );
};
ReferenceArrayInput.propTypes = {
  children: import_prop_types74.default.element,
  filter: import_prop_types74.default.object,
  label: import_prop_types74.default.string,
  page: import_prop_types74.default.number,
  perPage: import_prop_types74.default.number,
  reference: import_prop_types74.default.string.isRequired,
  resource: import_prop_types74.default.string,
  sort: import_prop_types74.default.shape({
    field: import_prop_types74.default.string,
    order: import_prop_types74.default.oneOf(["ASC", "DESC"])
  }),
  source: import_prop_types74.default.string
};
var defaultChildren2 = React137.createElement(AutocompleteArrayInput, null);
var defaultFilter = {};

// node_modules/ra-ui-materialui/dist/esm/input/ReferenceError.js
var React138 = __toESM(require_react());
var import_prop_types75 = __toESM(require_prop_types());
var ReferenceError2 = function(_a15) {
  var label = _a15.label, error = _a15.error;
  return React138.createElement(TextField_default, { error: true, disabled: true, label, helperText: error === null || error === void 0 ? void 0 : error.message, margin: "normal" });
};
ReferenceError2.propTypes = {
  error: import_prop_types75.default.object.isRequired,
...
var ReferenceInput = function(props) {
  var _a15 = props.children, children = _a15 === void 0 ? defaultChildren3 : _a15, reference = props.reference, _b = props.sort, sort = _b === void 0 ? { field: "id", order: "DESC" } : _b, _c = props.filter, filter = _c === void 0 ? {} : _c;
  var controllerProps = useReferenceInputController(__assign93(__assign93({}, props), { sort, filter }));
  if (import_react84.Children.count(children) !== 1) {
    throw new Error("<ReferenceInput> only accepts a single child");
  }
  return import_react84.default.createElement(
    ResourceContextProvider,
    { value: reference },
    import_react84.default.createElement(ChoicesContextProvider, { value: controllerProps }, children)
  );
};
ReferenceInput.propTypes = {
  children: import_prop_types76.default.element,
  filter: import_prop_types76.default.object,
  label: import_prop_types76.default.string,
  page: import_prop_types76.default.number,
  perPage: import_prop_types76.default.number,
  record: import_prop_types76.default.object,
  reference: import_prop_types76.default.string.isRequired,
  resource: import_prop_types76.default.string,
  sort: import_prop_types76.default.shape({
    field: import_prop_types76.default.string,
    order: import_prop_types76.default.oneOf(["ASC", "DESC"])
  }),
  source: import_prop_types76.default.string
};
var defaultChildren3 = import_react84.default.createElement(AutocompleteInput, null);
...
var SearchInput = function(props) {
  ...
  return React140.createElement(StyledTextInput, __assign94({ hiddenLabel: true, label: "", resettable: true, placeholder: translate("ra.action.search"), InputProps: {
    endAdornment: React140.createElement(
      InputAdornment_default,
      { position: "end" },
      React140.createElement(import_Search2.default, { color: "disabled" })
    )
  }, size: "small" }, rest));
};
var PREFIX59 = "RaSearchInput";
...
var SelectArrayInput = function(props) {
  ...
  var _j = useInput(__assign95({ format, onBlur, onChange, parse, resource, source, validate }, rest)), field = _j.field, isRequired2 = _j.isRequired, _k = _j.fieldState, error = _k.error, invalid = _k.invalid, isTouched = _k.isTouched, isSubmitted = _j.formState.isSubmitted, id = _j.id;
  var handleChange = (0, import_react85.useCallback)(function(eventOrChoice) {
    if (eventOrChoice === null || eventOrChoice === void 0 ? void 0 : eventOrChoice.target) {
      eventOrChoice.target.value = eventOrChoice.target.value.reduce(function(acc, value) {
        ...
        return index < 0 ? __spreadArray9(__spreadArray9([], acc, true), [value], false) : __spreadArray9(__spreadArray9([], acc.slice(0, index), true), acc.slice(index + 1), true);
      }, []);
      field.onChange(eventOrChoice);
    } else {
      field.onChange(__spreadArray9(__spreadArray9([], field.value || [], true), [
  ...
  var _l = useSupportCreateSuggestion({
    ...
    onCreate,
    optionText
  }), getCreateItem = _l.getCreateItem, handleChangeWithCreateSupport = _l.handleChange, createElement202 = _l.createElement;
  var createItem = create2 || onCreate ? getCreateItem() : null;
  var finalChoices = create2 || onCreate ? __spreadArray9(__spreadArray9([], allChoices || [], true), [createItem], false) : allChoices || [];
  ...
  var renderMenuItem = (0, import_react85.useCallback)(function(choice) {
    return choice ? React141.createElement(MenuItem_default, { key: getChoiceValue(choice), value: getChoiceValue(choice), disabled: getDisableValue(choice) }, renderMenuItemOption(!!createItem && (choice === null || choice === void 0 ? void 0 : choice.id) === createItem.id ? createItem : choice)) : null;
  ...
  if (isLoading) {
    return React141.createElement(
      ...
      React141.createElement(LinearProgress, null)
    );
  }
  var finalValue = Array.isArray((_a15 = field.value) !== null && _a15 !== void 0 ? _a15 : []) ? field.value : field.value ? [field.value] : [];
  var outlinedInputProps = variant === "outlined" ? {
    input: React141.createElement(OutlinedInput_default, { id: "select-multiple-chip", label: React141.createElement(FieldTitle_default, { label, source, resource, isRequired: isRequired2 }) })
  } : {};
  var renderHelperText = !!fetchError || helperText !== false || (isTouched || isSubmitted) && invalid;
  return React141.createElement(
    React141.Fragment,
    ...
    React141.createElement(
      StyledFormControl3,
      __assign95({ margin, className: clsx_m_default("ra-input", "ra-input-".concat(source), className), error: fetchError || (isTouched || isSubmitted) && invalid, variant }, sanitizeRestProps18(rest)),
      React141.createElement(
        InputLabel_default,
        { ref: inputLabel, id: "".concat(id, "-outlined-label"), htmlFor: id },
        React141.createElement(FieldTitle_default, { label, source, resource, isRequired: isRequired2 })
      ),
      React141.createElement(Select_default, __assign95({ id, autoWidth: true, labelId: "".concat(id, "-outlined-label"), label: React141.createElement(FieldTitle_default, { label, source, resource, isRequired: isRequired2 }), multiple: true, error: !!fetchError || (isTouched || isSubmitted) && invalid, renderValue: function(selected) {
        return React141.createElement("div", { className: SelectArrayInputClasses.chips }, (Array.isArray(selected) ? selected : []).map(function(item) {
          ...
          return React141.createElement(Chip_default, { key: getChoiceValue(item), label: renderMenuItemOption(item), className: SelectArrayInputClasses.chip, size: "small" });
        }));
      ...
      renderHelperText ? React141.createElement(
        FormHelperText_default,
        { error: fetchError || isTouched && !!error },
        React141.createElement(InputHelperText, { touched: isTouched || isSubmitted || fetchError, error: (error === null || error === void 0 ? void 0 : error.message) || (fetchError === null || fetchError === void 0 ? void 0 : fetchError.message), helperText })
      ) : null
    ),
    createElement202
  );
...
SelectArrayInput.propTypes = {
  choices: import_prop_types77.default.arrayOf(import_prop_types77.default.object),
  className: import_prop_types77.default.string,
  children: import_prop_types77.default.node,
  label: import_prop_types77.default.oneOfType([
    import_prop_types77.default.string,
    import_prop_types77.default.bool,
    import_prop_types77.default.element
  ]),
  options: import_prop_types77.default.object,
  optionText: import_prop_types77.default.oneOfType([
    import_prop_types77.default.string,
    import_prop_types77.default.func,
    import_prop_types77.default.element
  ]),
  optionValue: import_prop_types77.default.string,
  disableValue: import_prop_types77.default.string,
  resource: import_prop_types77.default.string,
  source: import_prop_types77.default.string,
  translateChoice: import_prop_types77.default.bool
};
var sanitizeRestProps18 = function(_a15) {
  var alwaysOn = _a15.alwaysOn, choices2 = _a15.choices, classNamInputWithOptionsPropse = _a15.classNamInputWithOptionsPropse, componenInputWithOptionsPropst = _a15.componenInputWithOptionsPropst, crudGetMInputWithOptionsPropsatching = _a15.crudGetMInputWithOptionsPropsatching, crudGetOInputWithOptionsPropsne = _a15.crudGetOInputWithOptionsPropsne, defaultValue = _a15.defaultValue, disableValue = _a15.disableValue, emptyText = _a15.emptyText, enableGetChoices = _a15.enableGetChoices, filter = _a15.filter, filterToQuery = _a15.filterToQuery, formClassName = _a15.formClassName, initializeForm = _a15.initializeForm, initialValue = _a15.initialValue, input = _a15.input, isRequired2 = _a15.isRequired, label = _a15.label, limitChoicesToValue = _a15.limitChoicesToValue, loaded = _a15.loaded, locale = _a15.locale, meta = _a15.meta, onChange = _a15.onChange, options = _a15.options, optionValue = _a15.optionValue, optionText = _a15.optionText, perPage = _a15.perPage, record = _a15.record, reference = _a15.reference, resource = _a15.resource, setFilter = _a15.setFilter, setPagination = _a15.setPagination, setSort = _a15.setSort, sort = _a15.sort, source = _a15.source, textAlign = _a15.textAlign, translate = _a15.translate, translateChoice = _a15.translateChoice, validation = _a15.validation, rest = __rest86(_a15, ["alwaysOn", "choices", "classNamInputWithOptionsPropse", "componenInputWithOptionsPropst", "crudGetMInputWithOptionsPropsatching", "crudGetOInputWithOptionsPropsne", "defaultValue", "disableValue", "emptyText", "enableGetChoices", "filter", "filterToQuery", "formClassName", "initializeForm", "initialValue", "input", "isRequired", "label", "limitChoicesToValue", "loaded", "locale", "meta", "onChange", "options", "optionValue", "optionText", "perPage", "record", "reference", "resource", "setFilter", "setPagination", "setSort", "sort", "source", "textAlign", "translate", "translateChoice", "validation"]);
  return rest;
};
var PREFIX60 = "RaSelectArrayInput";
var SelectArrayInputClasses = {
  chips: "".concat(PREFIX60, "-chips"),
  chip: "".concat(PREFIX60, "-chip")
};
...
var SelectInput = function(props) {
  var choicesProp = props.choices, className = props.className, create2 = props.create, createLabel = props.createLabel, createValue = props.createValue, defaultValue = props.defaultValue, _a15 = props.disableValue, disableValue = _a15 === void 0 ? "disabled" : _a15, _b = props.emptyText, emptyText = _b === void 0 ? "" : _b, _c = props.emptyValue, emptyValue = _c === void 0 ? "" : _c, format = props.format, filter = props.filter, helperText = props.helperText, isFetchingProp = props.isFetching, isLoadingProp = props.isLoading, label = props.label, _d = props.margin, margin = _d === void 0 ? "dense" : _d, onBlur = props.onBlur, onChange = props.onChange, onCreate = props.onCreate, optionText = props.optionText, optionValue = props.optionValue, parse = props.parse, resourceProp = props.resource, sourceProp = props.source, translateChoice = props.translateChoice, validate = props.validate, rest = __rest87(props, ["choices", "className", "create", "createLabel", "createValue", "defaultValue", "disableValue", "emptyText", "emptyValue", "format", "filter", "helperText", "isFetching", "isLoading", "label", "margin", "onBlur", "onChange", "onCreate", "optionText", "optionValue", "parse", "resource", "source", "translateChoice", "validate"]);
  var translate = useTranslate();
  ...
  var _g = useInput(__assign96({ defaultValue, parse, format, onBlur, onChange, resource, source, validate }, rest)), field = _g.field, fieldState = _g.fieldState, id = _g.id, isRequired2 = _g.isRequired, isSubmitted = _g.formState.isSubmitted;
  var error = fieldState.error, invalid = fieldState.invalid, isTouched = fieldState.isTouched;
  var renderEmptyItemOption = (0, import_react86.useCallback)(function() {
    return (0, import_react_is3.isElement)(emptyText) ? emptyText : emptyText === "" ? " " : translate(emptyText, { _: emptyText });
  }, [emptyText, translate]);
  var renderMenuItemOption = (0, import_react86.useCallback)(function(choice) {
    return getChoiceText(choice);
  }, [
    getChoiceText
  ]);
  var handleChange = (0, import_react86.useCallback)(function(eventOrChoice) {
    return __awaiter8(void 0, void 0, void 0, function() {
      return __generator8(this, function(_a16) {
        if (eventOrChoice === null || eventOrChoice === void 0 ? void 0 : eventOrChoice.target) {
          field.onChange(eventOrChoice);
        } else {
  ...
  var _h = useSupportCreateSuggestion({
    ...
    onCreate,
    optionText
  }), getCreateItem = _h.getCreateItem, handleChangeWithCreateSupport = _h.handleChange, createElement202 = _h.createElement;
  var createItem = create2 || onCreate ? getCreateItem() : null;
  var finalChoices = allChoices;
  if (create2 || onCreate) {
    finalChoices = __spreadArray10(__spreadArray10([], finalChoices, true), [createItem], false);
  }
  var renderMenuItem = (0, import_react86.useCallback)(function(choice) {
    return choice ? React142.createElement(MenuItem_default, { key: getChoiceValue(choice), value: getChoiceValue(choice), disabled: getDisableValue(choice) }, renderMenuItemOption(!!createItem && (choice === null || choice === void 0 ? void 0 : choice.id) === createItem.id ? createItem : choice)) : null;
  }, [getChoiceValue, getDisableValue, renderMenuItemOption, createItem]);
  if (isLoading) {
    return React142.createElement(LoadingInput, { label: label !== "" && label !== false && React142.createElement(FieldTitle_default, { label, source, resource: resourceProp, isRequired: isRequired2 }), sx: props.sx, helperText: React142.createElement(InputHelperText, { touched: isTouched || isSubmitted, error: error === null || error === void 0 ? void 0 : error.message, helperText }), variant: props.variant, size: props.size, margin: props.margin, fullWidth: props.fullWidth });
  }
  var renderHelperText = !!fetchError || helperText !== false || (isTouched || isSubmitted) && invalid;
  return React142.createElement(
    ...
    React142.createElement(
      ...
      __assign96({ id }, field, { className: clsx_m_default("ra-input", "ra-input-".concat(source), className), onChange: handleChangeWithCreateSupport, select: true, label: label !== "" && label !== false && React142.createElement(FieldTitle_default, { label, source, resource: resourceProp, isRequired: isRequired2 }), clearAlwaysVisible: true, error: !!fetchError || (isTouched || isSubmitted) && invalid, helperText: renderHelperText ? React142.createElement(InputHelperText, { touched: isTouched || isSubmitted || fetchError, error: (error === null || error === void 0 ? void 0 : error.message) || (fetchError === null || fetchError === void 0 ? void 0 : fetchError.message), helperText }) : null, margin }, sanitizeRestProps19(rest)),
      !isRequired2 && React142.createElement(MenuItem_default, { value: emptyValue, key: "null", "aria-label": translate("ra.action.clear_input_value"), title: translate("ra.action.clear_input_value") }, renderEmptyItemOption()),
...
SelectInput.propTypes = {
  emptyText: import_prop_types78.default.oneOfType([import_prop_types78.default.string, import_prop_types78.default.element]),
  emptyValue: import_prop_types78.default.any,
  choices: import_prop_types78.default.arrayOf(import_prop_types78.default.object),
  className: import_prop_types78.default.string,
  label: import_prop_types78.default.oneOfType([
    import_prop_types78.default.string,
    import_prop_types78.default.bool,
    import_prop_types78.default.element
  ]),
  optionText: import_prop_types78.default.oneOfType([
    import_prop_types78.default.string,
    import_prop_types78.default.func,
    import_prop_types78.default.element
  ]),
  optionValue: import_prop_types78.default.string,
  disableValue: import_prop_types78.default.string,
  resettable: import_prop_types78.default.bool,
  resource: import_prop_types78.default.string,
  source: import_prop_types78.default.string,
  translateChoice: import_prop_types78.default.bool
};
var sanitizeRestProps19 = function(_a15) {
  var afterSubmit = _a15.afterSubmit, allowNull = _a15.allowNull, beforeSubmit = _a15.beforeSubmit, choices2 = _a15.choices, className = _a15.className, crudGetMatching = _a15.crudGetMatching, crudGetOne = _a15.crudGetOne, data = _a15.data, field = _a15.field, fieldState = _a15.fieldState, formState = _a15.formState, filter = _a15.filter, filterToQuery = _a15.filterToQuery, formatOnBlur = _a15.formatOnBlur, isEqual9 = _a15.isEqual, limitChoicesToValue = _a15.limitChoicesToValue, multiple = _a15.multiple, name = _a15.name, pagination = _a15.pagination, perPage = _a15.perPage, ref = _a15.ref, reference = _a15.reference, refetch = _a15.refetch, render = _a15.render, setFilter = _a15.setFilter, setPagination = _a15.setPagination, setSort = _a15.setSort, shouldUnregister = _a15.shouldUnregister, sort = _a15.sort, subscription = _a15.subscription, type = _a15.type, validateFields = _a15.validateFields, validation = _a15.validation, value = _a15.value, rest = __rest87(_a15, ["afterSubmit", "allowNull", "beforeSubmit", "choices", "className", "crudGetMatching", "crudGetOne", "data", "field", "fieldState", "formState", "filter", "filterToQuery", "formatOnBlur", "isEqual", "limitChoicesToValue", "multiple", "name", "pagination", "perPage", "ref", "reference", "refetch", "render", "setFilter", "setPagination", "setSort", "shouldUnregister", "sort", "subscription", "type", "validateFields", "validation", "value"]);
  return sanitizeInputRestProps(rest);
};
var PREFIX61 = "RaSelectInput";
...
var TranslatableInputsTab = function(props) {
  ...
  var translate = useTranslate();
  return import_react87.default.createElement(StyledTab, __assign97({ id: "translatable-header-".concat(groupKey).concat(locale), label: translate("ra.locales.".concat(locale), {
    _: (0, import_inflection5.capitalize)(locale)
  }), className: clsx_m_default(TranslatableInputsTabClasses.root, (_a15 = {}, _a15[TranslatableInputsTabClasses.error] = !isValid && isTouched, _a15)) }, rest));
};
var PREFIX62 = "RaTranslatableInputsTab";
var TranslatableInputsTabClasses = {
  root: "".concat(PREFIX62, "-root"),
  error: "".concat(PREFIX62, "-error")
};
var StyledTab = styled_default(Tab_default, { name: PREFIX62 })(function(_a15) {
  var _b;
  var theme = _a15.theme;
...
var TranslatableInputsTabs = function(props) {
  ...
  var _a15 = useTranslatableContext(), locales = _a15.locales, selectLocale = _a15.selectLocale, selectedLocale = _a15.selectedLocale;
  ...
  return React144.createElement(
    ...
    React144.createElement(Tabs_default, __assign98({ value: selectedLocale, onChange: handleChange, indicatorColor: "primary", textColor: "primary", className: TranslatableInputsTabsClasses.tabs }, tabsProps), locales.map(function(locale) {
      return React144.createElement(TranslatableInputsTab, { key: locale, value: locale, locale, groupKey });
    }))
  );
};
var PREFIX63 = "RaTranslatableInputsTabs";
var TranslatableInputsTabsClasses = {
  root: "".concat(PREFIX63, "-root"),
  tabs: "".concat(PREFIX63, "-tabs")
};
var StyledAppBar2 = styled_default(AppBar_default, { name: PREFIX63 })(function(_a15) {
  var _b;
  var theme = _a15.theme;
...
var TranslatableInputsTabContent = function(props) {
  var _a15;
  var children = props.children, _b = props.groupKey, groupKey = _b === void 0 ? "" : _b, locale = props.locale, other = __rest89(props, ["children", "groupKey", "locale"]);
  ...
  return React145.createElement(
    ...
    React145.createElement(Root24, __assign99({ role: "tabpanel", id: "translatable-content-".concat(groupKey).concat(locale), "aria-labelledby": "translatable-header-".concat(groupKey).concat(locale), className: clsx_m_default(TranslatableInputsTabContentClasses.root, (_a15 = {}, _a15[TranslatableInputsTabContentClasses.hidden] = selectedLocale !== locale, _a15)) }, other), import_react88.Children.map(children, function(child) {
      return (0, import_react88.isValidElement)(child) ? (0, import_react88.cloneElement)(child, __assign99(__assign99({}, child.props), { label: getLabel(child.props.source, child.props.label), source: getSource(child.props.source, locale) })) : null;
    }))
  );
};
var PREFIX64 = "RaTranslatableInputsTabContent";
var TranslatableInputsTabContentClasses = {
  root: "".concat(PREFIX64, "-root"),
  hidden: "".concat(PREFIX64, "-hidden")
};
var Root24 = styled_default(Stack_default, { name: PREFIX64 })(function(_a15) {
  var _b;
  var theme = _a15.theme;
...
var TranslatableInputs = function(props) {
  var _a15;
  var className = props.className, defaultLocale = props.defaultLocale, fullWidth = props.fullWidth, locales = props.locales, _b = props.groupKey, groupKey = _b === void 0 ? "" : _b, _c = props.selector, selector = _c === void 0 ? React146.createElement(TranslatableInputsTabs, { groupKey }) : _c, children = props.children, margin = props.margin, sx = props.sx, _d = props.StackProps, StackProps = _d === void 0 ? {} : _d;
  var context = useTranslatable({ defaultLocale, locales });
  return React146.createElement(
    Root25,
    { className: clsx_m_default(className, TranslatableInputsClasses.root, (_a15 = {}, _a15[TranslatableInputsClasses.fullWidth] = fullWidth, _a15)), sx },
    React146.createElement(
      TranslatableContextProvider,
      { value: context },
      selector,
      locales.map(function(locale) {
        return React146.createElement(TranslatableInputsTabContent, __assign100({ key: locale, locale, groupKey, margin }, StackProps), children);
      })
    )
  );
};
var PREFIX65 = "RaTranslatableInputs";
var TranslatableInputsClasses = {
  root: "".concat(PREFIX65, "-root"),
  fullWidth: "".concat(PREFIX65, "-fullWidth")
};
...
var LoginForm = function(props) {
  ...
  var _a15 = useSafeSetState(false), loading = _a15[0], setLoading = _a15[1];
  ...
  return React147.createElement(
    ...
    React147.createElement(
      ...
      React147.createElement(TextInput, { autoFocus: true, source: "username", label: translate("ra.auth.username"), autoComplete: "username", validate: required(), fullWidth: true }),
      React147.createElement(TextInput, { source: "password", label: translate("ra.auth.password"), type: "password", autoComplete: "current-password", validate: required(), fullWidth: true }),
      React147.createElement(Button_default, { variant: "contained", type: "submit", color: "primary", disabled: loading, fullWidth: true, className: LoginFormClasses.button }, loading ? React147.createElement(CircularProgress_default, { className: LoginFormClasses.icon, size: 19, thickness: 3 }) : translate("ra.auth.sign_in"))
    )
  );
};
var PREFIX66 = "RaLoginForm";
var LoginFormClasses = {
  content: "".concat(PREFIX66, "-content"),
  button: "".concat(PREFIX66, "-button"),
  icon: "".concat(PREFIX66, "-icon")
};
...
LoginForm.propTypes = {
  redirectTo: import_prop_types79.default.string
};
...
var Login = function(props) {
  var _a15 = props.children, children = _a15 === void 0 ? defaultLoginForm : _a15, backgroundImage = props.backgroundImage, rest = __rest90(props, ["children", "backgroundImage"]);
  var containerRef = (0, import_react89.useRef)();
    ...
    React148.createElement(
      ...
      React148.createElement(
        ...
        React148.createElement(
          ...
          React148.createElement(import_Lock2.default, null)
        )
      ),
      children
    )
...
var defaultLoginForm = React148.createElement(LoginForm, null);
var PREFIX67 = "RaLogin";
var LoginClasses = {
  card: "".concat(PREFIX67, "-card"),
  avatar: "".concat(PREFIX67, "-avatar"),
  icon: "".concat(PREFIX67, "-icon")
};
...
Login.propTypes = {
  backgroundImage: import_prop_types80.default.string,
...
var CreateView = function(props) {
  var _a15;
  var actions = props.actions, aside = props.aside, children = props.children, className = props.className, _b = props.component, Content = _b === void 0 ? Card_default : _b, title = props.title, rest = __rest91(props, ["actions", "aside", "children", "className", "component", "title"]);
  ...
  return React149.createElement(
    ...
    React149.createElement(Title, { title, defaultTitle, preferenceKey: "".concat(resource, ".create.title") }),
    actions,
    React149.createElement(
      "div",
      { className: clsx_m_default(CreateClasses.main, (_a15 = {}, _a15[CreateClasses.noActions] = !actions, _a15)) },
      React149.createElement(Content, { className: CreateClasses.card }, children),
      aside
    )
  );
};
CreateView.propTypes = {
  actions: import_prop_types81.default.oneOfType([import_prop_types81.default.element, import_prop_types81.default.bool]),
  aside: import_prop_types81.default.element,
  children: import_prop_types81.default.node,
  className: import_prop_types81.default.string,
  defaultTitle: import_prop_types81.default.any,
  hasList: import_prop_types81.default.bool,
  hasShow: import_prop_types81.default.bool,
  mutationOptions: import_prop_types81.default.object,
  record: import_prop_types81.default.object,
  redirect: import_prop_types81.default.oneOfType([
    import_prop_types81.default.string,
    import_prop_types81.default.bool,
    import_prop_types81.default.func
  ]),
  resource: import_prop_types81.default.string,
  save: import_prop_types81.default.func,
  title: import_prop_types81.default.node
};
var sanitizeRestProps20 = function(_a15) {
  var _b = _a15.addMiddleware, addMiddleware = _b === void 0 ? null : _b, _c = _a15.defaultTitle, defaultTitle = _c === void 0 ? null : _c, _d = _a15.hasCreate, hasCreate = _d === void 0 ? null : _d, _e = _a15.hasEdit, hasEdit = _e === void 0 ? null : _e, _f = _a15.hasList, hasList = _f === void 0 ? null : _f, _g = _a15.hasShow, hasShow = _g === void 0 ? null : _g, _h = _a15.history, history = _h === void 0 ? null : _h, _j = _a15.isFetching, isFetching = _j === void 0 ? null : _j, _k = _a15.isLoading, isLoading = _k === void 0 ? null : _k, _l = _a15.location, location = _l === void 0 ? null : _l, _m = _a15.match, match = _m === void 0 ? null : _m, _o = _a15.mutationOptions, mutationOptions = _o === void 0 ? null : _o, _p = _a15.options, options = _p === void 0 ? null : _p, _q = _a15.permissions, permissions = _q === void 0 ? null : _q, _r = _a15.save, save = _r === void 0 ? null : _r, _s = _a15.saving, saving = _s === void 0 ? null : _s, _t = _a15.transform, transform = _t === void 0 ? null : _t, _u = _a15.removeMiddleware, removeMiddleware = _u === void 0 ? null : _u, rest = __rest91(_a15, ["addMiddleware", "defaultTitle", "hasCreate", "hasEdit", "hasList", "hasShow", "history", "isFetching", "isLoading", "location", "match", "mutationOptions", "options", "permissions", "save", "saving", "transform", "removeMiddleware"]);
  return rest;
};
var PREFIX68 = "RaCreate";
var CreateClasses = {
  main: "".concat(PREFIX68, "-main"),
  noActions: "".concat(PREFIX68, "-noActions"),
  card: "".concat(PREFIX68, "-card")
};
...
var Create = function(props) {
  ...
  return React150.createElement(
    ...
    React150.createElement(CreateView, __assign104({}, rest))
  );
};
Create.propTypes = {
  ...
  disableAuthentication: import_prop_types82.default.bool,
  hasEdit: import_prop_types82.default.bool,
  ...
  transform: import_prop_types82.default.func,
  sx: import_prop_types82.default.any
};
...
var CreateActions = function(_a15) {
  var className = _a15.className, rest = __rest93(_a15, ["className"]);
  var hasList = useResourceDefinition(rest).hasList;
  return React151.createElement(TopToolbar_default, __assign105({ className }, sanitizeRestProps21(rest)), hasList && React151.createElement(ListButton, null));
};
var sanitizeRestProps21 = function(_a15) {
  var _b = _a15.className, className = _b === void 0 ? null : _b, _c = _a15.hasList, hasList = _c === void 0 ? null : _c, _d = _a15.resource, resource = _d === void 0 ? null : _d, rest = __rest93(_a15, ["className", "hasList", "resource"]);
  return rest;
};
...
var EditActions = function(_a15) {
  var className = _a15.className, rest = __rest94(_a15, ["className"]);
  var record = useEditContext(rest).record;
  var hasShow = useResourceDefinition(rest).hasShow;
  return React152.createElement(TopToolbar_default, __assign106({ className }, sanitizeRestProps22(rest)), hasShow && React152.createElement(ShowButton_default, { record }));
};
var sanitizeRestProps22 = function(_a15) {
  var _b = _a15.hasCreate, hasCreate = _b === void 0 ? null : _b, _c = _a15.hasEdit, hasEdit = _c === void 0 ? null : _c, _d = _a15.hasShow, hasShow = _d === void 0 ? null : _d, _e = _a15.hasList, hasList = _e === void 0 ? null : _e, rest = __rest94(_a15, ["hasCreate", "hasEdit", "hasShow", "hasList"]);
  return rest;
};
EditActions.propTypes = {
  className: import_prop_types84.default.string,
  data: import_prop_types84.default.object,
  hasCreate: import_prop_types84.default.bool,
  hasEdit: import_prop_types84.default.bool,
  hasShow: import_prop_types84.default.bool,
  hasList: import_prop_types84.default.bool,
...
var EditView = function(props) {
  var _a15;
  var actions = props.actions, aside = props.aside, children = props.children, className = props.className, _b = props.component, Content = _b === void 0 ? Card_default : _b, title = props.title, mutationMode = props.mutationMode, rest = __rest95(props, ["actions", "aside", "children", "className", "component", "title", "mutationMode"]);
  ...
  var finalActions = typeof actions === "undefined" && hasShow ? React153.createElement(EditActions, null) : actions;
  if (!children) {
    return null;
  }
  return React153.createElement(
    ...
    React153.createElement(Title, { title, defaultTitle, preferenceKey: "".concat(resource, ".edit.title") }),
    finalActions,
    React153.createElement(
      "div",
      { className: clsx_m_default(EditClasses.main, (_a15 = {}, _a15[EditClasses.noActions] = !finalActions, _a15)) },
      React153.createElement(Content, { className: EditClasses.card }, record ? children : React153.createElement(CardContent_default, null, " ")),
      aside
    )
  );
};
EditView.propTypes = {
  actions: import_prop_types85.default.oneOfType([import_prop_types85.default.element, import_prop_types85.default.bool]),
  aside: import_prop_types85.default.element,
  className: import_prop_types85.default.string,
  component: ComponentPropType_default,
  defaultTitle: import_prop_types85.default.any,
  hasList: import_prop_types85.default.bool,
  hasShow: import_prop_types85.default.bool,
  mutationMode: import_prop_types85.default.oneOf(["pessimistic", "optimistic", "undoable"]),
  mutationOptions: import_prop_types85.default.object,
  record: import_prop_types85.default.object,
  redirect: import_prop_types85.default.oneOfType([
    import_prop_types85.default.string,
    import_prop_types85.default.bool,
    import_prop_types85.default.func
  ]),
  resource: import_prop_types85.default.string,
  save: import_prop_types85.default.func,
  title: import_prop_types85.default.node
};
var sanitizeRestProps23 = function(_a15) {
  var _b = _a15.addMiddleware, addMiddleware = _b === void 0 ? null : _b, _c = _a15.defaultTitle, defaultTitle = _c === void 0 ? null : _c, _d = _a15.hasCreate, hasCreate = _d === void 0 ? null : _d, _e = _a15.hasEdit, hasEdit = _e === void 0 ? null : _e, _f = _a15.hasList, hasList = _f === void 0 ? null : _f, _g = _a15.hasShow, hasShow = _g === void 0 ? null : _g, _h = _a15.history, history = _h === void 0 ? null : _h, _j = _a15.id, id = _j === void 0 ? null : _j, _k = _a15.isFetching, isFetching = _k === void 0 ? null : _k, _l = _a15.isLoading, isLoading = _l === void 0 ? null : _l, _m = _a15.location, location = _m === void 0 ? null : _m, _o = _a15.match, match = _o === void 0 ? null : _o, _p = _a15.options, options = _p === void 0 ? null : _p, _q = _a15.queryOptions, queryOptions = _q === void 0 ? null : _q, _r = _a15.mutationOptions, mutationOptions = _r === void 0 ? null : _r, _s = _a15.permissions, permissions = _s === void 0 ? null : _s, _t = _a15.refetch, refetch = _t === void 0 ? null : _t, _u = _a15.removeMiddleware, removeMiddleware = _u === void 0 ? null : _u, _v = _a15.resource, resource = _v === void 0 ? null : _v, _w = _a15.save, save = _w === void 0 ? null : _w, _x = _a15.saving, saving = _x === void 0 ? null : _x, _y = _a15.transform, transform = _y === void 0 ? null : _y, rest = __rest95(_a15, ["addMiddleware", "defaultTitle", "hasCreate", "hasEdit", "hasList", "hasShow", "history", "id", "isFetching", "isLoading", "location", "match", "options", "queryOptions", "mutationOptions", "permissions", "refetch", "removeMiddleware", "resource", "save", "saving", "transform"]);
  return rest;
};
var PREFIX69 = "RaEdit";
var EditClasses = {
...
})((_a9 = {}, _a9["& .".concat(EditClasses.main)] = {
  display: "flex",
  alignItems: "flex-start"
}, _a9["& .".concat(EditClasses.noActions)] = {
  marginTop: "1em"
}, _a9["& .".concat(EditClasses.card)] = {
  flex: "1 1 auto"
}, _a9));
...
var Edit = function(props) {
  ...
  return React154.createElement(
    ...
    React154.createElement(EditView, __assign108({}, rest))
  );
};
Edit.propTypes = {
  actions: import_prop_types86.default.oneOfType([import_prop_types86.default.element, import_prop_types86.default.bool]),
  aside: import_prop_types86.default.element,
  children: import_prop_types86.default.node,
  className: import_prop_types86.default.string,
  disableAuthentication: import_prop_types86.default.bool,
  hasCreate: import_prop_types86.default.bool,
  hasEdit: import_prop_types86.default.bool,
  hasShow: import_prop_types86.default.bool,
  hasList: import_prop_types86.default.bool,
  id: import_prop_types86.default.any,
  mutationMode: import_prop_types86.default.oneOf(["pessimistic", "optimistic", "undoable"]),
  mutationOptions: import_prop_types86.default.object,
  queryOptions: import_prop_types86.default.object,
  redirect: import_prop_types86.default.oneOfType([
    import_prop_types86.default.string,
    import_prop_types86.default.bool,
    import_prop_types86.default.func
  ]),
  resource: import_prop_types86.default.string,
  title: import_prop_types86.default.node,
  transform: import_prop_types86.default.func,
  sx: import_prop_types86.default.any
};
...
var Toolbar = function(props) {
  var _a15;
  var children = props.children, className = props.className, resource = props.resource, rest = __rest97(props, ["children", "className", "resource"]);
  var isXs = useMediaQuery(function(theme) {
    return theme.breakpoints.down("sm");
  });
  return React155.createElement(StyledToolbar2, __assign109({ className: clsx_m_default((_a15 = {}, _a15[ToolbarClasses.mobileToolbar] = isXs, _a15[ToolbarClasses.desktopToolbar] = !isXs, _a15), className), role: "toolbar" }, rest), import_react90.Children.count(children) === 0 ? React155.createElement(
    "div",
    { className: ToolbarClasses.defaultToolbar },
    React155.createElement(SaveButton, null),
    React155.createElement(DeleteButton, { resource })
  ) : children);
};
Toolbar.propTypes = {
...
var PREFIX70 = "RaToolbar";
var ToolbarClasses = {
  desktopToolbar: "".concat(PREFIX70, "-desktopToolbar"),
  mobileToolbar: "".concat(PREFIX70, "-mobileToolbar"),
  defaultToolbar: "".concat(PREFIX70, "-defaultToolbar")
};
...
var TabbedFormTabs = function(props) {
  var children = props.children, url = props.url, syncWithLocation = props.syncWithLocation, value = props.value, rest = __rest98(props, ["children", "url", "syncWithLocation", "value"]);
  var params = useParams();
  var tabValue = params["*"];
  return React156.createElement(Tabs_default, __assign110({ value: syncWithLocation ? tabValue : value, indicatorColor: "primary" }, rest), import_react91.Children.map(children, function(tab, index) {
    if (!(0, import_react91.isValidElement)(tab))
      return null;
    var tabPath = getTabbedFormTabFullPath(tab, index);
    return (0, import_react91.cloneElement)(tab, {
      intent: "header",
...
TabbedFormTabs.propTypes = {
  ...
  url: import_prop_types88.default.string,
  tabsWithErrors: import_prop_types88.default.arrayOf(import_prop_types88.default.string)
};
...
var TabbedFormView = function(props) {
  ...
  var renderTabHeaders = function() {
    return (0, import_react92.cloneElement)(tabs, {
  ...
  return React157.createElement(
    ...
    syncWithLocation ? React157.createElement(
      Routes,
      null,
      React157.createElement(Route, { path: "/*", element: renderTabHeaders() })
    ) : renderTabHeaders(),
    React157.createElement(Divider_default, null),
    React157.createElement(Component2, null, import_react92.Children.map(children, function(tab, index) {
      if (!tab) {
        return null;
      }
      var tabPath = getTabbedFormTabFullPath(tab, index);
      var hidden = syncWithLocation ? !matchPath("".concat(resolvedPath.pathname, "/").concat(tabPath), location.pathname) : tabValue !== index;
      return (0, import_react92.isValidElement)(tab) ? React157.cloneElement(tab, {
        intent: "content",
        resource,
        hidden,
        value: syncWithLocation ? tabPath : index
...
TabbedFormView.propTypes = {
  ...
  location: import_prop_types89.default.object,
  match: import_prop_types89.default.object,
  // @ts-ignore
  resource: import_prop_types89.default.string,
  tabs: import_prop_types89.default.element,
  toolbar: import_prop_types89.default.oneOfType([import_prop_types89.default.element, import_prop_types89.default.oneOf([false])]),
  validate: import_prop_types89.default.func,
  value: import_prop_types89.default.number
};
var DefaultTabs = React157.createElement(TabbedFormTabs, null);
var DefaultComponent = function(_a15) {
  var children = _a15.children;
  return React157.createElement(CardContent_default, null, children);
};
var DefaultToolbar2 = React157.createElement(Toolbar, null);
var PREFIX71 = "RaTabbedForm";
var TabbedFormClasses = {
  errorTabButton: "".concat(PREFIX71, "-errorTabButton")
};
...
var sanitizeRestProps24 = function(_a15) {
  var record = _a15.record, resource = _a15.resource, rest = __rest99(_a15, ["record", "resource"]);
  return rest;
};
...
var FormTabHeader = function(_a15) {
  var _b;
  var count = _a15.count, label = _a15.label, value = _a15.value, icon = _a15.icon, className = _a15.className, onChange = _a15.onChange, syncWithLocation = _a15.syncWithLocation, rest = __rest100(_a15, ["count", "label", "value", "icon", "className", "onChange", "syncWithLocation"]);
  var translate = useTranslate();
  var location = useLocation();
  ...
  if (count !== void 0) {
    tabLabel = React158.createElement(
      "span",
      null,
      tabLabel,
      " (",
  ...
  return React158.createElement(Tab_default, __assign112({ label: tabLabel, value, icon, className: clsx_m_default("form-tab", className, (_b = {}, _b[TabbedFormClasses.errorTabButton] = !formGroup.isValid && (formGroup.isTouched || isSubmitted), _b.error = !formGroup.isValid && (formGroup.isTouched || isSubmitted), _b)) }, syncWithLocation ? propsForLink : {}, { id: "tabheader-".concat(value), "aria-controls": "tabpanel-".concat(value), onChange }, rest));
};
FormTabHeader.propTypes = {
  className: import_prop_types90.default.string,
  contentClassName: import_prop_types90.default.string,
  count: import_prop_types90.default.node,
  children: import_prop_types90.default.node,
  intent: import_prop_types90.default.oneOf(["header", "content"]),
  hidden: import_prop_types90.default.bool,
  icon: import_prop_types90.default.element,
  label: import_prop_types90.default.oneOfType([import_prop_types90.default.string, import_prop_types90.default.element]).isRequired,
  margin: import_prop_types90.default.oneOf(["none", "dense", "normal"]),
  path: import_prop_types90.default.string,
  // @ts-ignore
  record: import_prop_types90.default.object,
  resource: import_prop_types90.default.string,
  value: import_prop_types90.default.oneOfType([import_prop_types90.default.string, import_prop_types90.default.number]),
...
var FormTab = function(props) {
  var children = props.children, className = props.className, contentClassName = props.contentClassName, count = props.count, hidden = props.hidden, icon = props.icon, intent = props.intent, label = props.label, onChange = props.onChange, path = props.path, resource = props.resource, syncWithLocation = props.syncWithLocation, value = props.value, rest = __rest101(props, ["children", "className", "contentClassName", "count", "hidden", "icon", "intent", "label", "onChange", "path", "resource", "syncWithLocation", "value"]);
  var renderHeader = function() {
    return React159.createElement(FormTabHeader, __assign113({ label, count, value, icon, className, syncWithLocation, onChange }, sanitizeRestProps25(rest)));
  };
  var renderContent = function() {
    return React159.createElement(
      FormGroupContextProvider,
      { name: value.toString() },
      React159.createElement(Stack_default, __assign113({ alignItems: "flex-start", style: hidden ? hiddenStyle : null, className: contentClassName, id: "tabpanel-".concat(value), "aria-labelledby": "tabheader-".concat(value), "aria-hidden": hidden || void 0 }, rest), children)
    );
  };
...
FormTab.propTypes = {
  ...
  contentClassName: import_prop_types91.default.string,
  children: import_prop_types91.default.node,
  count: import_prop_types91.default.node,
  intent: import_prop_types91.default.oneOf(["header", "content"]),
  hidden: import_prop_types91.default.bool,
  icon: import_prop_types91.default.element,
  label: import_prop_types91.default.oneOfType([import_prop_types91.default.string, import_prop_types91.default.element]).isRequired,
  path: import_prop_types91.default.string,
  // @ts-ignore
  resource: import_prop_types91.default.string,
  value: import_prop_types91.default.oneOfType([import_prop_types91.default.string, import_prop_types91.default.number])
};
FormTab.displayName = "FormTab";
var hiddenStyle = { display: "none" };
var sanitizeRestProps25 = function(_a15) {
  var classes2 = _a15.classes, ref = _a15.ref, margin = _a15.margin, rest = __rest101(_a15, ["classes", "ref", "margin"]);
  return rest;
};
...
var TabbedForm = function(props) {
  ...
  return React160.createElement(
    ...
    React160.createElement(TabbedFormView, __assign114({ formRootPathname }, sanitizeRestProps26(props)))
  );
};
TabbedForm.Tab = FormTab;
var sanitizeRestProps26 = function(_a15) {
  var criteriaMode = _a15.criteriaMode, defaultValues = _a15.defaultValues, delayError = _a15.delayError, formRootPathname = _a15.formRootPathname, mode = _a15.mode, noValidate = _a15.noValidate, onSubmit = _a15.onSubmit, record = _a15.record, resetOptions = _a15.resetOptions, resolver = _a15.resolver, reValidateMode = _a15.reValidateMode, sanitizeEmptyValues = _a15.sanitizeEmptyValues, shouldFocusError = _a15.shouldFocusError, shouldUnregister = _a15.shouldUnregister, shouldUseNativeValidation = _a15.shouldUseNativeValidation, validate = _a15.validate, warnWhenUnsavedChanges = _a15.warnWhenUnsavedChanges, rest = __rest102(_a15, ["criteriaMode", "defaultValues", "delayError", "formRootPathname", "mode", "noValidate", "onSubmit", "record", "resetOptions", "resolver", "reValidateMode", "sanitizeEmptyValues", "shouldFocusError", "shouldUnregister", "shouldUseNativeValidation", "validate", "warnWhenUnsavedChanges"]);
  return rest;
};
TabbedForm.propTypes = {
  children: import_prop_types92.default.node,
  defaultValues: import_prop_types92.default.oneOfType([import_prop_types92.default.object, import_prop_types92.default.func]),
  formRootPathname: import_prop_types92.default.string,
  mutationMode: import_prop_types92.default.oneOf(["pessimistic", "optimistic", "undoable"]),
  // @ts-ignore
  record: import_prop_types92.default.object,
  saving: import_prop_types92.default.bool,
...
var findTabsWithErrors = function(children, errors) {
  ...
  return import_react93.Children.toArray(children).reduce(function(acc, child) {
    if (!(0, import_react93.isValidElement)(child)) {
      return acc;
    }
    var inputs = import_react93.Children.toArray(child.props.children);
    if (inputs.some(function(input) {
      return (0, import_react93.isValidElement)(input) && (0, import_get9.default)(errors, input.props.source);
    })) {
      return __spreadArray11(__spreadArray11([], acc, true), [child.props.label], false);
    }
    return acc;
  }, []);
};
...
var SimpleForm = function(props) {
  var children = props.children, className = props.className, _a15 = props.component, Component2 = _a15 === void 0 ? DefaultComponent2 : _a15, sx = props.sx, _b = props.toolbar, toolbar = _b === void 0 ? DefaultToolbar3 : _b, rest = __rest103(props, ["children", "className", "component", "sx", "toolbar"]);
  return React161.createElement(
    ...
    React161.createElement(
      Component2,
      { className, sx },
      React161.createElement(Stack_default, __assign115({ alignItems: "flex-start" }, sanitizeRestProps27(props)), children)
    ),
    toolbar !== false ? toolbar : null
  );
};
SimpleForm.propTypes = {
  ...
  defaultValues: import_prop_types93.default.oneOfType([import_prop_types93.default.object, import_prop_types93.default.func]),
  // @ts-ignore
  record: import_prop_types93.default.object,
  toolbar: import_prop_types93.default.oneOfType([import_prop_types93.default.element, import_prop_types93.default.oneOf([false])]),
  validate: import_prop_types93.default.func
};
var PREFIX72 = "RaSimpleForm";
...
var DefaultToolbar3 = React161.createElement(Toolbar, null);
var sanitizeRestProps27 = function(_a15) {
  var children = _a15.children, className = _a15.className, component = _a15.component, criteriaMode = _a15.criteriaMode, defaultValues = _a15.defaultValues, delayError = _a15.delayError, onSubmit = _a15.onSubmit, record = _a15.record, resource = _a15.resource, reValidateMode = _a15.reValidateMode, sx = _a15.sx, toolbar = _a15.toolbar, validate = _a15.validate, resetOptions = _a15.resetOptions, resolver = _a15.resolver, sanitizeEmptyValues = _a15.sanitizeEmptyValues, shouldFocusError = _a15.shouldFocusError, shouldUnregister = _a15.shouldUnregister, shouldUseNativeValidation = _a15.shouldUseNativeValidation, warnWhenUnsavedChanges = _a15.warnWhenUnsavedChanges, props = __rest103(_a15, ["children", "className", "component", "criteriaMode", "defaultValues", "delayError", "onSubmit", "record", "resource", "reValidateMode", "sx", "toolbar", "validate", "resetOptions", "resolver", "sanitizeEmptyValues", "shouldFocusError", "shouldUnregister", "shouldUseNativeValidation", "warnWhenUnsavedChanges"]);
  return props;
};
...
var SimpleFormEditor = function() {
  ...
  return React162.createElement(FieldsSelector, { name: "inputs", availableName: "availableInputs" });
};
...
var SimpleFormConfigurable = function(_a15) {
  var preferenceKey = _a15.preferenceKey, omit = _a15.omit, props = __rest104(_a15, ["preferenceKey", "omit"]);
  var translate = useTranslate();
  var resource = useResourceContext(props);
  ...
  React163.useEffect(function() {
    var inputs = React163.Children.map(props.children, function(child, index) {
      return React163.isValidElement(child) ? {
        index: String(index),
        source: child.props.source,
  ...
  return React163.createElement(
    Configurable,
    { editor: React163.createElement(SimpleFormEditor, null), preferenceKey: finalPreferenceKey, sx: {
      display: "block",
      "&.RaConfigurable-editMode": {
        margin: "2px"
      }
    } },
    React163.createElement(SimpleFormWithPreferences, __assign116({}, props))
  );
};
var SimpleFormWithPreferences = function(_a15) {
  var children = _a15.children, props = __rest104(_a15, ["children"]);
  ...
  return React163.createElement(SimpleForm, __assign116({}, props), inputs === void 0 ? children : inputs.map(function(index) {
    return childrenArray[index];
  }));
};
...
var editFieldTypes = {
  ...
  array: {
    ...
    component: function(_a15) {
      var children = _a15.children, props = __rest105(_a15, ["children"]);
      return React164.createElement(
        ArrayInput,
        __assign117({}, props),
        React164.createElement(SimpleFormIterator, null, children)
      );
    },
  ...
  referenceArrayChild: {
    component: function(props) {
      return React164.createElement(SelectInput, __assign117({ optionText: "id" }, props));
    },
...
var EditGuesser = function(props) {
  ...
  return React165.createElement(
    EditBase,
    { resource, id, mutationMode, mutationOptions, queryOptions, redirect, transform, disableAuthentication },
    React165.createElement(EditViewGuesser, __assign118({}, rest))
  );
};
var EditViewGuesser = function(props) {
  var resource = useResourceContext(props);
  var record = useEditContext().record;
  var _a15 = (0, import_react94.useState)(null), child = _a15[0], setChild = _a15[1];
  ...
  return React165.createElement(EditView, __assign118({}, rest), child);
};
...
var ShowActions = function(props) {
  ...
  return React166.createElement(
    ...
    React166.createElement(EditButton, { record })
  );
};
ShowActions.propTypes = {
  className: import_prop_types94.default.string,
  record: import_prop_types94.default.any
};
...
var _a10;
var defaultActions = React167.createElement(ShowActions, null);
var ShowView = function(props) {
  ...
  return React167.createElement(
    ...
    React167.createElement(Title, { title, defaultTitle, preferenceKey: "".concat(resource, ".show.title") }),
    finalActions !== false && finalActions,
    React167.createElement(
      "div",
      { className: clsx_m_default(ShowClasses.main, (_a15 = {}, _a15[ShowClasses.noActions] = !finalActions, _a15)) },
      React167.createElement(Content, { className: ShowClasses.card }, children),
      aside
    )
  );
};
ShowView.propTypes = {
  actions: import_prop_types95.default.oneOfType([import_prop_types95.default.element, import_prop_types95.default.bool]),
  children: import_prop_types95.default.node,
  className: import_prop_types95.default.string,
  emptyWhileLoading: import_prop_types95.default.bool,
  title: import_prop_types95.default.any
};
var sanitizeRestProps28 = function(_a15) {
  var _b = _a15.defaultTitle, defaultTitle = _b === void 0 ? null : _b, _c = _a15.hasCreate, hasCreate = _c === void 0 ? null : _c, _d = _a15.hasEdit, hasEdit = _d === void 0 ? null : _d, _e = _a15.hasList, hasList = _e === void 0 ? null : _e, _f = _a15.hasShow, hasShow = _f === void 0 ? null : _f, _g = _a15.history, history = _g === void 0 ? null : _g, _h = _a15.id, id = _h === void 0 ? null : _h, _j = _a15.isLoading, isLoading = _j === void 0 ? null : _j, _k = _a15.isFetching, isFetching = _k === void 0 ? null : _k, _l = _a15.location, location = _l === void 0 ? null : _l, _m = _a15.match, match = _m === void 0 ? null : _m, _o = _a15.options, options = _o === void 0 ? null : _o, _p = _a15.refetch, refetch = _p === void 0 ? null : _p, _q = _a15.permissions, permissions = _q === void 0 ? null : _q, rest = __rest107(_a15, ["defaultTitle", "hasCreate", "hasEdit", "hasList", "hasShow", "history", "id", "isLoading", "isFetching", "location", "match", "options", "refetch", "permissions"]);
  return rest;
};
var PREFIX73 = "RaShow";
var ShowClasses = {
  main: "".concat(PREFIX73, "-main"),
  noActions: "".concat(PREFIX73, "-noActions"),
  card: "".concat(PREFIX73, "-card")
};
var Root30 = styled_default("div", {
  name: PREFIX73,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
})((_a10 = {}, _a10["& .".concat(ShowClasses.main)] = {
  display: "flex"
}, _a10["& .".concat(ShowClasses.noActions)] = {
  marginTop: "1em"
}, _a10["& .".concat(ShowClasses.card)] = {
  flex: "1 1 auto"
}, _a10));
...
var Show = function(_a15) {
  var id = _a15.id, resource = _a15.resource, queryOptions = _a15.queryOptions, disableAuthentication = _a15.disableAuthentication, rest = __rest108(_a15, ["id", "resource", "queryOptions", "disableAuthentication"]);
  return React168.createElement(
    ShowBase,
    { id, disableAuthentication, queryOptions, resource },
    React168.createElement(ShowView, __assign120({}, rest))
  );
};
Show.propTypes = {
  actions: import_prop_types96.default.oneOfType([import_prop_types96.default.element, import_prop_types96.default.bool]),
  children: import_prop_types96.default.node.isRequired,
  className: import_prop_types96.default.string,
  disableAuthentication: import_prop_types96.default.bool,
  emptyWhileLoading: import_prop_types96.default.bool,
  component: import_prop_types96.default.elementType,
  resource: import_prop_types96.default.string,
  title: import_prop_types96.default.node,
  sx: import_prop_types96.default.any
};
...
var fieldPropTypes = {
  sortBy: import_prop_types97.default.string,
  sortByOrder: import_prop_types97.default.oneOf(["ASC", "DESC"]),
  source: import_prop_types97.default.string,
  label: import_prop_types97.default.oneOfType([
    import_prop_types97.default.string,
    import_prop_types97.default.element,
    import_prop_types97.default.bool
  ]),
  sortable: import_prop_types97.default.bool,
  className: import_prop_types97.default.string,
  cellClassName: import_prop_types97.default.string,
  headerClassName: import_prop_types97.default.string,
  textAlign: import_prop_types97.default.oneOf([
    "inherit",
    "left",
    "center",
    "right",
  ...
  emptyText: import_prop_types97.default.string
};
...
var genericMemo = function(component) {
  var _a15;
  var result = (0, import_react95.memo)(component);
  result.propTypes = component.propTypes;
  result.defaultProps = component.defaultProps;
  result.displayName = (_a15 = component.displayName) === null || _a15 === void 0 ? void 0 : _a15.replace("Impl", "");
  return result;
};
...
var ArrayFieldImpl = function(props) {
  ...
  return React169.createElement(ListContextProvider, { value: listContext }, children);
};
...
var sanitizeFieldRestProps = function(_a15) {
  var cellClassName = _a15.cellClassName, className = _a15.className, emptyText = _a15.emptyText, formClassName = _a15.formClassName, fullWidth = _a15.fullWidth, headerClassName = _a15.headerClassName, label = _a15.label, linkType = _a15.linkType, link = _a15.link, locale = _a15.locale, record = _a15.record, refetch = _a15.refetch, resource = _a15.resource, sortable = _a15.sortable, sortBy = _a15.sortBy, sortByOrder = _a15.sortByOrder, source = _a15.source, textAlign = _a15.textAlign, translateChoice = _a15.translateChoice, props = __rest109(_a15, ["cellClassName", "className", "emptyText", "formClassName", "fullWidth", "headerClassName", "label", "linkType", "link", "locale", "record", "refetch", "resource", "sortable", "sortBy", "sortByOrder", "source", "textAlign", "translateChoice"]);
  return props;
};
...
var BooleanFieldImpl = function(props) {
  ...
  if (looseValue || value === false || value === true) {
    return React170.createElement(
      ...
      React170.createElement(Tooltip_default, { title: translate(ariaLabel, { _: ariaLabel }) }, isTruthyValue ? TrueIcon ? React170.createElement(TrueIcon, { "data-testid": "true", fontSize: "small", className: classes.trueIcon }) : React170.createElement(React170.Fragment, null) : FalseIcon ? React170.createElement(FalseIcon, { "data-testid": "false", fontSize: "small", className: classes.falseIcon }) : React170.createElement(React170.Fragment, null))
    );
  }
  return React170.createElement(Typography_default, __assign122({ component: "span", variant: "body2", className }, sanitizeFieldRestProps(rest)), emptyText && translate(emptyText, { _: emptyText }));
};
BooleanFieldImpl.propTypes = __assign122(__assign122(__assign122({}, Typography_default.propTypes), fieldPropTypes), { valueLabelFalse: import_prop_types98.default.string, valueLabelTrue: import_prop_types98.default.string, TrueIcon: import_prop_types98.default.elementType, FalseIcon: import_prop_types98.default.elementType, looseValue: import_prop_types98.default.bool });
BooleanFieldImpl.displayName = "BooleanFieldImpl";
var BooleanField = genericMemo(BooleanFieldImpl);
var PREFIX74 = "RaBooleanField";
var classes = {
  trueIcon: "".concat(PREFIX74, "-trueIcon"),
  falseIcon: "".concat(PREFIX74, "-falseIcon")
};
var StyledTypography = styled_default(Typography_default, {
  ...
  lineHeight: 0
}, _a11["& .".concat(classes.trueIcon)] = {}, _a11["& .".concat(classes.falseIcon)] = {}, _a11));
...
var ChipFieldImpl = function(props) {
  ...
  if (value == null && emptyText) {
    return React171.createElement(Typography_default, __assign123({ component: "span", variant: "body2", className }, sanitizeFieldRestProps(rest)), emptyText && translate(emptyText, { _: emptyText }));
  }
  return React171.createElement(StyledChip, __assign123({ className: clsx_m_default(ChipFieldClasses.chip, className), label: value }, sanitizeFieldRestProps(rest)));
};
...
var PREFIX75 = "RaChipField";
var ChipFieldClasses = {
  chip: "".concat(PREFIX75, "-chip")
};
...
})((_a12 = {}, _a12["&.".concat(ChipFieldClasses.chip)] = { margin: 4, cursor: "inherit" }, _a12));
...
var DateFieldImpl = function(props) {
  ...
  if (value == null || value === "") {
    return emptyText ? React172.createElement(Typography_default, __assign124({ component: "span", variant: "body2", className }, sanitizeFieldRestProps(rest)), emptyText && translate(emptyText, { _: emptyText })) : null;
  }
  ...
  return React172.createElement(Typography_default, __assign124({ component: "span", variant: "body2", className }, sanitizeFieldRestProps(rest)), dateString);
};
DateFieldImpl.propTypes = __assign124(__assign124(__assign124({}, Typography_default.propTypes), fieldPropTypes), { locales: import_prop_types99.default.oneOfType([
  import_prop_types99.default.string,
  import_prop_types99.default.arrayOf(import_prop_types99.default.string)
]), options: import_prop_types99.default.object, showTime: import_prop_types99.default.bool, showDate: import_prop_types99.default.bool });
...
var EmailFieldImpl = function(props) {
  ...
  var translate = useTranslate();
  if (value == null) {
    return emptyText ? React173.createElement(Typography_default, __assign125({ component: "span", variant: "body2", className }, sanitizeFieldRestProps(rest)), emptyText && translate(emptyText, { _: emptyText })) : null;
  }
  return React173.createElement(Link_default, __assign125({ className, href: "mailto:".concat(value), onClick: stopPropagation4, variant: "body2" }, sanitizeFieldRestProps(rest)), value);
};
...
var FileField = function(props) {
  ...
  var translate = useTranslate();
  if (!sourceValue) {
    return emptyText ? React174.createElement(Typography_default, __assign126({ component: "span", variant: "body2", className }, sanitizeFieldRestProps(rest)), emptyText && translate(emptyText, { _: emptyText })) : React174.createElement(Root31, __assign126({ className }, sanitizeFieldRestProps(rest)));
  }
  if (Array.isArray(sourceValue)) {
    return React174.createElement(StyledList, __assign126({ className }, sanitizeFieldRestProps(rest)), sourceValue.map(function(file, index) {
      ...
      return React174.createElement(
        "li",
        { key: index },
        React174.createElement(Link_default, { href: srcValue, title: fileTitleValue, target, download, ping, rel, variant: "body2", onClick: function(e) {
          return e.stopPropagation();
        } }, fileTitleValue)
      );
    }));
  }
  var titleValue = ((_a15 = (0, import_get15.default)(record, title)) === null || _a15 === void 0 ? void 0 : _a15.toString()) || title;
  return React174.createElement(
    Root31,
    __assign126({ className }, sanitizeFieldRestProps(rest)),
    React174.createElement(Link_default, { href: sourceValue === null || sourceValue === void 0 ? void 0 : sourceValue.toString(), title: titleValue, target, download, ping, rel, variant: "body2" }, titleValue)
  );
};
FileField.propTypes = __assign126(__assign126({}, fieldPropTypes), { src: import_prop_types100.default.string, title: import_prop_types100.default.string, target: import_prop_types100.default.string, download: import_prop_types100.default.oneOfType([import_prop_types100.default.bool, import_prop_types100.default.string]), ping: import_prop_types100.default.string, rel: import_prop_types100.default.string });
var PREFIX76 = "RaFileField";
...
var FunctionField = function(props) {
  var className = props.className, _a15 = props.source, source = _a15 === void 0 ? "" : _a15, render = props.render, rest = __rest115(props, ["className", "source", "render"]);
  var record = useRecordContext(props);
  return (0, import_react96.useMemo)(function() {
    return record ? React175.createElement(Typography_default, __assign127({ component: "span", variant: "body2", className }, sanitizeFieldRestProps(rest)), render(record, source)) : null;
  }, [className, record, source, render, rest]);
};
FunctionField.propTypes = __assign127(__assign127(__assign127({}, Typography_default.propTypes), fieldPropTypes), { render: import_prop_types101.default.func.isRequired });
...
var ImageField = function(props) {
  ...
  var translate = useTranslate();
  if (!sourceValue) {
    return emptyText ? React176.createElement(Typography_default, __assign128({ component: "span", variant: "body2", className }, sanitizeFieldRestProps(rest)), emptyText && translate(emptyText, { _: emptyText })) : React176.createElement(Typography_default, __assign128({ component: "div", className }, sanitizeFieldRestProps(rest)));
  }
  if (Array.isArray(sourceValue)) {
    return React176.createElement(
      Root32,
      __assign128({ className }, sanitizeFieldRestProps(rest)),
      React176.createElement("ul", { className: ImageFieldClasses.list }, sourceValue.map(function(file, index) {
        var fileTitleValue = (0, import_get16.default)(file, title) || title;
        var srcValue = (0, import_get16.default)(file, src) || title;
        return React176.createElement(
          "li",
          { key: index },
          React176.createElement("img", { alt: fileTitleValue, title: fileTitleValue, src: srcValue, className: ImageFieldClasses.image })
        );
      }))
    );
  }
  var titleValue = ((_a15 = (0, import_get16.default)(record, title)) === null || _a15 === void 0 ? void 0 : _a15.toString()) || title;
  return React176.createElement(
    Root32,
    __assign128({ className }, sanitizeFieldRestProps(rest)),
    React176.createElement("img", { title: titleValue, alt: titleValue, src: sourceValue === null || sourceValue === void 0 ? void 0 : sourceValue.toString(), className: ImageFieldClasses.image })
  );
};
ImageField.displayName = "ImageField";
ImageField.propTypes = __assign128(__assign128({}, fieldPropTypes), { src: import_prop_types102.default.string, title: import_prop_types102.default.string });
var PREFIX77 = "RaImageField";
var ImageFieldClasses = {
  list: "".concat(PREFIX77, "-list"),
  image: "".concat(PREFIX77, "-image")
};
var Root32 = styled_default(Box_default, {
  name: PREFIX77,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
})((_a13 = {}, _a13["& .".concat(ImageFieldClasses.list)] = {
  display: "flex",
  listStyleType: "none"
}, _a13["& .".concat(ImageFieldClasses.image)] = {
  margin: "0.25rem",
  width: 200,
  height: 100,
  objectFit: "contain"
...
var NumberFieldImpl = function(props) {
  var className = props.className, emptyText = props.emptyText, source = props.source, locales = props.locales, options = props.options, textAlign = props.textAlign, _a15 = props.transform, transform = _a15 === void 0 ? defaultTransform2 : _a15, rest = __rest117(props, ["className", "emptyText", "source", "locales", "options", "textAlign", "transform"]);
  var record = useRecordContext(props);
  var translate = useTranslate();
  if (!record) {
    return null;
  ...
  if (value == null) {
    return emptyText ? React177.createElement(Typography_default, __assign129({ component: "span", variant: "body2", className }, sanitizeFieldRestProps(rest)), emptyText && translate(emptyText, { _: emptyText })) : null;
  }
  if (transform) {
    value = transform(value);
  }
  return React177.createElement(Typography_default, __assign129({ variant: "body2", component: "span", className }, sanitizeFieldRestProps(rest)), hasNumberFormat && typeof value === "number" ? value.toLocaleString(locales, options) : value);
};
var defaultTransform2 = function(value) {
  return value && typeof value === "string" && !isNaN(value) ? +value : value;
};
NumberFieldImpl.propTypes = __assign129(__assign129(__assign129({}, Typography_default.propTypes), fieldPropTypes), { locales: import_prop_types103.default.oneOfType([
  import_prop_types103.default.string,
  import_prop_types103.default.arrayOf(import_prop_types103.default.string)
]), options: import_prop_types103.default.object });
...
var Link2 = function(props) {
  var to = props.to, children = props.children, className = props.className, rest = __rest118(props, ["to", "children", "className"]);
  return React178.createElement(StyledMuiLink, __assign130({ component: Link, to, className: clsx_m_default(LinkClasses.link, className), underline: "none" }, rest), children);
};
var PREFIX78 = "RaLink";
var LinkClasses = {
  link: "".concat(PREFIX78, "-link")
};
...
Link2.propTypes = {
  ...
  to: import_prop_types104.default.oneOfType([import_prop_types104.default.string, import_prop_types104.default.object])
};
...
var SingleFieldList = function(props) {
  var className = props.className, children = props.children, _a15 = props.linkType, linkType = _a15 === void 0 ? "edit" : _a15, _b = props.component, Component2 = _b === void 0 ? Root33 : _b, rest = __rest119(props, ["className", "children", "linkType", "component"]);
  var _c = useListContext(props), data = _c.data, isLoading = _c.isLoading;
  var resource = useResourceContext(props);
  var createPath = useCreatePath();
  if (isLoading === true) {
    return React179.createElement(LinearProgress_default, null);
  }
  return React179.createElement(Component2, __assign131({ className }, sanitizeListRestProps(rest)), data.map(function(record, rowIndex) {
    var _a16, _b2;
    ...
    if (resourceLinkPath) {
      return React179.createElement(
        RecordContextProvider,
        { value: record, key: (_a16 = record.id) !== null && _a16 !== void 0 ? _a16 : "row".concat(rowIndex) },
        React179.createElement(Link2, { className: SingleFieldListClasses.link, to: resourceLinkPath, onClick: stopPropagation5 }, (0, import_react97.cloneElement)(import_react97.Children.only(children), {
          record,
          resource,
    ...
    return React179.createElement(RecordContextProvider, { value: record, key: (_b2 = record.id) !== null && _b2 !== void 0 ? _b2 : "row".concat(rowIndex) }, children);
  }));
};
SingleFieldList.propTypes = {
  children: import_prop_types105.default.element.isRequired,
  ...
  ids: import_prop_types105.default.array,
  // @ts-ignore
  linkType: import_prop_types105.default.oneOfType([import_prop_types105.default.string, import_prop_types105.default.bool]),
  resource: import_prop_types105.default.string,
  sx: import_prop_types105.default.oneOfType([
    import_prop_types105.default.arrayOf(import_prop_types105.default.oneOfType([
      import_prop_types105.default.func,
      import_prop_types105.default.object,
      import_prop_types105.default.bool
    ])),
    import_prop_types105.default.func,
    import_prop_types105.default.object
  ])
};
var PREFIX79 = "RaSingleFieldList";
var SingleFieldListClasses = {
  link: "".concat(PREFIX79, "-link")
};
var Root33 = styled_default("div", {
  name: PREFIX79,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var ReferenceArrayField = function(props) {
  var filter = props.filter, _a15 = props.page, page = _a15 === void 0 ? 1 : _a15, perPage = props.perPage, reference = props.reference, resource = props.resource, sort = props.sort, source = props.source;
  var record = useRecordContext(props);
  ...
  return React180.createElement(
    ...
    React180.createElement(
      ...
      React180.createElement(PureReferenceArrayFieldView, __assign132({}, props))
    )
  );
};
ReferenceArrayField.propTypes = __assign132(__assign132({}, fieldPropTypes), { className: import_prop_types106.default.string, children: import_prop_types106.default.node, label: fieldPropTypes.label, record: import_prop_types106.default.any, reference: import_prop_types106.default.string.isRequired, resource: import_prop_types106.default.string, sortBy: import_prop_types106.default.string, sortByOrder: fieldPropTypes.sortByOrder, source: import_prop_types106.default.string.isRequired });
var ReferenceArrayFieldView = function(props) {
  ...
  var _a15 = useListContext(props), isLoading = _a15.isLoading, total = _a15.total;
  var recordRepresentation = useResourceDefinition({
    resource: reference
  }).recordRepresentation;
  var child = children ? children : React180.createElement(
    SingleFieldList,
    null,
    React180.createElement(ChipField, { source: typeof recordRepresentation === "string" ? recordRepresentation : "id", size: "small" })
  );
  return React180.createElement(Root34, { className, sx }, isLoading ? React180.createElement(LinearProgress, { className: ReferenceArrayFieldClasses.progress }) : React180.createElement(
    "span",
    null,
    child,
...
var PREFIX80 = "RaReferenceArrayField";
var ReferenceArrayFieldClasses = {
  progress: "".concat(PREFIX80, "-progress")
};
...
var PureReferenceArrayFieldView = (0, import_react98.memo)(ReferenceArrayFieldView);
...
var ReferenceField = function(props) {
  var source = props.source, emptyText = props.emptyText, _a15 = props.link, link = _a15 === void 0 ? "edit" : _a15, rest = __rest120(props, ["source", "emptyText", "link"]);
  var record = useRecordContext(props);
  var id = (0, import_get18.default)(record, source);
  var translate = useTranslate();
  return id == null ? emptyText ? React181.createElement(Typography_default, { component: "span", variant: "body2" }, emptyText && translate(emptyText, { _: emptyText })) : null : React181.createElement(NonEmptyReferenceField, __assign133({}, rest, { link, emptyText, record, id }));
};
ReferenceField.propTypes = {
  children: import_prop_types107.default.node,
  className: import_prop_types107.default.string,
  cellClassName: import_prop_types107.default.string,
  headerClassName: import_prop_types107.default.string,
  label: fieldPropTypes.label,
  record: import_prop_types107.default.any,
  reference: import_prop_types107.default.string.isRequired,
  resource: import_prop_types107.default.string,
  sortBy: import_prop_types107.default.string,
  sortByOrder: fieldPropTypes.sortByOrder,
  source: import_prop_types107.default.string.isRequired,
  translateChoice: import_prop_types107.default.oneOfType([import_prop_types107.default.func, import_prop_types107.default.bool]),
  // @ts-ignore
  link: import_prop_types107.default.oneOfType([
    import_prop_types107.default.string,
    import_prop_types107.default.bool,
    import_prop_types107.default.func
  ])
};
var NonEmptyReferenceField = function(_a15) {
  var children = _a15.children, id = _a15.id, reference = _a15.reference, queryOptions = _a15.queryOptions, link = _a15.link, props = __rest120(_a15, ["children", "id", "reference", "queryOptions", "link"]);
  return React181.createElement(
    ResourceContextProvider,
    { value: reference },
    React181.createElement(PureReferenceFieldView, __assign133({ reference }, props, useReference({
      reference,
      id,
...
var ReferenceFieldView = function(props) {
  ...
  if (error) {
    return (
      ...
      React181.createElement(import_Error3.default, { "aria-errormessage": error.message ? error.message : error, role: "presentation", color: "error", fontSize: "small" })
    );
  }
  if (isLoading) {
    return React181.createElement(LinearProgress, null);
  }
  if (!referenceRecord) {
    return emptyText ? React181.createElement(React181.Fragment, null, emptyText && translate(emptyText, { _: emptyText })) : null;
  }
  ...
  var child = children || React181.createElement(Typography_default, { component: "span", variant: "body2" }, getRecordRepresentation(referenceRecord));
  if (link) {
    return React181.createElement(
      Root35,
      { className, sx },
      React181.createElement(
        ...
        React181.createElement(Link2, { to: link, className: ReferenceFieldClasses.link, onClick: stopPropagation6 }, child)
      )
    );
  }
  return React181.createElement(RecordContextProvider, { value: referenceRecord }, child);
};
ReferenceFieldView.propTypes = {
  children: import_prop_types107.default.element,
  className: import_prop_types107.default.string,
  isLoading: import_prop_types107.default.bool,
  record: import_prop_types107.default.any,
  reference: import_prop_types107.default.string,
  referenceRecord: import_prop_types107.default.any,
  resource: import_prop_types107.default.string,
  // @ts-ignore
  resourceLinkPath: import_prop_types107.default.oneOfType([
    import_prop_types107.default.string,
    import_prop_types107.default.bool,
    import_prop_types107.default.func
  ]).isRequired,
  source: import_prop_types107.default.string,
  translateChoice: import_prop_types107.default.oneOfType([import_prop_types107.default.func, import_prop_types107.default.bool])
};
var PureReferenceFieldView = genericMemo(ReferenceFieldView);
var PREFIX81 = "RaReferenceField";
var ReferenceFieldClasses = {
  link: "".concat(PREFIX81, "-link")
};
var Root35 = styled_default("span", {
  name: PREFIX81,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var ReferenceManyCount = function(props) {
  var _a15;
  var reference = props.reference, target = props.target, filter = props.filter, sort = props.sort, link = props.link, resource = props.resource, _b = props.source, source = _b === void 0 ? "id" : _b, _c = props.timeout, timeout = _c === void 0 ? 1e3 : _c, rest = __rest121(props, ["reference", "target", "filter", "sort", "link", "resource", "source", "timeout"]);
  var record = useRecordContext(props);
  var oneSecondHasPassed = useTimeout(timeout);
  var createPath = useCreatePath();
  ...
  var body = isLoading ? oneSecondHasPassed ? import_react99.default.createElement(CircularProgress_default, { size: 14 }) : "" : error ? import_react99.default.createElement(import_Error4.default, { color: "error", fontSize: "small", titleAccess: "error" }) : total;
  return link ? import_react99.default.createElement(Link2, __assign134({ to: {
    pathname: createPath({ resource: reference, type: "list" }),
    search: "filter=".concat(JSON.stringify(__assign134(__assign134({}, filter || {}), (_a15 = {}, _a15[target] = record[source], _a15))))
  }, variant: "body2", onClick: function(e) {
    return e.stopPropagation();
  } }, sanitizeFieldRestProps(rest)), body) : import_react99.default.createElement(Typography_default, __assign134({ component: "span", variant: "body2" }, sanitizeFieldRestProps(rest)), body);
};
...
ReferenceManyField.propTypes = {
  children: import_prop_types108.default.node.isRequired,
  className: import_prop_types108.default.string,
  filter: import_prop_types108.default.object,
  label: fieldPropTypes.label,
  perPage: import_prop_types108.default.number,
  record: import_prop_types108.default.any,
  reference: import_prop_types108.default.string.isRequired,
  resource: import_prop_types108.default.string,
  sortBy: import_prop_types108.default.string,
  sortByOrder: fieldPropTypes.sortByOrder,
  source: import_prop_types108.default.string,
  sort: import_prop_types108.default.exact({
    field: import_prop_types108.default.string,
    order: import_prop_types108.default.oneOf(["ASC", "DESC"])
  }),
  target: import_prop_types108.default.string.isRequired
};
...
ReferenceManyFieldView.propTypes = {
  ...
  data: import_prop_types108.default.any,
  isLoading: import_prop_types108.default.bool,
  pagination: import_prop_types108.default.element,
  reference: import_prop_types108.default.string,
  setSort: import_prop_types108.default.func
};
var defaultFilter2 = {};
...
var ReferenceOneField = function(props) {
  var children = props.children, reference = props.reference, _a15 = props.source, source = _a15 === void 0 ? "id" : _a15, target = props.target, emptyText = props.emptyText, sort = props.sort, filter = props.filter, _b = props.link, link = _b === void 0 ? false : _b, queryOptions = props.queryOptions;
  var record = useRecordContext(props);
  var createPath = useCreatePath();
  var translate = useTranslate();
  ...
  return !record || !isLoading && referenceRecord == null ? emptyText ? import_react101.default.createElement(Typography_default, { component: "span", variant: "body2" }, emptyText && translate(emptyText, { _: emptyText })) : null : import_react101.default.createElement(
    ResourceContextProvider,
    { value: reference },
    import_react101.default.createElement(ReferenceFieldView, { isLoading, isFetching, referenceRecord, resourceLinkPath, reference, refetch, error }, children)
  );
};
ReferenceOneField.propTypes = {
  ...
  label: fieldPropTypes.label,
  record: import_prop_types109.default.any,
  reference: import_prop_types109.default.string.isRequired,
  source: import_prop_types109.default.string,
  target: import_prop_types109.default.string.isRequired,
  queryOptions: import_prop_types109.default.any
};
...
var RichTextFieldImpl = function(props) {
  ...
  var record = useRecordContext(props);
  var value = (_a15 = (0, import_get19.default)(record, source)) === null || _a15 === void 0 ? void 0 : _a15.toString();
  var translate = useTranslate();
  return React185.createElement(Typography_default, __assign135({ className, variant: "body2", component: "span" }, sanitizeFieldRestProps(rest)), value == null && emptyText ? translate(emptyText, { _: emptyText }) : stripTags ? removeTags(value) : React185.createElement("span", { dangerouslySetInnerHTML: {
    __html: purify.sanitize(value, purifyOptions)
  } }));
};
RichTextFieldImpl.propTypes = __assign135(__assign135(__assign135({}, Typography_default.propTypes), fieldPropTypes), { stripTags: import_prop_types110.default.bool, purifyOptions: import_prop_types110.default.any });
...
var SelectFieldImpl = function(props) {
  var className = props.className, emptyText = props.emptyText, source = props.source, choices2 = props.choices, _a15 = props.optionValue, optionValue = _a15 === void 0 ? "id" : _a15, _b = props.optionText, optionText = _b === void 0 ? "name" : _b, _c = props.translateChoice, translateChoice = _c === void 0 ? true : _c, rest = __rest123(props, ["className", "emptyText", "source", "choices", "optionValue", "optionText", "translateChoice"]);
  var record = useRecordContext(props);
  ...
  if (!choice) {
    return emptyText ? React186.createElement(Typography_default, __assign136({ component: "span", variant: "body2", className }, sanitizeFieldRestProps(rest)), emptyText && translate(emptyText, { _: emptyText })) : null;
  }
  var choiceText = getChoiceText(choice);
  return React186.createElement(Typography_default, __assign136({ component: "span", variant: "body2", className }, sanitizeFieldRestProps(rest)), choiceText);
};
SelectFieldImpl.propTypes = __assign136(__assign136(__assign136({}, Typography_default.propTypes), fieldPropTypes), { choices: import_prop_types111.default.arrayOf(import_prop_types111.default.object).isRequired, optionText: import_prop_types111.default.oneOfType([
  import_prop_types111.default.string,
  import_prop_types111.default.func,
  import_prop_types111.default.element
]), optionValue: import_prop_types111.default.string, translateChoice: import_prop_types111.default.bool });
...
var TextFieldImpl = function(props) {
  ...
  var record = useRecordContext(props);
  var value = (_a15 = (0, import_get21.default)(record, source)) === null || _a15 === void 0 ? void 0 : _a15.toString();
  var translate = useTranslate();
  return React187.createElement(Typography_default, __assign137({ component: "span", variant: "body2", className }, sanitizeFieldRestProps(rest)), value != null && typeof value !== "string" ? JSON.stringify(value) : value || (emptyText ? translate(emptyText, { _: emptyText }) : null));
};
...
var TranslatableFieldsTab = function(props) {
  var locale = props.locale, _a15 = props.groupKey, groupKey = _a15 === void 0 ? "" : _a15, rest = __rest125(props, ["locale", "groupKey"]);
  var translate = useTranslate();
  return import_react102.default.createElement(Tab_default, __assign138({ id: "translatable-header-".concat(groupKey).concat(locale), label: translate("ra.locales.".concat(groupKey).concat(locale), {
...
var TranslatableFieldsTabs = function(props) {
  ...
  return React189.createElement(
    ...
    React189.createElement(Tabs_default, __assign139({ value: selectedLocale, onChange: handleChange, indicatorColor: "primary", textColor: "primary" }, tabsProps), locales.map(function(locale) {
      return React189.createElement(TranslatableFieldsTab, { key: locale, value: locale, locale, groupKey });
    }))
  );
};
var PREFIX82 = "RaTranslatableFieldsTabs";
...
var TranslatableFieldsTabContent = function(props) {
  var children = props.children, _a15 = props.groupKey, groupKey = _a15 === void 0 ? "" : _a15, locale = props.locale, record = props.record, resource = props.resource, className = props.className, other = __rest126(props, ["children", "groupKey", "locale", "record", "resource", "className"]);
  var _b = useTranslatableContext(), selectedLocale = _b.selectedLocale, getLabel = _b.getLabel, getSource = _b.getSource;
  var addLabel = import_react103.Children.count(children) > 1;
  return React190.createElement(Root36, __assign140({ role: "tabpanel", hidden: selectedLocale !== locale, id: "translatable-content-".concat(groupKey).concat(locale), "aria-labelledby": "translatable-header-".concat(groupKey).concat(locale), className }, other), import_react103.Children.map(children, function(field) {
    return field && (0, import_react103.isValidElement)(field) ? React190.createElement("div", { key: field.props.source }, addLabel ? React190.createElement(Labeled, { resource, label: field.props.label, source: field.props.source }, (0, import_react103.cloneElement)(field, __assign140(__assign140({}, field.props), { label: getLabel(field.props.source), record, source: getSource(field.props.source, locale) }))) : typeof field === "string" ? field : (0, import_react103.cloneElement)(field, __assign140(__assign140({}, field.props), { label: getLabel(field.props.source), record, source: getSource(field.props.source, locale) }))) : null;
  }));
};
var PREFIX83 = "RaTranslatableFieldsTabContent";
...
var TranslatableFields = function(props) {
  var defaultLocale = props.defaultLocale, locales = props.locales, _a15 = props.groupKey, groupKey = _a15 === void 0 ? "" : _a15, _b = props.selector, selector = _b === void 0 ? React191.createElement(TranslatableFieldsTabs, { groupKey }) : _b, children = props.children, resource = props.resource, className = props.className;
  var record = useRecordContext(props);
  var context = useTranslatable({ defaultLocale, locales });
  return React191.createElement(
    ...
    React191.createElement(
      ...
      selector,
      locales.map(function(locale) {
        return React191.createElement(TranslatableFieldsTabContent, { key: locale, locale, record, resource, groupKey }, children);
      })
    )
  );
};
var PREFIX84 = "RaTranslatableFields";
...
var UrlFieldImpl = function(props) {
  ...
  var translate = useTranslate();
  if (value == null) {
    return React192.createElement(Typography_default, __assign141({ component: "span", variant: "body2", className }, sanitizeFieldRestProps(rest)), emptyText && translate(emptyText, { _: emptyText }));
  }
  return React192.createElement(Link_default, __assign141({ className, href: value, onClick: stopPropagation7, variant: "body2" }, sanitizeFieldRestProps(rest)), value);
};
...
var WrapperField = function(_a15) {
  var children = _a15.children;
  return React193.createElement(React193.Fragment, null, children);
};
...
var SimpleShowLayout = function(props) {
  var className = props.className, children = props.children, divider = props.divider, _a15 = props.spacing, spacing = _a15 === void 0 ? 1 : _a15, rest = __rest128(props, ["className", "children", "divider", "spacing"]);
  var record = useRecordContext(props);
  if (!record) {
    return null;
  }
  return React194.createElement(
    ...
    React194.createElement(
      ...
      React194.createElement(Stack_default, { spacing, divider, className: SimpleShowLayoutClasses.stack }, import_react104.Children.map(children, function(field) {
        return field && (0, import_react104.isValidElement)(field) ? React194.createElement(Labeled, { key: field.props.source, className: clsx_m_default("ra-field", field.props.source && "ra-field-".concat(field.props.source), SimpleShowLayoutClasses.row, field.props.className) }, field) : null;
      }))
    )
  );
};
...
var PREFIX85 = "RaSimpleShowLayout";
var SimpleShowLayoutClasses = {
  stack: "".concat(PREFIX85, "-stack"),
  row: "".concat(PREFIX85, "-row")
};
var Root38 = styled_default("div", {
  name: PREFIX85,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var sanitizeRestProps29 = function(_a15) {
  var record = _a15.record, resource = _a15.resource, initialValues = _a15.initialValues, translate = _a15.translate, rest = __rest128(_a15, ["record", "resource", "initialValues", "translate"]);
  return rest;
};
...
var showFieldTypes = {
  show: {
    component: function(props) {
      return React195.createElement(SimpleShowLayout, __assign143({}, props));
    },
    representation: function(_, children) {
  ...
  array: {
    // eslint-disable-next-line react/display-name
    component: function(_a15) {
      var children = _a15.children, props = __rest129(_a15, ["children"]);
      return React195.createElement(
        ArrayField,
        __assign143({}, props),
        React195.createElement(Datagrid, null, children)
      );
    },
    representation: function(props, children) {
  ...
  referenceChild: {
    component: function(props) {
      return React195.createElement(TextField, __assign143({ source: "id" }, props));
    },
    representation: function() {
...
var ShowGuesser = function(_a15) {
  var id = _a15.id, queryOptions = _a15.queryOptions, resource = _a15.resource, rest = __rest130(_a15, ["id", "queryOptions", "resource"]);
  return React196.createElement(
    ShowBase,
    { id, resource, queryOptions },
    React196.createElement(ShowViewGuesser, __assign144({}, rest))
  );
};
var ShowViewGuesser = function(props) {
  var resource = useResourceContext(props);
  var record = useShowContext().record;
  var _a15 = (0, import_react105.useState)(null), child = _a15[0], setChild = _a15[1];
  ...
  return React196.createElement(ShowView, __assign144({}, rest), child);
};
...
var TabbedShowLayoutTabs = function(_a15) {
  var children = _a15.children, syncWithLocation = _a15.syncWithLocation, value = _a15.value, rest = __rest131(_a15, ["children", "syncWithLocation", "value"]);
  var params = useParams();
  var tabValue = params["*"];
  return React197.createElement(Tabs_default, __assign145({ indicatorColor: "primary", value: syncWithLocation ? tabValue : value }, rest), import_react106.Children.map(children, function(tab, index) {
    if (!tab || !(0, import_react106.isValidElement)(tab))
      return null;
    var tabPath = getShowLayoutTabFullPath(tab, index);
    return (0, import_react106.cloneElement)(tab, {
      context: "header",
      value: syncWithLocation ? tabPath : index,
      syncWithLocation
    });
...
var Tab = function(_a15) {
  var children = _a15.children, contentClassName = _a15.contentClassName, context = _a15.context, count = _a15.count, className = _a15.className, divider = _a15.divider, icon = _a15.icon, label = _a15.label, record = _a15.record, _b = _a15.spacing, spacing = _b === void 0 ? 1 : _b, _c = _a15.syncWithLocation, syncWithLocation = _c === void 0 ? true : _c, value = _a15.value, rest = __rest132(_a15, ["children", "contentClassName", "context", "count", "className", "divider", "icon", "label", "record", "spacing", "syncWithLocation", "value"]);
  var translate = useTranslate();
  var location = useLocation();
  var propsForLink = {
    component: Link,
  ...
  var renderHeader = function() {
    ...
    if (count !== void 0) {
      tabLabel = React198.createElement(
        "span",
        null,
        tabLabel,
        " (",
    ...
    return React198.createElement(Tab_default, __assign146({ key: "tab-header-".concat(value), label: tabLabel, value, icon, className: clsx_m_default("show-tab", className) }, syncWithLocation ? propsForLink : {}, rest));
  };
  var renderContent = function() {
    return React198.createElement(Stack_default, { className: contentClassName, spacing, divider }, React198.Children.map(children, function(field) {
      return field && (0, import_react107.isValidElement)(field) ? React198.createElement(Labeled, { key: field.props.source, className: clsx_m_default("ra-field", field.props.source && "ra-field-".concat(field.props.source), field.props.className) }, field) : null;
    }));
  };
...
Tab.propTypes = {
  ...
  contentClassName: import_prop_types114.default.string,
  context: import_prop_types114.default.oneOf(["header", "content"]),
  count: import_prop_types114.default.node,
  icon: import_prop_types114.default.element,
  label: import_prop_types114.default.oneOfType([import_prop_types114.default.string, import_prop_types114.default.element]).isRequired,
  path: import_prop_types114.default.string,
  spacing: import_prop_types114.default.any,
  value: import_prop_types114.default.oneOfType([import_prop_types114.default.string, import_prop_types114.default.number])
};
...
var TabbedShowLayout = function(props) {
  var children = props.children, className = props.className, spacing = props.spacing, divider = props.divider, _a15 = props.syncWithLocation, syncWithLocation = _a15 === void 0 ? true : _a15, _b = props.tabs, tabs = _b === void 0 ? DefaultTabs2 : _b, value = props.value, rest = __rest133(props, ["children", "className", "spacing", "divider", "syncWithLocation", "tabs", "value"]);
  var record = useRecordContext(props);
  var nonNullChildren = import_react108.Children.toArray(children).filter(function(child) {
    return child !== null;
  });
  var _c = (0, import_react108.useState)(0), tabValue = _c[0], setTabValue = _c[1];
  ...
  var renderTabHeaders = function() {
    return (0, import_react108.cloneElement)(tabs, {
      onChange: handleTabChange,
      syncWithLocation,
      value: tabValue
    }, nonNullChildren);
  ...
  return React199.createElement(
    OptionalRecordContextProvider,
    { value: props.record },
    React199.createElement(Root39, __assign147({ className }, sanitizeRestProps30(rest)), syncWithLocation ? React199.createElement(
      Routes,
      null,
      React199.createElement(Route, { path: "/*", element: React199.createElement(
        React199.Fragment,
        null,
        renderTabHeaders(),
        React199.createElement(Divider_default, null),
        React199.createElement(
          "div",
          { className: TabbedShowLayoutClasses.content },
          React199.createElement(Outlet, null)
        )
      ) }, import_react108.Children.map(nonNullChildren, function(tab, index) {
        return (0, import_react108.isValidElement)(tab) ? React199.createElement(Route, { path: getShowLayoutTabFullPath(tab, index), element: (0, import_react108.cloneElement)(tab, {
          context: "content",
          spacing,
          divider
        }) }) : null;
      ...
      renderTabHeaders(),
      React199.createElement(Divider_default, null),
      React199.createElement("div", { className: TabbedShowLayoutClasses.content }, import_react108.Children.map(nonNullChildren, function(tab, index) {
        if (!(0, import_react108.isValidElement)(tab) || tabValue !== index) {
          return null;
        }
...
TabbedShowLayout.propTypes = {
  ...
  record: import_prop_types115.default.object,
  spacing: import_prop_types115.default.any,
  sx: import_prop_types115.default.any,
  syncWithLocation: import_prop_types115.default.bool,
  tabs: import_prop_types115.default.element,
  value: import_prop_types115.default.number
};
var DefaultTabs2 = React199.createElement(TabbedShowLayoutTabs, null);
var PREFIX86 = "RaTabbedShowLayout";
var TabbedShowLayoutClasses = {
  content: "".concat(PREFIX86, "-content")
};
var Root39 = styled_default("div", {
  name: PREFIX86,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var sanitizeRestProps30 = function(_a15) {
  var record = _a15.record, resource = _a15.resource, initialValues = _a15.initialValues, staticContext = _a15.staticContext, translate = _a15.translate, tabs = _a15.tabs, rest = __rest133(_a15, ["record", "resource", "initialValues", "staticContext", "translate", "tabs"]);
  return rest;
};

// node_modules/ra-ui-materialui/dist/esm/list/Count.js
var React200 = __toESM(require_react());
var import_Error5 = __toESM(require_Error());
...
var Count = function(props) {
  var filter = props.filter, sort = props.sort, link = props.link, resourceFromProps = props.resource, _a15 = props.timeout, timeout = _a15 === void 0 ? 1e3 : _a15, rest = __rest134(props, ["filter", "sort", "link", "resource", "timeout"]);
  var resource = useResourceContext(props);
  var oneSecondHasPassed = useTimeout(timeout);
  var createPath = useCreatePath();
  ...
  var body = isLoading ? oneSecondHasPassed ? React200.createElement(CircularProgress_default, { size: 14 }) : "" : error ? React200.createElement(import_Error5.default, { color: "error", fontSize: "small", titleAccess: "error" }) : total;
  return link ? (
    // @ts-ignore TypeScript complains that the props for <a> aren't the same as for <span>
    React200.createElement(Link2, __assign148({ to: {
      pathname: createPath({ resource, type: "list" }),
      search: filter ? "filter=".concat(JSON.stringify(filter)) : void 0
    }, variant: "body2", onClick: function(e) {
      return e.stopPropagation();
    } }, rest), body)
  ) : React200.createElement(Typography_default, __assign148({ component: "span", variant: "body2" }, rest), body);
};
...
var Empty = function(props) {
  ...
  return React201.createElement(
    ...
    React201.createElement(
      ...
      React201.createElement(import_Inbox.default, { className: EmptyClasses.icon }),
      React201.createElement(Typography_default, { variant: "h4", paragraph: true }, translate("resources.".concat(resource, ".empty"), {
        _: emptyMessage
      })),
      hasCreate && React201.createElement(Typography_default, { variant: "body1" }, translate("resources.".concat(resource, ".invite"), {
        _: inviteMessage
      }))
    ),
    hasCreate && React201.createElement(
      "div",
      { className: EmptyClasses.toolbar },
      React201.createElement(CreateButton_default, { variant: "contained" })
    )
  );
};
var PREFIX87 = "RaEmpty";
var EmptyClasses = {
  message: "".concat(PREFIX87, "-message"),
  icon: "".concat(PREFIX87, "-icon"),
  toolbar: "".concat(PREFIX87, "-toolbar")
};
var Root40 = styled_default("span", {
  name: PREFIX87,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var ListToolbar = (0, import_react109.memo)(function(props) {
  var filters = props.filters, actions = props.actions, className = props.className, rest = __rest135(props, ["filters", "actions", "className"]);
  return Array.isArray(filters) ? React202.createElement(
    FilterContext.Provider,
    { value: filters },
    React202.createElement(
      Root41,
      { className },
      React202.createElement(FilterForm, null),
      React202.createElement("span", null),
      actions && React202.cloneElement(actions, __assign149(__assign149({}, rest), actions.props))
    )
  ) : React202.createElement(
    Root41,
    { className },
    filters && React202.cloneElement(filters, __assign149(__assign149({}, rest), { context: "form" })),
    React202.createElement("span", null),
    actions && React202.cloneElement(actions, __assign149(__assign149(__assign149({}, rest), { filters }), actions.props))
  );
});
ListToolbar.propTypes = {
  ...
  // @ts-ignore
  exporter: import_prop_types116.default.oneOfType([import_prop_types116.default.func, import_prop_types116.default.bool])
};
var PREFIX88 = "RaListToolbar";
var Root41 = styled_default("div", {
  name: PREFIX88,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var ListActions = function(props) {
  var className = props.className, filtersProp = props.filters, _ = props.hasCreate, _a15 = props.selectedIds, selectedIds = _a15 === void 0 ? defaultSelectedIds : _a15, _b = props.onUnselectItems, onUnselectItems = _b === void 0 ? defaultOnUnselectItems : _b, rest = __rest136(props, ["className", "filters", "hasCreate", "selectedIds", "onUnselectItems"]);
  ...
  var resource = useResourceContext(props);
  var hasCreate = useResourceDefinition(props).hasCreate;
  var filters = (0, import_react110.useContext)(FilterContext) || filtersProp;
  return (0, import_react110.useMemo)(
    function() {
      return React203.createElement(
        TopToolbar_default,
        __assign150({ className }, sanitizeListRestProps(rest)),
        filtersProp ? (0, import_react110.cloneElement)(filtersProp, {
          resource,
          showFilter,
          displayedFilters,
          filterValues,
          context: "button"
        }) : filters && React203.createElement(FilterButton, null),
        hasCreate && React203.createElement(CreateButton_default, null),
        exporter !== false && React203.createElement(ExportButton, { disabled: total === 0, resource, sort, filterValues })
      );
    },
...
ListActions.propTypes = {
  ...
  sort: import_prop_types117.default.shape({
    ...
    order: import_prop_types117.default.oneOf(["ASC", "DESC"])
  }),
  displayedFilters: import_prop_types117.default.object,
  exporter: import_prop_types117.default.oneOfType([import_prop_types117.default.func, import_prop_types117.default.bool]),
  filters: import_prop_types117.default.element,
  filterValues: import_prop_types117.default.object,
  hasCreate: import_prop_types117.default.bool,
  resource: import_prop_types117.default.string,
  onUnselectItems: import_prop_types117.default.func,
  selectedIds: import_prop_types117.default.arrayOf(import_prop_types117.default.any),
  showFilter: import_prop_types117.default.func,
  total: import_prop_types117.default.number
};
...
var ListView = function(props) {
  ...
  var renderList = function() {
    return React204.createElement(
      ...
      (filters || actions) && React204.createElement(ListToolbar, { className: ListClasses.actions, filters, actions, hasCreate }),
      React204.createElement(Content, { className: ListClasses.content }, bulkActionButtons && children && React204.isValidElement(children) ? (
        // FIXME remove in 5.0
        (0, import_react111.cloneElement)(children, {
          bulkActionButtons
        })
      ) : children),
      error ? React204.createElement(Error2, { error, resetErrorBoundary: null }) : pagination !== false && pagination
    );
  };
  var renderEmpty = function() {
    return empty !== false && (0, import_react111.cloneElement)(empty, { className: ListClasses.noResults, hasCreate });
  };
  ...
  return React204.createElement(
    ...
    React204.createElement(Title, { title, defaultTitle, preferenceKey: "".concat(resource, ".list.title") }),
    shouldRenderEmptyPage ? renderEmpty() : renderList(),
    aside
  );
};
ListView.propTypes = {
  actions: import_prop_types118.default.oneOfType([import_prop_types118.default.bool, import_prop_types118.default.element]),
  aside: import_prop_types118.default.element,
  children: import_prop_types118.default.node,
  className: import_prop_types118.default.string,
  component: ComponentPropType_default,
  emptyWhileLoading: import_prop_types118.default.bool,
  filters: import_prop_types118.default.oneOfType([
    import_prop_types118.default.element,
    import_prop_types118.default.arrayOf(import_prop_types118.default.element)
  ]),
  hasCreate: import_prop_types118.default.bool,
  pagination: import_prop_types118.default.oneOfType([import_prop_types118.default.element, import_prop_types118.default.bool]),
  title: TitlePropType
};
var PREFIX89 = "RaList";
var ListClasses = {
  main: "".concat(PREFIX89, "-main"),
  content: "".concat(PREFIX89, "-content"),
  actions: "".concat(PREFIX89, "-actions"),
  noResults: "".concat(PREFIX89, "-noResults")
};
var Root42 = styled_default("div", {
  name: PREFIX89,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var InfiniteList = function(_a15) {
  var debounce2 = _a15.debounce, disableAuthentication = _a15.disableAuthentication, disableSyncWithLocation = _a15.disableSyncWithLocation, exporter = _a15.exporter, _b = _a15.filter, filter = _b === void 0 ? defaultFilter3 : _b, filterDefaultValues = _a15.filterDefaultValues, _c = _a15.pagination, pagination = _c === void 0 ? defaultPagination3 : _c, _d = _a15.perPage, perPage = _d === void 0 ? 10 : _d, queryOptions = _a15.queryOptions, resource = _a15.resource, sort = _a15.sort, storeKey = _a15.storeKey, rest = __rest138(_a15, ["debounce", "disableAuthentication", "disableSyncWithLocation", "exporter", "filter", "filterDefaultValues", "pagination", "perPage", "queryOptions", "resource", "sort", "storeKey"]);
  return React205.createElement(
    ...
    React205.createElement(ListView, __assign152({}, rest, { pagination }))
  );
};
var defaultPagination3 = React205.createElement(InfinitePagination, null);
var defaultFilter3 = {};
InfiniteList.propTypes = {
  // the props you can change
  // @ts-ignore-line
  actions: import_prop_types119.default.oneOfType([import_prop_types119.default.bool, import_prop_types119.default.element]),
  aside: import_prop_types119.default.element,
  children: import_prop_types119.default.node.isRequired,
  className: import_prop_types119.default.string,
  emptyWhileLoading: import_prop_types119.default.bool,
  filter: import_prop_types119.default.object,
  filterDefaultValues: import_prop_types119.default.object,
  filters: import_prop_types119.default.oneOfType([
    import_prop_types119.default.element,
    import_prop_types119.default.arrayOf(import_prop_types119.default.element)
  ]),
  // @ts-ignore-line
  pagination: import_prop_types119.default.oneOfType([import_prop_types119.default.element, import_prop_types119.default.bool]),
  perPage: import_prop_types119.default.number,
  //@ts-ignore-line
  sort: import_prop_types119.default.shape({
    field: import_prop_types119.default.string,
    order: import_prop_types119.default.oneOf(["ASC", "DESC"])
  }),
  sx: import_prop_types119.default.any,
  title: TitlePropType,
  // the props managed by react-admin
  disableSyncWithLocation: import_prop_types119.default.bool,
  hasCreate: import_prop_types119.default.bool,
  hasEdit: import_prop_types119.default.bool,
  hasList: import_prop_types119.default.bool,
  hasShow: import_prop_types119.default.bool,
  resource: import_prop_types119.default.string
};
...
var List = function(_a15) {
  var debounce2 = _a15.debounce, disableAuthentication = _a15.disableAuthentication, disableSyncWithLocation = _a15.disableSyncWithLocation, exporter = _a15.exporter, _b = _a15.filter, filter = _b === void 0 ? defaultFilter4 : _b, filterDefaultValues = _a15.filterDefaultValues, _c = _a15.perPage, perPage = _c === void 0 ? 10 : _c, queryOptions = _a15.queryOptions, resource = _a15.resource, sort = _a15.sort, storeKey = _a15.storeKey, rest = __rest139(_a15, ["debounce", "disableAuthentication", "disableSyncWithLocation", "exporter", "filter", "filterDefaultValues", "perPage", "queryOptions", "resource", "sort", "storeKey"]);
  return React206.createElement(
    ListBase,
    { debounce: debounce2, disableAuthentication, disableSyncWithLocation, exporter, filter, filterDefaultValues, perPage, queryOptions, resource, sort, storeKey },
    React206.createElement(ListView, __assign153({}, rest))
  );
};
List.propTypes = {
  // the props you can change
  // @ts-ignore-line
  actions: import_prop_types120.default.oneOfType([import_prop_types120.default.bool, import_prop_types120.default.element]),
  aside: import_prop_types120.default.element,
  children: import_prop_types120.default.node.isRequired,
  className: import_prop_types120.default.string,
  emptyWhileLoading: import_prop_types120.default.bool,
  filter: import_prop_types120.default.object,
  filterDefaultValues: import_prop_types120.default.object,
  filters: import_prop_types120.default.oneOfType([
    import_prop_types120.default.element,
    import_prop_types120.default.arrayOf(import_prop_types120.default.element)
  ]),
  // @ts-ignore-line
  pagination: import_prop_types120.default.oneOfType([import_prop_types120.default.element, import_prop_types120.default.bool]),
  perPage: import_prop_types120.default.number,
  //@ts-ignore-line
  sort: import_prop_types120.default.shape({
    field: import_prop_types120.default.string,
    order: import_prop_types120.default.oneOf(["ASC", "DESC"])
  }),
  sx: import_prop_types120.default.any,
  title: TitlePropType,
  // the props managed by react-admin
  disableSyncWithLocation: import_prop_types120.default.bool,
  hasCreate: import_prop_types120.default.bool,
  resource: import_prop_types120.default.string
};
var defaultFilter4 = {};
...
var listFieldTypes = {
  table: {
    component: function(props) {
      ...
      return React207.createElement(Datagrid, __assign154({ rowClick: !hasEdit && hasShow ? "show" : "edit" }, rest));
    },
    representation: function(props, children) {
  ...
  array: {
    // eslint-disable-next-line react/display-name
    component: function(_a15) {
      var children = _a15.children, props = __rest140(_a15, ["children"]);
      return React207.createElement(
        ...
        React207.createElement(
          SingleFieldList,
          null,
          React207.createElement(ChipField, { source: children.length > 0 && children[0].props.source })
        )
      );
    },
    representation: function(props, children) {
  ...
  referenceChild: {
    component: function() {
      return React207.createElement(TextField, { source: "id" });
    },
    representation: function() {
      return '<TextField source="id" />';
    }
  ...
  referenceArrayChild: {
    component: function() {
      return React207.createElement(
        SingleFieldList,
        null,
        React207.createElement(ChipField, { source: "id" })
      );
    },
    representation: function() {
...
var ListGuesser = function(props) {
  ...
  return React208.createElement(
    ...
    React208.createElement(ListViewGuesser, __assign155({}, rest))
  );
};
var ListViewGuesser = function(props) {
  var data = useListContext(props).data;
  var resource = useResourceContext();
  var _a15 = useResourceDefinition(props), hasEdit = _a15.hasEdit, hasShow = _a15.hasShow;
  var _b = (0, import_react112.useState)(null), child = _b[0], setChild = _b[1];
  ...
  return React208.createElement(ListView, __assign155({}, rest), child);
};
...
var SimpleListLoading = function(props) {
  var className = props.className, hasLeftAvatarOrIcon = props.hasLeftAvatarOrIcon, hasRightAvatarOrIcon = props.hasRightAvatarOrIcon, hasSecondaryText = props.hasSecondaryText, hasTertiaryText = props.hasTertiaryText, _a15 = props.nbFakeLines, nbFakeLines = _a15 === void 0 ? 5 : _a15, rest = __rest142(props, ["className", "hasLeftAvatarOrIcon", "hasRightAvatarOrIcon", "hasSecondaryText", "hasTertiaryText", "nbFakeLines"]);
  var oneSecondHasPassed = useTimeout(1e3);
  return oneSecondHasPassed ? React209.createElement(StyledList2, __assign156({ className }, rest), times2(nbFakeLines, function(key) {
    return React209.createElement(
      ListItem_default,
      { key },
      hasLeftAvatarOrIcon && React209.createElement(
        ListItemAvatar_default,
        null,
        React209.createElement(Avatar_default, null, " ")
      ),
      React209.createElement(ListItemText_default, { primary: React209.createElement(
        "div",
        null,
        React209.createElement(Placeholder, { className: SimpleListLoadingClasses.primary }),
        hasTertiaryText && React209.createElement(
          "span",
          { className: SimpleListLoadingClasses.tertiary },
          React209.createElement(Placeholder, null)
        )
      ), secondary: hasSecondaryText ? React209.createElement(Placeholder, null) : void 0 }),
      hasRightAvatarOrIcon && React209.createElement(
        ListItemSecondaryAction_default,
        null,
        React209.createElement(Avatar_default, null, " ")
      )
...
SimpleListLoading.propTypes = {
  ...
  hasLeftAvatarOrIcon: import_prop_types121.default.bool,
  hasRightAvatarOrIcon: import_prop_types121.default.bool,
  hasSecondaryText: import_prop_types121.default.bool,
  hasTertiaryText: import_prop_types121.default.bool,
  nbFakeLines: import_prop_types121.default.number
};
var PREFIX90 = "RaSimpleListLoading";
var SimpleListLoadingClasses = {
  primary: "".concat(PREFIX90, "-primary"),
  tertiary: "".concat(PREFIX90, "-tertiary")
};
...
var SimpleList = function(props) {
  ...
  var renderAvatar = function(record, avatarCallback) {
    ...
    if (typeof avatarValue === "string" && (avatarValue.startsWith("http") || avatarValue.startsWith("data:"))) {
      return React210.createElement(Avatar_default, { src: avatarValue });
    } else {
      return React210.createElement(Avatar_default, null, avatarValue);
    }
  };
  return total == null && (data === null || data === void 0 ? void 0 : data.length) > 0 || total > 0 ? React210.createElement(Root43, __assign157({ className }, sanitizeListRestProps(rest)), data.map(function(record, rowIndex) {
    return React210.createElement(
      ...
      React210.createElement(
        ...
        React210.createElement(
          ...
          leftIcon && React210.createElement(ListItemIcon_default, null, leftIcon(record, record.id)),
          leftAvatar && React210.createElement(ListItemAvatar_default, null, renderAvatar(record, leftAvatar)),
          React210.createElement(ListItemText_default, { primary: React210.createElement(
            "div",
            null,
            primaryText ? typeof primaryText === "string" ? translate(primaryText, __assign157(__assign157({}, record), { _: primaryText })) : (0, import_react_is5.isElement)(primaryText) ? primaryText : primaryText(record, record.id) : getRecordRepresentation(record),
            !!tertiaryText && ((0, import_react113.isValidElement)(tertiaryText) ? tertiaryText : React210.createElement("span", { className: SimpleListClasses.tertiary }, typeof tertiaryText === "string" ? translate(tertiaryText, __assign157(__assign157({}, record), { _: tertiaryText })) : (0, import_react_is5.isElement)(tertiaryText) ? tertiaryText : tertiaryText(record, record.id)))
          ), secondary: !!secondaryText && (typeof secondaryText === "string" ? translate(secondaryText, __assign157(__assign157({}, record), { _: secondaryText })) : (0, import_react_is5.isElement)(secondaryText) ? secondaryText : secondaryText(record, record.id)) }),
          (rightAvatar || rightIcon) && React210.createElement(
            ListItemSecondaryAction_default,
            null,
            rightAvatar && React210.createElement(Avatar_default, null, renderAvatar(record, rightAvatar)),
            rightIcon && React210.createElement(ListItemIcon_default, null, rightIcon(record, record.id))
          )
        )
      )
    );
...
SimpleList.propTypes = {
  ...
  leftAvatar: import_prop_types122.default.func,
  leftIcon: import_prop_types122.default.func,
  linkType: import_prop_types122.default.oneOfType([
    import_prop_types122.default.string,
    import_prop_types122.default.bool,
    import_prop_types122.default.func
  ]),
  primaryText: import_prop_types122.default.oneOfType([
    import_prop_types122.default.func,
    import_prop_types122.default.element,
    import_prop_types122.default.string
  ]),
  rightAvatar: import_prop_types122.default.func,
  rightIcon: import_prop_types122.default.func,
  secondaryText: import_prop_types122.default.oneOfType([
    import_prop_types122.default.func,
    import_prop_types122.default.element,
    import_prop_types122.default.string
  ]),
  tertiaryText: import_prop_types122.default.oneOfType([
    import_prop_types122.default.func,
    import_prop_types122.default.element,
    import_prop_types122.default.string
  ]),
  rowStyle: import_prop_types122.default.func,
  rowSx: import_prop_types122.default.func
};
var LinkOrNot = function(props) {
  var classesOverride = props.classes, linkType = props.linkType, resource = props.resource, id = props.id, children = props.children, record = props.record, rest = __rest143(props, ["classes", "linkType", "resource", "id", "children", "record"]);
  var createPath = useCreatePath();
  var type = typeof linkType === "function" ? linkType(record, id) : linkType;
  return type === false ? React210.createElement(
    ListItemText_default,
    __assign157({
      // @ts-ignore
      component: "div"
    ...
    // @ts-ignore
    React210.createElement(ListItemButton_default, __assign157({ component: Link, to: createPath({ resource, id, type }) }, rest), children)
  );
};
var PREFIX91 = "RaSimpleList";
var SimpleListClasses = {
  tertiary: "".concat(PREFIX91, "-tertiary")
};
var Root43 = styled_default(List_default, {
  name: PREFIX91,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
})((_a14 = {}, _a14["& .".concat(SimpleListClasses.tertiary)] = { float: "right", opacity: 0.541176 }, _a14));
var DefaultEmpty2 = React210.createElement(ListNoResults, null);
...
var SimpleListEditor = function(props) {
  var _a15 = props.defaultPrimaryText, defaultPrimaryText = _a15 === void 0 ? "" : _a15, _b = props.defaultSecondaryText, defaultSecondaryText = _b === void 0 ? "" : _b, _c = props.defaultTertiatyText, defaultTertiatyText = _c === void 0 ? "" : _c;
  ...
  return React211.createElement(
    "form",
    null,
    React211.createElement(TextField_default, __assign158({ label: translate("ra.configurable.SimpleList.primaryText", {
      _: "Primary Text"
    }) }, primaryTextField, { variant: "filled", size: "small", fullWidth: true, sx: { mb: 1 } })),
    React211.createElement(TextField_default, __assign158({ label: translate("ra.configurable.SimpleList.secondaryText", {
      _: "Secondary Text"
    }) }, secondaryTextField, { variant: "filled", size: "small", fullWidth: true, sx: { mb: 1 } })),
    React211.createElement(TextField_default, __assign158({ label: translate("ra.configurable.SimpleList.tertiaryText", {
      _: "Tertiary Text"
...
var SimpleListConfigurable = function(_a15) {
  var preferenceKey = _a15.preferenceKey, props = __rest144(_a15, ["preferenceKey"]);
  var resource = useResourceContext(props);
  return React212.createElement(
    Configurable,
    { editor: React212.createElement(SimpleListEditor, null), preferenceKey: preferenceKey || "".concat(resource, ".SimpleList"), sx: { display: "block" } },
    React212.createElement(SimpleListWithPreferences, __assign159({}, props))
  );
};
var SimpleListWithPreferences = function(props) {
  ...
  return React212.createElement(SimpleList, __assign159({}, props, { primaryText: primaryTextFromStore || props.primaryText, secondaryText: secondaryTextFromStore || props.secondaryText, tertiaryText: tertiaryTextFromStore || props.tertiaryText }));
};
...
var AdminUI = function(_a15) {
  var _b = _a15.layout, layout = _b === void 0 ? Layout : _b, _c = _a15.catchAll, catchAll = _c === void 0 ? NotFound : _c, _d = _a15.loading, loading = _d === void 0 ? LoadingPage : _d, _e = _a15.loginPage, loginPage = _e === void 0 ? Login : _e, _f = _a15.authCallbackPage, authCallbackPage = _f === void 0 ? AuthCallback : _f, _g = _a15.notification, notification = _g === void 0 ? Notification : _g, props = __rest145(_a15, ["layout", "catchAll", "loading", "loginPage", "authCallbackPage", "notification"]);
  return React213.createElement(
    ScopedCssBaseline_default,
    { enableColorScheme: true },
    React213.createElement(CoreAdminUI, __assign160({ layout, catchAll, loading, loginPage, authCallbackPage }, props)),
    (0, import_react114.createElement)(notification)
  );
};
...
var AdminContext = function(props) {
  var theme = props.theme, _a15 = props.lightTheme, lightTheme = _a15 === void 0 ? defaultLightTheme : _a15, darkTheme = props.darkTheme, defaultTheme2 = props.defaultTheme, children = props.children, rest = __rest146(props, ["theme", "lightTheme", "darkTheme", "defaultTheme", "children"]);
  return React214.createElement(
    ...
    React214.createElement(
      ...
      React214.createElement(ThemeProvider2, null, children)
    )
  );
};
...
var Admin = function(props) {
  var authProvider = props.authProvider, basename = props.basename, catchAll = props.catchAll, children = props.children, dashboard = props.dashboard, dataProvider = props.dataProvider, disableTelemetry = props.disableTelemetry, history = props.history, _a15 = props.i18nProvider, i18nProvider = _a15 === void 0 ? defaultI18nProvider : _a15, layout = props.layout, loading = props.loading, loginPage = props.loginPage, authCallbackPage = props.authCallbackPage, menu = props.menu, notification = props.notification, queryClient = props.queryClient, requireAuth = props.requireAuth, _b = props.store, store = _b === void 0 ? defaultStore : _b, ready = props.ready, theme = props.theme, lightTheme = props.lightTheme, darkTheme = props.darkTheme, defaultTheme2 = props.defaultTheme, _c = props.title, title = _c === void 0 ? "React Admin" : _c;
  ...
  return React215.createElement(
    ...
    React215.createElement(AdminUI, { layout, dashboard, disableTelemetry, menu, catchAll, title, loading, loginPage, authCallbackPage, notification, requireAuth, ready }, children)
  );
};
export {
  AUTH_CHECK,
